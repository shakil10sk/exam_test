$(document).ready(function() {
    ...
    $('#warish').click(function () {
        if ($.trim($('#warish_name_bn_0').val()) == '' || $.trim($('#relation_bn_0').val()) == ''){
            ...
            $('#emptyError').html('');
            addRow(x, woyarish_name_bn, woyarish_name_en, relation_bn, relation_en, relation_age);
        }
    });
    ...
    function addRow(x, woyarish_name_bn, woyarish_name_en, relation_bn, relation_en, relation_age) {
        ...
        $('#addWoyarish').append('<div class="col-sm-12" id="dataRow_'+x+'">\n' +
            ...
            '            <input type="text" name="warish_name_bn[]" value="'+woyarish_name_bn+'" id="warish_name_bn_'+x+'" class="form-control" placeholder="নাম বাংলায়" data-parsley-required  />\n' +
            ...
            '            <input type="text" name="relation_bn[]" value="'+relation_bn+'" id="relation_bn_'+x+'" class="form-control"  placeholder="সম্পর্ক বাংলায়" data-parsley-required/>\n' +
