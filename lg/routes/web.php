...
Route::group(['prefix' => 'verify'], function(){
    ...
    Route::get('/trade_bn/{sonod_no}/{union_id}/{type}', 'VerifyController@trade_bn')->name('trade_bn');
    Route::get('/trade_en/{sonod_no}/{union_id}/{type}', 'VerifyController@trade_en')->name('trade_en');
    ...
    //for onapotti sonod
    Route::get('/onapotti_application/{tracking}/{union_id}/{type}', 'VerifyController@onapotti_application')->name('voter_application');
    Route::get('/onapotti_bn/{sonod_no}/{union_id}/{type}', 'VerifyController@voter_bn')->name('voter_bn');
    Route::get('/onapotti_en/{sonod_no}/{union_id}/{type}', 'VerifyController@voter_en')->name('voter_en');
...
Route::group(['prefix' => '/geo/code', 'middleware' => 'web'], function () {
    ...
    Route::get('/get_union', [
        'uses' => 'GeoCodeController@get_union'
    ]);

    Route::post('/business_type', [
        'uses' => 'GeoCodeController@business_type'
    ]);
});
