    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center bg-primary"
                ...
                <h4 style="color: white;">অবিবাহিত সনদের আবেদন</h4>
            </div>
        </div>
    </div>
</section>
...
<section>
    <div class="container">
        <form id="form-data" data-route="{{ $path.'/api/application/obibahito' }}" method="post"
           ...
           @include('application_form/application_head')
                ...
                <div class="col-md-12" id="genderErr">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-3 bt-flabels__wrapper" id="marital_status_status">
                            <input type="hidden" name="marital_status" id="marital_status" value="1">
                            <span class="bt-flabels__error-desc">অনুগ্রহ করে নির্বাচন করুন....</span>
            ...
            <div class="row" style="margin-bottom: 100px;">
                <div class="col-sm-offset-6 col-sm-6 button-style">
                    ...
                    {{-- <input type="text" value="{{ $unionProfile->union_id }}" name="union_id" id="union-id" /> --}}
