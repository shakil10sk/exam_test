    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center bg-primary"
                ...
                <h4 style="color: white;">একই নামের প্রত্যয়ন আবেদন</h4>
            </div>
        </div>
    </div>
</section>
...
<section>
    <div class="container">
        <form id="form-data" data-route="{{ $path.'/api/application/ekoinam' }}" method="post"
            ...
            <div class="row" style="margin-top: 50px;">
                ...
                <div class="col-sm-12">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-3 bt-flabels__wrapper" id="nickname_en_status">
                            <input type="text" name="nickname_en" id="nickname_en" class="form-control"
                                placeholder="একই নামের প্রত্যয়ন ক্ষেত্রে" data-parsley-pattern='^[a-zA-Z. ]+$'
                                data-parsley-trigger="keyup" />
                            <span class="bt-flabels__error-desc">একই নামের প্রত্যয়ন ক্ষেত্রে প্রকাশে দিন
                                ইংরেজীতে....</span>

                            <span id="nickname_en_feedback" class="help-block"></span>
                        </div>
                        <label for="nick_name" class="col-sm-3 control-label">প্রকাশে নাম (বাংলায়)<span>*</span></label>
                        <div class="col-sm-3 bt-flabels__wrapper" id="nickname_bn_status">
                            <input type="text" name="nickname_bn" id="nickname_bn" class="form-control"
                                placeholder="একই নামের প্রত্যয়ন ক্ষেত্রে" data-parsley-trigger="keyup"
                                data-parsley-required />
                            <span class="bt-flabels__error-desc">একই নামের প্রত্যয়ন ক্ষেত্রে প্রকাশে দিন
                                বাংলায়....</span>

                            <span id="nickname_bn_feedback" class="help-block"></span>
                        </div>
                    </div>
                </div>
