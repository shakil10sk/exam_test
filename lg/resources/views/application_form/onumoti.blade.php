    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center bg-primary"
                ...
                <h4 style="color: white;">অনুমতি পত্রের আবেদন</h4>
            </div>
        </div>
    </div>
</section>
...
<section>
    <div class="container">
        <form id="form-data" data-route="{{ $path.'/api/application/onumoti' }}" method="post"
            ...
            <div class="row" style="margin-top: 50px;">
                ...
                <div class="col-sm-12">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-3 bt-flabels__wrapper" id="job_sector_en_status">
                            <input type="text" name="job_sector_en" id="job_sector_en" class="form-control"
                                placeholder="" data-parsley-pattern='^[a-zA-Z.(),:;_ ]+$'
                                data-parsley-trigger="keyup" />
                            <span class="bt-flabels__error-desc">কর্ম ক্ষেত্রের নাম ইংরেজীতে....</span>

                            <span id="job_sector_en_feedback" class="help-block"></span>
                        </div>
                        <label for="job_sector" class="col-sm-3 control-label">কর্ম ক্ষেত্রের নাম (বাংলায়)
                            <span>*</span></label>
                        <div class="col-sm-3 bt-flabels__wrapper" id="job_sector_bn_status">
                            <input type="text" name="job_sector_bn" id="job_sector_bn" class="form-control"
                                placeholder=" অনুমতি পত্র  ক্ষেত্রে  যেমন-সেনাবাহিনীতে" data-parsley-required />
                            <span class="bt-flabels__error-desc">কর্ম ক্ষেত্রের নাম বাংলায়....</span>

                            <span id="job_sector_bn_feedback" class="help-block"></span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-3 bt-flabels__wrapper" id="mother_name_bn_status">
                            <input type="text" name="mother_name_bn" id="mother_name_bn"
                                value="{{ old('mother_name_bn') }}" class="form-control" placeholder="মাতার নাম"
                ...
                <div class="col-sm-12">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-3 bt-flabels__wrapper" id="mobile_status">
                            <input type="tel" name="mobile" id="mobile" value="{{ old('mobile') }}" class="form-control"
