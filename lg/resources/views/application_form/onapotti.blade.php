                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="text-center list-none">
                            <li class='text-warning list-unstyled'>বাংলায় সার্টিফিকেট পেতে শুধুমাত্র বাংলায় ঘর গুলো পূরন
                                করুন ।</li>
                            <li class='text-warning list-unstyled'>ইংরেজি সার্টিফিকেট পেতে বাংলা এবং ইংরেজি উভয় ঘর পূরন
                                করুন ।</li>
                            <li class='text-warning list-unstyled'>আপনি যদি পূর্বে কোনো সনদ নিয়ে থাকেন, নিচের সার্চ বক্সে
                                আপনার ন্যাশনাল আইডি/জন্ম নিবন্ধন/পাসপোর্ট/পিন নং দিয়ে সার্চ করুন!</li>
                        </ul>
                        <div class="col-md-12">
                ...
                {{-- <div class="row">
                    ...
                    <div class="row" style="margin-top: 50px">
                        <div class="col-sm-12" style="text-align:center;">
                            ...
                            <p style="font-size:15px; font-weight:normal;padding-top:10px;"> <input type="checkbox" id="permanentBtn" name="permanentBtn" {{ (old('permanentBtn'))? 'checked' : '' }} >ঠিকানা  একই হলে পাশে টিক দিন</p>
                        </div>
                    </div>
