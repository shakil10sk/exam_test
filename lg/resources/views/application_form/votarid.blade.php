...
<section>
    <div class="container">
        <form id="form-data" data-route="{{ $path.'/api/application/voterid' }}" method="post"
                ...
                <div class="col-sm-12">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-3 bt-flabels__wrapper" id="union_name_en_status">
                            <input type="text" name="union_name_en" id="union_name_en" class="form-control"
                                placeholder="" data-parsley-maxlength="100" data-parsley-trigger="keyup" />
                            <span class="bt-flabels__error-desc">পূর্বের ইউনিয়ন দিন ইংরেজিতে....</span>

                            <span id="union_name_en_feedback" class="help-block"></span>
                        </div>
                        <label for="union_name_bn" class="col-sm-3 control-label">পূর্বের ইউনিয়ন (বাংলায়)
                            <span>*</span></label>
                        <div class="col-sm-3 bt-flabels__wrapper" id="union_name_bn_status">
                            <input type="text" name="union_name_bn" id="union_name_bn" class="form-control"
                                placeholder="" data-parsley-maxlength="100" data-parsley-trigger="keyup"
                                data-parsley-required />
