...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center bg-primary"
                    ...
                    <h4 style="color: rgb(255, 255, 255);">নাগরিক আবেদন</h4>
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container">
            <form id="form-data" data-route="{{ $path . '/api/application/nagorik' }}" method="post"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3" id="gender_status">
                                <label class="radio-inline gender"><input type="radio" id="gender_1" name="gender" value="1"
                                        {{ old('gender') == 1 ? 'checked' : '' }} /><span class="wrap">পুরুষ</span></label>
                                <label class="radio-inline gender"><input type="radio" id="gender_2" name="gender" value="2"
                                        {{ old('gender') == 2 ? 'checked' : '' }} /><span class="wrap">মহিলা</span></label>
                                <label class="radio-inline gender"><input type="radio" id="gender_3" name="gender" value="3"
                                        {{ old('gender') == 3 ? 'checked' : '' }} /><span
                                        class="wrap">অন্যান্য</span></label>
                ...
                <div class="row" style="margin-bottom: 100px;">
                    <div class="col-sm-offset-6 col-sm-6 button-style">
                        ...
                        {{-- <input type="hidden" value="{{ $unionProfile->union_id }}"
                            name="union_id" id="union-id" /> --}}
