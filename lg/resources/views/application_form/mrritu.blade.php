...
<section>
    <div class="container">
        <form id="form-data" data-route="{{ $path.'/api/application/mrritu' }}" method="post"
            ...
            <div class="row" style="margin-top: 50px;">
                ...
                <div class="col-md-12">
                    <div class="row form-group">
                        ...
                        <label for="name_bn" class="col-sm-3 control-label">মৃত ব্যাক্তির নাম (বাংলায়)
                            <span>*</span></label>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="row form-group">
                        <label for="comment_en" class="col-sm-3 control-label">মৃত্যুর কারন ও স্থান
                            দিন(ইংরেজিতে)</label>
                        <div class="col-sm-3 bt-flabels__wrapper" id="comment_en_status">
                            ...
                            <span class="bt-flabels__error-desc">মৃত্যুর কারন ও স্থান ৫০০ অক্ষরের নিচে লিখুন
                                ইংরেজিতে....</span>
