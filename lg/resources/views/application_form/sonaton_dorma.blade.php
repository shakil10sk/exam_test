    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center bg-primary"
                ...
                <h4 style="color: white;">সনাতন ধর্ম অবলম্বী সনদের আবেদন</h4>
            </div>
        </div>
    </div>
</section>
...
<section>
    <div class="container">
        <form id="form-data" data-route="{{ $path.'/api/application/sonatondhormo' }}" method="post"
                ...
                <div class="col-md-12">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-3 bt-flabels__wrapper" id="religion_status">
                            <input type="hidden" name="religion" id="sonaton" value="2">
                            <span class="bt-flabels__error-desc">অনুগ্রহ করে নির্বাচন করুন....</span>
            ...
            <div class="row" style="margin-top: 50px;">
                <div class="col-sm-12 text-center">
                    ...
                    <p id="addressCheck" style="font-size:15px; font-weight:normal;padding-top:10px;"> <input
