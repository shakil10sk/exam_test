            ...
            <div class="row" style="margin-top: 50px;">
                ...
                <div class="col-md-12">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-3 bt-flabels__wrapper @error('is_father_alive')has-error has-feedback @enderror @error('father_age')has-error has-feedback @enderror"
                            id="fatheragenull">
                            <label class="radio-inline flive"><input type="radio" name="is_father_alive" value="1"
                                    {{ (old('father_alive') == 1) ? 'checked' : '' }}>হ্যাঁ </label>
                            <label class="radio-inline flive"><input type="radio" name="is_father_alive" value="0"
                                    {{ (old('father_alive') == 0) ? 'checked' : '' }}>না</label>
                            <input type="text" name="father_age" id="father_age" class="form-control"
                                value="{{ old('father_age') }}"
                                {{ (old('father_alive') == 1)? 'style=display:block;' : 'style=display:none;' }}
                                placeholder="পিতার বয়স" data-parsley-type="number" data-parsley-trigger="keyup" />
                        ...
                        <div class="col-sm-3 bt-flabels__wrapper @error('mother_alive')has-error has-feedback @enderror @error('mother_age')has-error has-feedback @enderror"
                            id="motheragenull">
                            <label class="radio-inline mlive"><input type="radio" name="is_mother_alive" value="1"
                                    {{ (old('mother_alive') == 1) ? 'checked' : '' }}>হ্যাঁ </label>
                            <label class="radio-inline mlive"><input type="radio" name="is_mother_alive" value="0"
                                    {{ (old('mother_alive') == 0) ? 'checked' : '' }}>না</label>
                            <input type="text" name="mother_age" id="mother_age" class="form-control"
                                placeholder="মাতার বয়স" value="{{ old('mother_age') }}"
                                {{ (old('mother_alive') == 1)? 'style=display:block;' : 'style=display:none;' }}
                                data-parsley-type="number" data-parsley-trigger="keyup" />
