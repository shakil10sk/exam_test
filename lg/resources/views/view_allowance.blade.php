    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center bg-primary" style="margin-top: 20px; margin-bottom: 20px; border-radius: 4px;">
                <h3 style="color: white;"><i class="icon ion-document"></i> ইউপি @if($type == 1) মুক্তিযোদ্ধাদের @elseif($type == 2) দুস্থ ও দরিদ্র ভাতা গ্রহণকারীদের @elseif($type == 3) বয়স্ক ভাতা গ্রহণকারীদের @elseif($type == 4) মাতৃত্যকালিন ভাতা গ্রহণকারীদের @elseif($type == 5) বিধবা ভাতা গ্রহণকারীদের @elseif($type == 6) প্রতিবন্ধী ভাতা গ্রহণকারীদের @elseif($type == 7) ভি জি ডি ভাতা গ্রহণকারীদের @endif তালিকা</h3>
            </div>
        </div>
    </div>
</section>
