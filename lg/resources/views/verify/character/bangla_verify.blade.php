    ...
    <table class="jolchap" align="center" border="0" height="415px" width='99%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed;">
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                <p style="line-height:25px;font-size:16px; ">
                    ...
                    : গ্রামঃ {{ $character->present_village_bn }}
                    <br> &nbsp; ডাকঘরঃ {{ $character->present_postoffice_name_bn }}
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                ...
                <p style="line-height:25px;font-size:16px;  ">
                    : গ্রামঃ {{ $character->permanent_village_bn }}
                    <br> &nbsp; ডাকঘরঃ {{ $character->permanent_postoffice_name_bn }}
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">:  {{ converter::en2bn($character->permanent_ward_no) }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: {{ converter::en2bn($character->nid) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ converter::en2bn($character->birth_id) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ converter::en2bn($character->passport_no) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: <?php echo Converter::en2bn(date('d-m-Y', strtotime($character->generate_date))); ?></font>
            </td>
        </tr>
    ...
    <table border='0' width='98%' cellpadding='0' cellspacing='0' style="border-collapse:collapse;margin:0 auto;padding-top:10px;">
        ...
        <tr>
            <td style="font-size:17px;  padding-left:50px;" height="80">&nbsp; &nbsp; &nbsp; &nbsp;  {{ ($character->resident == 1) ? "অস্থায়ী" : "স্থায়ী" }} 
                </font> বাসিন্দা। তিনি জন্মগতভাবে বাংলাদেশী এবং আমার পরিচিত। আমার জানা মতে, সে রাষ্ট্র বা সমাজ বিরোধী কাজের সাথে লিপ্ত নহে। তাহার স্বভাব ও নৈতিক চরিত্র ভাল এবং প্রশংসনীয়।  </td>
