...
<html lang="en-US">
    ...
    <body>
        ...
        <table border="0" cellpadding="5" cellspacing="5" style="border-collapse:collapse;margin-left: 50px; " width="95%">
            <tr>
                <td style="text-align: center; {{($prottyon->photo)?"padding-left:100px;":""}} padding-bottom:50px;">
                    <h2>
                ...
                <td  valign="top" style="text-align: center;" >
                    ...
                    @if($prottyon->photo)
                        <img src="{{ env('ADMIN_ASSET_URL').'/images/application/'. $prottyon->photo }}" height="80px" width="80px" style=""/>
                    @endif
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-left: 50px; " width="95%">
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ converter::en2bn(date('d-m-Y', strtotime($prottyon->created_time))) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2" style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($prottyon->tracking) }}
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($prottyon->birth_id) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    হোল্ডিং নং
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($prottyon->permanent_holding_no) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        :
                        <?php echo converter::en2bn(date('d-m-Y', strtotime($prottyon->
                        birth_date)));?>
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($prottyon->mobile) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    ই-মেইল
            ...
            <tr>
                ...
                <td style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ converter::en2bn($prottyon->passport_no) }}
                    </span>
                </td>
            </tr>
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none;height: 80px;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $prottyon->present_village_bn }},   রোড/ব্লক/সেক্টর : {{ $prottyon->present_rbs_bn }},     পোষ্ট অফিস :{{ $prottyon->present_postoffice_name }},   ওয়ার্ড নং : {{ converter::en2bn($prottyon->present_ward_no) }}
                        <br/>
            ...
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none; border-bottom:none;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $prottyon->permanent_village_bn }},   রোড/ব্লক/সেক্টর : {{ $prottyon->permanent_rbs_bn }},     পোষ্ট অফিস :{{ $prottyon->permanent_postoffice_name }},   ওয়ার্ড নং : {{ converter::en2bn($prottyon->permanent_ward_no) }}
                        <br/>
                        উপজেলা/থানা :{{ $prottyon->permanent_upazila_name }},     জেলা :{{ $prottyon->permanent_district_name }}
                    </p>
                </td>
            </tr>
        </table>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-left: 50px; margin-top: 20px; " width="95%">
            <tr>
                ...
                <td rowspan="4" style="height:140px;width:160px; border-top:1px solid black; border-left:1px solid black;">
                    ...
                    $url = request()->root().'/verify/prottyon_application/'.$prottyon->tracking.'/'.$prottyon->union_id.'/'.$prottyon->type;
