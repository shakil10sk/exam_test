...
<body>
        ...
        <table style="width:95%; margin-left:48px;border-color:lightgray;border-collapse:collapse;margin-top:10px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td rowspan="3" valign="top" style="text-align: left;" >
                    @if($sonaton->photo != '' )
                        <img src="{{ env('ADMIN_ASSET_URL').'/images/application/'.$sonaton->photo }}" height="100px" width="100px" style="" alt="profile" />
    ...
    <table class="jolchap" align="center" border="0" height="415px" width='99%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed;">
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">:  {{ converter::en2bn($sonaton->permanent_ward_no) }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: {{ converter::en2bn($sonaton->nid) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ converter::en2bn($sonaton->birth_id) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ converter::en2bn($sonaton->passport_no) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: <?php echo converter::en2bn(date('d-m-Y', strtotime($sonaton->generate_date))); ?></font>
            </td>
        </tr>
    ...
    <table border='0' width='98%' cellpadding='0' cellspacing='0' style="border-collapse:collapse;margin:0 auto;padding-top:10px;">
        ...
        <tr>
            <td style="font-size:17px;  padding-left:50px;" height="80">&nbsp; &nbsp; &nbsp; &nbsp; 
                আমার জানামতে সে অত্র ইউনিয়ন এর {{ converter::en2bn($sonaton->permanent_ward_no) }} নং ওয়ার্ডের সনাতন ধর্ম অবলম্বী একজন {{ ($sonaton->resident == 1) ? "অস্থায়ী" : "স্থায়ী" }} বাসিন্দা । 
