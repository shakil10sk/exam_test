...
<body>
    ...
    <table class="jolchap" align="center" border="0" height="415px" width='99%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed;">
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                <p style="line-height:25px;font-size:16px; ">
                    ...
                    <br> &nbsp; ডাকঘরঃ {{ $ekoinam->present_postoffice_name_bn }}
                    <br> &nbsp; উপজেলাঃ {{ $ekoinam->present_upazila_name_bn }}
                    <br> &nbsp; জেলাঃ {{ $ekoinam->present_district_name_bn}}</p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                ...
                <p style="line-height:25px;font-size:16px;  ">
                    ...
                    <br> &nbsp; ডাকঘরঃ {{ $ekoinam->permanent_postoffice_name_bn }}
                    <br> &nbsp; উপজেলাঃ {{ $ekoinam->permanent_upazila_name_bn }}
                    <br> &nbsp; জেলাঃ {{ $ekoinam->permanent_district_name_bn }} 
                </p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">:  {{ converter::en2bn($ekoinam->permanent_ward_no) }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: {{ converter::en2bn($ekoinam->nid) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ converter::en2bn($ekoinam->birth_id) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ converter::en2bn($ekoinam->passport_no) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: <?php echo converter::en2bn(date('d-m-Y', strtotime($ekoinam->generate_date))); ?></font>
            </td>
        </tr>
    ...
    <table border='0' width='98%' cellpadding='0' cellspacing='0' style="border-collapse:collapse;margin:0 auto;padding-top:10px;">
        ...
        <tr>
            <td style="font-size:17px;  padding-left:50px;" height="80">&nbsp; &nbsp; &nbsp; &nbsp; তিনি অত্র ইউনিয়নের অন্তগত {{ converter::en2bn($ekoinam->permanent_ward_no) }} নং ওয়ার্ডের {{ ($ekoinam->resident == 1) ? "অস্থায়ী" : "স্থায়ী" }} বাসিন্দা, আমার জানামতে {{ $ekoinam->nickname_bn }} প্রকাশে {{ $ekoinam->name_bn }} একই ব্যাক্তি উভয় নামে পরিচিত।
            </td>
    ...
    <table border="0" width='99%' style="border-collapse:collapse; margin:5px auto; height: 100px" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td  style="font-size:16px;">&nbsp;{{ $ekoinam->comment_bn }} 
            </td>
        </tr>
