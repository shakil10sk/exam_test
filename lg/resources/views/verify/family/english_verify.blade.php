...
<html>
    ...
    <body>
            ...
            <tr>
                <td style="padding-left: 50px; height: 25px;"> 
                    <font style="font-size:16px; padding-left:30px;"> 
                                {{ ($data['warish_data']->gender == 1) ? "He" : "She" }} is a <span>{{ ($data['warish_data']->resident == 1) ? "Temporary" : "Permanent" }} </span> resident in this Union. listed below people are member of his family. </font>
                </td>
            </tr>
        </table>
        ...
        <table width="98%" border="0" style="padding-top:5px;border-collapse:collapse;margin:0px auto;">
            <tr>
                <td style="font-size:16px; padding-left: 50px"> I wish all the good things of {{ ($data['warish_data']->gender == 1) ? "his" : "her" }} family. </td>
            </tr>
        </table>
