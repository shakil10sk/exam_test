...
namespace App\Http\Controllers\Management\Voter;
...
class VoterController extends Controller
{
    ...
    //get all voter
    public function viewAllVoter()
    {
        $data = CitizenInformation::getCitizenInNid($this->unionId);
        return view('all_voter_list', ['unionProfile' => $this->unionProfile, 'path' => $this->path, 'data' => $data]);
    }
}
