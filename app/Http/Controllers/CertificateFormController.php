...
class CertificateFormController extends Controller
{
    ...
    public function showApplicationForm($id)
    {
        ...
        elseif ($id == 90) {
            ...
            return view('application_form.premises', $data);
        }elseif ($id == 91) {
            $data['id'] = $id;
            return view('application_form.animal', $data);

        }elseif ($id == 92) {
            $data['id'] = $id;
            return view('application_form.new_holding', $data);

        }elseif ($id == 93) {
            $data['id'] = $id;
            return view('application_form.holding_namjari', $data);

        }elseif ($id == 95) {
            $data['id'] = $id;

            return view('application_form.emarot', $data);
        }elseif ($id == 96) {
            $data['id'] = $id;

            return view('application_form.landuse', $data);
        }
    }
}
