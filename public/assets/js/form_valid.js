        ...
        if(searchData == ''){
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if(res.data.gender == 1 && res.data.marital_status == 2){
                        $('#wife').show();
                    ...
                    else if(res.data.gender == 2 && res.data.marital_status == 2){
                        $('#husband').show();
                    ...
                    $('#husband_name_bn').val(res.data.husband_name_bn);
                    ...
                    $('#permanent_postoffice_id').val(res.data.permanent_postoffice_id);
