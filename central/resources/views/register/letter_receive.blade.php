@extends('layout.main',['title'=> 'Letter Receive'])
...
@section('content')
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h2 class="tx-gray-800 mg-b-5">পত্র প্রাপ্তি রেজিষ্টার</h2>
    </div>
        ...
        <div class="br-section-wrapper m-0 p-0">
            <div class="card ">
                <div class="card-header">
                    <form action="{{ route('letter.receive') }}" method="get">
                    ...
                    <table class="table datatable">
                        <thead>
                            <tr>
                                ...
                                <th>প্রাপ্ত চিঠির নং ও তারিখ</th>
                                <th>কোন  অফিস হতে প্রাপ্ত </th>
                                <th>জবাব নং ও তারিখ </th>
                                <th>প্রাপ্ত চিঠির সংক্ষিপ্ত বিবরণ</th>
                                <th>ফাইল</th>
                            </tr>
                        </thead>
                        <tbody>
