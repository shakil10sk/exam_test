<style type="text/css">
    ...
    body {
        ...
        @if(strtotime(date('Y-m-d')) > strtotime($trade['organization']['expire_date']))
            ...
            @if(!empty($trade['organization']))
                    ...
                    <tr>
                        <td>
                            <table style="width: 100%">
                                <tr>
                                    <td>ইস্যু
                                        তারিখঃ {{ Converter::en2bn(Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $trade['organization']['generate_date'])->format('d-m-Y')) }}</td>
                                    <td style="text-align: right;padding-right: 5px;">মেয়াদ
                                        উত্তীর্ণঃ {{Converter::en2bn( Carbon\Carbon::parse($trade['organization']['expire_date'])->format('d-m-Y')) }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td valign="top" style="text-align: center;">
                            ...
                            @foreach($trade['organization']['owner_list'] as $owner)
                                ...
                                @else
                                    ...
                                    <img src="{{ asset('/images/defult_user.jpg') }}" height="80px"
                                         width="80px"/>
                ...
                <table width="95%" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        ...
                        <td style="font-size:16px; text-align:left;">
                            :&nbsp;{{ Converter::en2bn($trade['organization']['mobile']) }}</td>
                ...
                <table width="95%" cellpadding="0" cellspacing="0" border="1"
                       style="border-collapse:collapse;border:1px solid black; text-align: center; margin:0 auto; margin-top: 20px">
                        ...
                        <tr height='25px'>
                            <td colspan="4">
                                ...
                                <p style="font-size:15px;">ঠিকানা
                                    :&nbsp;গ্রাম/মহল্লাঃ&nbsp;{{ $owner['permanent_village_bn'] }}
                                    &nbsp;ওয়ার্ড নংঃ&nbsp;{{ Converter::en2bn($owner['permanent_ward_no']) }}
                ...
                <table class="jolchap" align="center" border="0" height="200px" width='99%' cellspacing="0"
                       cellspacing='0'
                       style="border-collapse:collapse;margin:0 auto;table-layout:fixed; margin-top: 1px">

                    <tr>
                        <td align='left'
                            style="font-size:16px;text-indent:20px; font-color:black; width: 200px; padding-left: 50px">
                            ব্যবসা প্রতিষ্ঠানের ঠিকানা
                        </td>
                        <td  style=" font-size:16px; text-align:left;">
                            :&nbsp;গ্রাম/মহল্লাঃ{{ $trade['organization']['trade_village_bn'] }}
                            &nbsp;&nbsp;ওয়ার্ড নংঃ&nbsp;{{ Converter::en2bn($trade['organization']['trade_ward_no']) }}
                    ...
                    @foreach ($trade['fee_data'] ?? [] as $item)
                        <tr>
                            <td align="left" nowrap
                                style="font-size:16px;text-indent:55px; font-color:black; width: 200px; padding-left: 50px">{{$item['account_name']}}</td>
                            <td style="text-align:left;font-size:16px; ">
                                :&nbsp;{{ Converter::en2bn($item['amount']??0)}}&nbsp;টাকা</span></td>
                        </tr>

                        @php
                            if($item['account_type'] == 24){    // discount
                                $total -= $item['amount'] ?? 0;
                            } else {
                                $total += $item['amount'] ?? 0;
                            }
                ...
                <table border='0' width='98%' cellpadding='0' cellspacing='0'
                    ...
                    <tr>
                        <td style="font-size:17px;  padding-left:50px;" height="80">&nbsp; &nbsp; &nbsp; &nbsp; উল্লেখিত
                            ...
                            করিয়া {{ Converter::en2bn($trade['organization']['fiscal_year_name']) }} সালের জন্য আবশ্যকীয়
