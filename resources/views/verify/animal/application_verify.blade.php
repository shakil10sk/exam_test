        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-left: 50px;" width="95%">
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ converter::en2bn(date('d-m-Y', strtotime($animal->created_time))) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2" style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($animal->tracking) }}
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        :
                        <?php echo converter::en2bn(date('d-m-Y', strtotime($animal->
                        birth_date)));?>
                    </span>
                </td>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($animal->birth_id) }}
                    </span>
                </td>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($animal->permanent_holding_no) }}
                    </span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ converter::en2bn($animal->passport_no) }}
                    </span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ converter::en2bn($animal->jolatongko_date) }}
                    </span>
                </td>
                ...
                <td colspan="" style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($animal->jolatongko_next_date) }}
                    </span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ converter::en2bn($animal->animal_keeping_date) }}
                    </span>
                </td>
                ...
                <td style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ converter::en2bn($animal->animal_age) }}
                    </span>
                </td>
            </tr>
            ...
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none;height: 80px;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $animal->present_village_bn }},   রোড/ব্লক/সেক্টর : {{ $animal->present_rbs_bn }},     পোষ্ট অফিস :{{ $animal->present_postoffice_name }},   ওয়ার্ড নং : {{ converter::en2bn($animal->present_ward_no) }}
                        <br/>
            ...
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none; border-bottom:none;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $animal->permanent_village_bn }},   রোড/ব্লক/সেক্টর : {{ $animal->permanent_rbs_bn }},     পোষ্ট অফিস :{{ $animal->permanent_postoffice_name }},   ওয়ার্ড নং : {{ converter::en2bn($animal->permanent_ward_no) }}
                        <br/>
    ...
    @endphp
            ...
            <tr style="height:100px;">
                <td colspan="6" style="border-left:none; border-bottom:none;height:80px;">
                    <p>
                    আমি অঙ্গীকার করিতেছি যে,আমি গত <b>{{converter::en2bn(date('d-m-Y', strtotime($animal->animal_keeping_date)))}}</b> তারিখ /সাল হইতে উল্লেখিত <b>{{$animal_type}}</b> পালন করি। জলাতংক টিকাদানের পরবর্তী তারিখের মধ্যে পোষা প্রাণীকে টিকা প্রদান করিব এবং পৌরসভার বিধি বিধান মানিয়া চলিব।
                    </p>
                </td>
            </tr>
