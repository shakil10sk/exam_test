...
<html lang="en-US">
    ...
    <body>
        ...
        <table border="0" cellpadding="5" cellspacing="5" style="border-collapse:collapse;margin-left: 50px;" width="95%">
            <tr>
                <td style="text-align: center; {{($death->photo)?"padding-left:100px;":""}} padding-bottom:50px;">
                    <h2>
                ...
                <td  valign="top" style="text-align: center;" >
                    ...
                    @if($death->photo)
                        <img src="{{ env('ADMIN_ASSET_URL').'/images/application/'. $death->photo }}" height="80px" width="80px" style=""/>
                    @endif
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-left: 50px;" width="95%">
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ converter::en2bn(date('d-m-Y', strtotime($death->created_time))) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2" style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($death->tracking) }}
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($death->birth_id) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    হোল্ডিং নং
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($death->permanent_holding_no) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        :
                        <?php echo converter::en2bn(date('d-m-Y', strtotime($death->
                        birth_date)));?>
                    </span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ converter::en2bn($death->passport_no) }}
                    </span>
                </td>
            </tr>
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none;height: 80px;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $death->present_village_bn }},   রোড/ব্লক/সেক্টর : {{ $death->present_rbs_bn }},     পোষ্ট অফিস :{{ $death->present_postoffice_name }},   ওয়ার্ড নং : {{ converter::en2bn($death->present_ward_no) }}
                        <br/>
            ...
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none; border-bottom:none;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $death->permanent_village_bn }},   রোড/ব্লক/সেক্টর : {{ $death->permanent_rbs_bn }},     পোষ্ট অফিস :{{ $death->permanent_postoffice_name }},   ওয়ার্ড নং : {{ converter::en2bn($death->permanent_ward_no) }}
                        <br/>
    ...
    <table width="95%"  cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;margin-left: 50px; margin-top: 40px; ">
        <tr>
        ...
        <tr>
            <td  style="border-bottom:1px solid black;">
             ...
             <td rowspan="4" style="height:140px;width:160px; border-top:1px solid black; border-left:1px solid black;">
                    ...
                    $url = request()->root().'/verify/death_application/'.$death->tracking.'/'.$death->union_id.'/'.$death->type;
                    // echo $url;
