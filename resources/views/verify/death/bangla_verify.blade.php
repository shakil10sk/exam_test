...
<body>
    ...
    <table border='0' width='98%' cellpadding='0' cellspacing='0' style="border-collapse:collapse;margin:0 auto;padding-top:10px;">
        ...
        <tr>
            <td style="font-size:17px;  padding-left:50px;" height="80">&nbsp; &nbsp; &nbsp; &nbsp; তিনি গত- <?php echo converter::en2bn(date('d-m-Y', strtotime($death->birth_date))); ?> ইং তারিখে মৃত্যু বরণ করিয়াছেন। তিনি অত্র পৌরসভার {{ converter::en2bn($death->permanent_ward_no) }} নং ওর্য়াডের স্থায়ী বাসিন্দা ছিলেন ।</td>
