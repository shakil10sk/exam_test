        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-left: 50px; " width="95%">
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ Converter::en2bn(date('d-m-Y', strtotime($newholding->created_time))) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ Converter::en2bn($newholding->pin) }}
                    </span>
                </td>
                ...
                <td colspan="2" style="border-left:none;">
                    <span>
                        : {{ Converter::en2bn($newholding->tracking) }}
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ Converter::en2bn($newholding->birth_id) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    হোল্ডিং নং
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ Converter::en2bn($newholding->permanent_holding_no) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        :
                        <?php echo Converter::en2bn(date('d-m-Y', strtotime($newholding->
                        birth_date)));?>
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ Converter::en2bn($newholding->mobile) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    ই-মেইল
            ...
            <tr>
                ...
                <td colspan="" style="border-left:none;">
                    <span>
                        : {{ Converter::en2bn($newholding->nid) }}
                    </span>
                </td>
                ...
                <td style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ Converter::en2bn($newholding->passport_no) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ Converter::en2bn($newholding->holding_construction_date) }}
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none;height: 80px;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $newholding->present_village_bn }},   রোড/ব্লক/সেক্টর : {{ $newholding->present_rbs_bn }},     পোষ্ট অফিস :{{ $newholding->present_postoffice_name }},   ওয়ার্ড নং : {{ Converter::en2bn($newholding->present_ward_no) }}
                        <br/>
            ...
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none; border-bottom:none;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $newholding->permanent_village_bn }},   রোড/ব্লক/সেক্টর : {{ $newholding->permanent_rbs_bn }},     পোষ্ট অফিস :{{ $newholding->permanent_postoffice_name }},   ওয়ার্ড নং : {{ Converter::en2bn($newholding->permanent_ward_no) }}
                        <br/>
