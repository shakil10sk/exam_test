...
<html lang="en-US">
    ...
    <body>
        ...
        <table border="0" cellpadding="5" cellspacing="5" style="border-collapse:collapse;margin-left: 50px; " width="95%">
            <tr>
                <td style="text-align: center; {{($yearlyincome->photo)?"padding-left:100px;":""}} padding-bottom:50px;">
                    <h2>
                ...
                <td  valign="top" style="text-align: center;" >
                    ...
                    @if($yearlyincome->photo)
                        <img src="{{ env('ADMIN_ASSET_URL').'/images/application/'. $yearlyincome->photo }}" height="80px" width="80px" style=""/>
                    @endif
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-left: 50px; " width="95%">
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ converter::en2bn(date('d-m-Y', strtotime($yearlyincome->created_time))) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ converter::en2bn($yearlyincome->pin) }}
                    </span>
                </td>
                ...
                <td colspan="2" style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($yearlyincome->tracking) }}
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($yearlyincome->birth_id) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    হোল্ডিং নং
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($yearlyincome->permanent_holding_no) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        :
                        <?php echo converter::en2bn(date('d-m-Y', strtotime($yearlyincome->
                        birth_date)));?>
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($yearlyincome->mobile) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    ই-মেইল
            ...
            <tr>
                ...
                <td colspan="" style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($yearlyincome->nid) }}
                    </span>
                </td>
                ...
                <td style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ converter::en2bn($yearlyincome->passport_no) }}
                    </span>
                </td>
            </tr>
            ...
            <tr>
				...
				<td colspan="2" style="border-left:none;"><span>: {{ converter::en2bn($yearlyincome->amount) }} টাকা মাত্র</span></td>
            ...
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none;height: 80px;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $yearlyincome->present_village_bn }} &nbsp;রোড/ব্লক/সেক্টর : &nbsp;{{ $yearlyincome->present_rbs_bn }}&nbsp;পোষ্ট অফিস :&nbsp;{{ $yearlyincome->present_postoffice_name }}&nbsp;ওয়ার্ড নং : {{ converter::en2bn($yearlyincome->present_ward_no) }}
                        <br/>
            ...
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none; border-bottom:none;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $yearlyincome->permanent_village_bn }}&nbsp;রোড/ব্লক/সেক্টর : {{ $yearlyincome->permanent_rbs_bn }}&nbsp;পোষ্ট অফিস :{{ $yearlyincome->permanent_postoffice_name }}&nbsp;ওয়ার্ড নং : {{ converter::en2bn($yearlyincome->permanent_ward_no) }}
                        <br/>
        ...
        <!--        <td rowspan="4" style="height:140px;width:160px; border-top:1px solid black; border-left:1px solid black;">-->
                <?php
                   ...
                   //$url = request()->root().'/verify/yearlyincome_application/'.$yearlyincome->tracking.'/'.$yearlyincome->union_id.'/'.$yearlyincome->type;
                ...
                <tr>
					<td  style="border-bottom:1px solid black;">
					    <ul style="padding-left:50px;list-style:none; font-size:13px;">
						    <li>১) &nbsp; আবেদন পত্রটি  সংশ্লিষ্ট সাধারণ ওয়ার্ড কাউন্সিলর এবং সংরক্ষিত আসনে কাউন্সিলর কর্তৃক স্বাক্ষর নিয়ে নির্ধারিত শাখায় জমা দিন। </li>

                             <li>২) &nbsp; পৌর কর পরিশোধ এর ভাউচার সাথে জমা দিন।</li>

                             <li>৩)&nbsp; জন্ম নিবন্ধন / জাতীয় পরিচয় পত্রের ফটোকপি সাথে জমা দিন।</li>

                            <li>৪) &nbsp; আবেদন কপি টি প্রিন্ট করে ১৫দিনের মধ্যে সংশ্লিষ্ট শাখায় জমা দিন। অন্যথায় আবেদন টি বাতিল বলে গণ্য হবে। </li>
