...
<body>
                ...
                <td  valign="top" style="text-align: center;" >
                    ...
                    @foreach($premises['owner_list'] as $owner)
                        ...
                        @if(!empty($owner->photo))
                            ...
                            <img src="{{ env('ADMIN_ASSET_URL').'/images/application/'. $owner->photo }}" height="80px"
                                 width="80px" style="" />
		...
		<table width="95%"  cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;margin-left: 50px; margin-top: 20px; ">
			...
			<tr>
				...
				<td style="font-size:16px; text-align:left;">:&nbsp;{{ $premises['tracking'] }}</td>
				<td style="">আবেদনের তারিখ</td>
				<td style="">:&nbsp;{{ converter::en2bn(date('d-m-Y')) }}</td>
			</tr>

            <tr>
                <td style="text-indent: 20px;text-align:left; font-size:16px;">ব্যবসা প্রতিষ্ঠানের নাম</td>
                <td style="font-size:16px; text-align:left;">:&nbsp;{{ $premises['organization_name_bn'] }}</td>
                <td style="text-indent: 20px;text-align:left; font-size:16px;">ব্যবসার ধরণ</td>
                <td style="font-size:16px; text-align:left;">:&nbsp;{{ $premises['business_type'] }}</td>
            </tr>

            <tr>
                <td style="text-indent: 20px;text-align:left; font-size:16px;">মোবাইল</td>
                <td style="font-size:16px; text-align:left;">:&nbsp;{{ Converter::en2bn($premises['mobile']) }}</td>
        ...
        <table width="88%" cellpadding="0" cellspacing="0" border="1" style="border-collapse:collapse;border:1px dashed lightgray; text-align: center; margin:0 auto; margin-top: 20px" >
                ...
                <tr height='25px' >
                    <td colspan="4">
                        ...
                        :গ্রাম/মহল্লাঃ &nbsp;{{ $owner->permanent_village_bn }}&nbsp;রোডঃ&nbsp;{{ $owner->permanent_rbs_bn }}
                      ওয়ার্ড নং:&nbsp; {{ Converter::en2bn($owner->permanent_ward_no) }}&nbsp;{{ $owner->permanent_postoffice_name }}&nbsp; {{ $owner->permanent_upazila_name }}&nbsp; {{ $owner->permanent_district_name }}
                        </p>
			...
			<table class="jolchap" align="center" border="0" height="115px" width='99%' cellspacing="0"
                   cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed; margin-top: 10px">

                <tr>
                    <td valign='top' align='left'  style="font-size:16px;text-indent:55px; font-color:black; width:
                    228px;
                    padding-left: 40px">ব্যবসা প্রতিষ্ঠানের ঠিকানা</td>
                    <td valign='top' style="font-weight:bold; font-size:18px; text-align:left;"> : গ্রাম/মহল্লা:{{
                    $premises['trade_village_bn']  }}
                    ওয়ার্ড নং:&nbsp;{{ Converter::en2bn($premises['trade_ward_no']) }}&nbsp;{{
                    $premises['trade_postoffice_name'] }}
                    &nbsp;{{ $premises['trade_upazila_name'] }},&nbsp;{{
                    $premises['trade_district_name'] }}
                    </td>
                </tr>
    ...
    <table width="95%"  cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;margin-left: 50px; margin-top: 20px; ">
        ...
        <tr>
           ...
           <td rowspan="4" style="height:140px;width:160px; border-top:1px solid black; border-left:1px solid black;">
                ...
                $url = request()->root().'/verify/premises_application/'.$premises['tracking'].'/'.$premises['union_id'].$type;
                ?>
