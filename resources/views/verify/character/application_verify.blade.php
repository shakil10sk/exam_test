...
<html lang="en-US">
    ...
    <body>
        ...
        <table border="0" cellpadding="5" cellspacing="5" style="border-collapse:collapse;margin-left: 50px;" width="95%">
            <tr>
                <td style="text-align: center; {{($character->photo)?"padding-left:100px;":""}} padding-bottom:50px;">
                    <h2>
                ...
                <td  valign="top" style="text-align: center;" >
                    ...
                    @if($character->photo)
                        <img src="{{ env('ADMIN_ASSET_URL').'/images/application/'. $character->photo }}" height="80px" width="80px" style=""/>
                    @endif
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-left: 50px;" width="95%">
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ converter::en2bn(date('d-m-Y', strtotime($character->created_time))) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2" style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($character->tracking) }}
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
						...
						@if($character->marital_status == 1)
						 	অবিবাহিত
						@elseif($character->marital_status == 2)
							বিবাহিত
						@elseif($character->marital_status == 3)
							তালাকপ্রাপ্ত
						@elseif($character->marital_status == 4)
							বিধবা
						@else
							অন্যান্য
						@endif
                ...
                @if ($character->marital_status == 2 && $character->gender == 2 && !empty($character->husband_name_bn))
                <td colspan="">
                    স্বামীর নাম
                </td>
                <td colspan="" style="border-left:none;">
                    <span>
                        :  {{ $character->husband_name_bn }}
                    </span>
                </td>
                @endif @if ($character->marital_status == 2 && $character->gender == 1 && !empty($character->wife_name_bn))
                <td colspan="" style="border-left: none">
                    স্ত্রীর নাম
                </td>
                <td colspan="" style="border-left:none;">
                    <span>
                        :  {{ $character->wife_name_bn }}
                    </span>
                </td>
                @endif
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($character->birth_id) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    হোল্ডিং নং
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($character->permanent_holding_no) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ $character->educational_qualification }}
                    </span>
                </td>
                <td style="border-left:none ">
                    জন্ম তারিখ
                ...
                <td style="border-left:none;">
                    <span>
                        :
                        <?php echo converter::en2bn(date('d-m-Y', strtotime($character->
                        birth_date)));?>
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ converter::en2bn($character->mobile) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    ই-মেইল
            ...
            <tr>
                ...
                <td style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ converter::en2bn($character->passport_no) }}
                    </span>
                </td>
            </tr>
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none;height: 80px;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $character->present_village_bn }},   রোড/ব্লক/সেক্টর : {{ $character->present_rbs_bn }},     পোষ্ট অফিস :{{ $character->present_postoffice_name }},   ওয়ার্ড নং : {{ converter::en2bn($character->present_ward_no) }}
                        <br/>
                        উপজেলা/থানা :{{ $character->present_upazila_name }},     জেলা :{{ $character->present_district_name }}
                    </p>
                </td>
            </tr>
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none; border-bottom:none;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $character->permanent_village_bn }},   রোড/ব্লক/সেক্টর : {{ $character->permanent_rbs_bn }},     পোষ্ট অফিস :{{ $character->permanent_postoffice_name }},   ওয়ার্ড নং : {{ converter::en2bn($character->permanent_ward_no) }}
                        <br/>
                        উপজেলা/থানা :{{ $character->permanent_upazila_name }},     জেলা :{{ $character->permanent_district_name }}
                    </p>
                </td>
            </tr>
        </table>
    ...
    <table width="95%"  cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;margin-left: 50px; margin-top: 20px; ">
        ...
        <tr>
            <td  style="border-bottom:1px solid black;">
                ...
                <li>
                    ১)   আবেদনপত্রটি সংশ্লিষ্ট ওয়ার্ড কাউন্সিলর এবং সংরক্ষিত আসনের কাউন্সিলর কর্তৃক স্বাক্ষর নিয়ে নির্ধারিত শাখায় জমা দিন।
                </li>
                <li>
            ...
            <td rowspan="4" style="height:140px;width:160px; border-top:1px solid black; border-left:1px solid black;">
                    ...
                    $url = request()->root().'/verify/character_application/'.$character->tracking.'/'.$character->union_id.'/'.$character->type;
