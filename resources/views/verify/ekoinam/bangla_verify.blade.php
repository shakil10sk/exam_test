...
<body>
    ...
    <table border='0' width='98%' cellpadding='0' cellspacing='0' style="border-collapse:collapse;margin:0 auto;padding-top:10px;">
        ...
        <tr>
            <td style="font-size:17px;  padding-left:50px;" height="80">&nbsp; &nbsp; &nbsp; &nbsp; তিনি অত্র পৌরসভার অন্তগত {{ converter::en2bn($ekoinam->permanent_ward_no) }} নং ওয়ার্ডের {{ ($ekoinam->resident == 1) ? "অস্থায়ী" : "স্থায়ী" }} বাসিন্দা, আমার জানামতে {{ $ekoinam->nickname_bn }} প্রকাশে {{ $ekoinam->name_bn }} একই ব্যাক্তি উভয় নামে পরিচিত।
            </td>
