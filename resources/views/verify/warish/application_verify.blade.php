...
{{--						</tr>--}}
						...
						<tr>
							<td>মৃত্যু তারিখ</td>
							<td><p>:@if (!empty($data['warish_data']->death_date))
                                {{ Converter::en2bn(date('d-m-Y', strtotime($data['warish_data']->death_date))) }}
                            @endif
                        </p></td>
						</tr>
                ...
                <tr>
					...
					<td rowspan="4" style="height:140px;width:160px; border-top:1px solid black; border-left:1px solid black;">
						<?php
                            ...
                            $url =  request()->root().'/verify/warish_application/'.$data['warish_data']->tracking.'/'.$data['warish_data']->union_id.'/'.$data['warish_data']->type;
