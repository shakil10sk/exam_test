        ...
        <table style="width:95%; margin-left:48px;border-color:lightgray;border-collapse:collapse;margin-top:10px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    ...
                    <table border="1" style="width: 600px;border-color:lightgray;border-collapse:collapse;" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            $sonod = str_split($land->certificate_data->sonod_no);

                            for($i=0; $i<strlen($land->certificate_data->sonod_no); $i++):
                ...
                <td rowspan="3" valign="top" style="text-align: left;" >
                   @if($land->certificate_data->photo != '' )
                        <img src="{{ asset('images/application/'.$land->certificate_data->photo) }}" height="100px" width="100px" style="" alt="profile" />
                    @endif
                </td>
            ...
            <table class="jolchap" align="center" border="0" height="415px" width='99%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed; line-height: 1.5;">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <font style="font-size:16px;">:  {{ $land->certificate_data->name_bn }}</font>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <font style="font-size:16px; ">: {{ $land->certificate_data->father_name_bn }} </font>
                    </td>

                    <td align="left" style="font-size:16px;text-indent:55px; font-color:black; padding-left: 50px">মাতার নাম</td>

                    <td>
                        <font style="font-size:16px;  ">: {{ $land->certificate_data->mother_name_bn }} </font>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <font style="font-size:16px; ">: {{ BanglaConverter::bn_number($land->certificate_data->nid) }} </font>
                    </td>

                    <td align="left" style="font-size:16px;text-indent:55px; font-color:black; padding-left: 50px">জন্ম নিবন্ধন নং</td>

                    <td>
                        <font style="font-size:16px;  ">: {{ BanglaConverter::bn_number($land->certificate_data->birth_id) }} </font>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <font style="font-size:16px; ">: {{ BanglaConverter::bn_number($land->certificate_data->mobile) }} </font>
                    </td>

                    <td align="left" style="font-size:16px;text-indent:55px; font-color:black; padding-left: 50px">ইমেইল</td>

                    <td>
                        <font style="font-size:16px;  ">: {{ $land->certificate_data->email }} </font>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style=" vertical-align:top;">
                        <p style="line-height:25px;font-size:16px; ">
                            ...
                            : গ্রামঃ {{ $land->certificate_data->present_village_bn }}
                            <br> &nbsp; ডাকঘরঃ {{ $land->certificate_data->present_postoffice_name_bn }}
                            <br> &nbsp; উপজেলাঃ {{ $land->certificate_data->present_upazila_name_bn }}
                            <br> &nbsp; জেলাঃ {{ $land->certificate_data->present_district_name_bn}}</p>
                    </td>
                    ...
                    <td style="vertical-align:top;">
                        <p style="line-height:25px;font-size:16px; ">
                            ...
                            : গ্রামঃ {{ $land->certificate_data->permanent_village_bn }}
                            <br> &nbsp; ডাকঘরঃ {{ $land->certificate_data->permanent_postoffice_name_bn }}
                            <br> &nbsp; উপজেলাঃ {{ $land->certificate_data->permanent_upazila_name_bn }}
                            <br> &nbsp; জেলাঃ {{ $land->certificate_data->permanent_district_name_bn}}</p>
                    </td>
                </tr>
            ...
            <table width="90%" height="100px"   cellpadding="0" cellspacing="0" border="1" style="
            border-collapse:collapse;margin:0px auto; font-size: 13px ">
                ...
                <tr>
                    <td style="padding-left:10px;font-size:15px;font-family:solaimanLipi;">{{ $land->certificate_data->mojar_name  }}</td>
                    <td style="padding-left:20px;font-size:15px;font-family:solaimanLipi;text-align:justify">
                        সি.এস- {{ $land->certificate_data->khotian_no_cs  }}</br>
                        এস এ- {{ $land->certificate_data->khotian_no_sa }}</br>
                        আর এস- {{ $land->certificate_data->khotian_no_rs }}</br>
                    </td>
                    <td style="padding-left:20px;font-size:15px;font-family:solaimanLipi;">
                        সি.এস- {{ $land->certificate_data->dag_no_cs }} </br>
                        এস এ- {{ $land->certificate_data->dag_no_sa }}</br>
                        আর এস- {{ $land->certificate_data->dag_no_rs }}</br>
                    </td>
                    <td style="padding-left:10px;font-size:15px;font-family:solaimanLipi;"> {{
                        $land->certificate_data->land_type }}</td>
                    <td style="padding-left:10px;font-size:15px;font-family:solaimanLipi;">
                        {{  $land->certificate_data->land_amount }}</td>
                </tr>

            </table>

            <table width="97%" height="50px"  cellpadding="0" cellspacing="0" border="0px" style="table-layout:fixed;
            border-collapse:collapse;margin:0px auto;">
                <tr>
                    <td style="padding-left:20px;font-size:15px;font-family:solaimanLipi;text-indent:20px">উপরোক্ত
                        ...
                        বর্ণিত শর্তাধিনে {{ $land->certificate_data->plot_proposed_use }} ভবনের জন্য ভূমি ব্যবহার ছাড়পত্রের
                        অনুমতি
                        প্রদান করা হলো।</td>
                </tr>
            ...
            <table width="92%" height="10px" cellpadding="0" cellspacing="0" border="0px" style="border-collapse:collapse;margin: 0px auto;table-layout: fixed;text-align:justify" >
                <tr valign='bottom'>
                    <td style="padding-left:20px;font-size:13px;font-family:solaimanLipi;"><span
                        ...
                        করতে হবে।<span style="font-weight:bold;">@if($land->certificate_data->road_consider!='')১০।
                        </span> {{  $land->certificate_data->road_consider  }} @endif
                    </td>
                </tr>
            </table>
        ...
        <tr>
            ...
            <tr>
                <td colspan="{{$colspan}}" style="padding-left:20px;font-size:16px;box-sizing: border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;border-bottom: 1px solid black; vertical-align: bottom;">
                    <b> স্মারক নং-সাপৌস/প্রকৌঃ/{{ BanglaConverter::bn_number($land->certificate_data->fiscal_year_name )  }}/{{
                    BanglaConverter::bn_number($land->certificate_data->sonod_no )  }} </b>
                    <br />
                ...
                <td rowspan="1" style="border-left:1px solid black; border-top:1px solid black;">
                    ...
                    $url = $url.'/verify/landuse_bn/'.$land->certificate_data->sonod_no.'/'.$land->certificate_data->union_id.'/'.$land->certificate_data->type;
                    // dd($url);
