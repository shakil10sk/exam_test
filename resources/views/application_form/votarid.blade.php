...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center bg-primary" style="margin-top: 20px; margin-bottom: 20px; border-radius: 4px;">
                    <h4 style="color: white;">ভোটার আইডি স্থানান্তর সনদের আবেদন</h4>
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container">
        <form id="form-data" data-route="{{ $path.'/api/application/voterid' }}" method="post" enctype="multipart/form-data" class="uk-form bt-flabels js-flabels" data-parsley-validate data-parsley-errors-messages-disabled>
                @csrf
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            <label for="union_name_bn" class="col-sm-3 control-label">পূর্বের ইউনিয়ন (ইংরেজিতে)</label>
                            <div class="col-sm-3 bt-flabels__wrapper" id="union_name_en_status">
                                <input type="text" name="union_name_en" id="union_name_en" class="form-control" placeholder="" data-parsley-maxlength="100" data-parsley-trigger="keyup" />
                                <span class="bt-flabels__error-desc">পূর্বের ইউনিয়ন দিন ইংরেজিতে....</span>

                                <span id="union_name_en_feedback" class="help-block"></span>
                            </div>
                            <label for="union_name_bn" class="col-sm-3 control-label">পূর্বের ইউনিয়ন (বাংলায়) <span>*</span></label>
                            <div class="col-sm-3 bt-flabels__wrapper" id="union_name_bn_status">
                                <input type="text" name="union_name_bn" id="union_name_bn" class="form-control" placeholder="" data-parsley-maxlength="100" data-parsley-trigger="keyup"  data-parsley-required />
                                <span class="bt-flabels__error-desc">পূর্বের ইউনিয়ন দিন বাংলায়....</span>

                                <span id="union_name_bn_feedback" class="help-block"></span>
                            </div>
                        </div>
                    </div>
