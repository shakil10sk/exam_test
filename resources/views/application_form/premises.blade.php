    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center bg-primary"
                ...
                <h4 style="color: white;">প্রিমিসেস লাইসেন্স আবেদন</h4>
            </div>
        </div>
    </div>
</section>
...
<section>
    <div class="container">
        <form id="form-data" data-route="{{ $path.'/api/application/premises' }}" method="post"
                            ...
                            <div class="panel-body" style="width: 100%;">
                                ...
                                <div class="row" style="margin-top: 50px;">
                                    <div class="col-sm-12 text-center">
                                        ...
                                        <p style="font-size:15px;text-align:center; font-weight:normal;padding-top:10px;"
            ...
            <div class="row" style="margin-top: 50px;">
                ...
                <div class="col-sm-12">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-3 bt-flabels__wrapper">
                            <input type="text" name="previous_license_data" id="previous_license_data" value="{{ old
                            ('previous_license_data') }}" data-date-format="yyyy-mm-dd"
                                   class="form-control datepicker" data-date-format="yyyy-mm-dd"
                                   placeholder="{{ date('Y-m-d')  }}" autocomplete="previous_license_data"
...
@section('script')
<script src="{{ asset('js/pemises_license_form.js') }}"></script>
