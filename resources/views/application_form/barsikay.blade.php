...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center bg-primary" style="margin-top: 20px; margin-bottom: 20px; border-radius: 4px;">
                    <h4 style="color: white;">বার্ষিক আয়ের প্রত্যয়ন আবেদন</h4>
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container">
        <form id="form-data" data-route="{{ $path.'/api/application/yearlyincome' }}" method="post" enctype="multipart/form-data" class="uk-form bt-flabels js-flabels" data-parsley-validate data-parsley-errors-messages-disabled>
                @csrf
                ...
                <div class="row" style="margin-top: 50px;">
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="earn_type_status">
                                <select name="earn_type" class="form-control" data-parsley-required >
                                    <option value=''>চিহ্নিত করুন</option>
                                    <option value='1' >মাসিক</option>
                                    <option value='2'>বার্ষিক</option>
                                </select>
                                <span class="bt-flabels__error-desc">আয়ের ধরণ চিহ্নিত করুন....</span>

                                <span id="earn_type_feedback" class="help-block"></span>
                            </div>

                            <label for="yearly_income" class="col-sm-3 control-label">আয়ের পরিমান (ইংরেজিতে) <span>*</span></label>
                            <div class="col-sm-3 bt-flabels__wrapper" id="yearly_income_status">
                                <input type="text" name="yearly_income" id="yearly_income" class="form-control"   placeholder="আয়ের পরিমান" data-parsley-type="number" data-parsley-trigger="keyup" data-parsley-required/>
                                <span class="bt-flabels__error-desc">আয়ের পরিমান দিন ইংরেজিতে....</span>

                                <span id="yearly_income_feedback" class="help-block"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="birth_id_status">
                                <input type="text" name="birth_id" id="birth_id" value="{{ old('birth_id') }}" class="form-control datepicker" autocomplete="birth_id" autofocus data-parsley-maxlength="17" data-parsley-type="number" data-parsley-trigger="keyup" placeholder="1919623458679011" />
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="present_holding_no_status">
                                <input type="text" name="present_holding_no" id="present_holding_no" value="{{ old('present_holding_no') }}" class="form-control" autocomplete="present_holding_no" autofocus  />
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="permanent_holding_no_status">
                                <input type="text" name="permanent_holding_no" id="permanent_holding_no" value="{{ old('permanent_holding_no') }}" class="form-control" autocomplete="permanent_holding_no" />
                                <span class="bt-flabels__error-desc">হোল্ডিং নং দিন ইংরেজিতে....</span>
...
@section('script')
    <script src="{{ asset('js/form_valid.min.js') }}"></script>
