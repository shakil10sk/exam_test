...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center bg-primary" style="margin-top: 20px; margin-bottom: 20px; border-radius: 4px;">
                    <h4 style="color: white;">রাস্তা খননের অনুমতির আবেদন</h4>
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container">
            <form id="form-data" data-route="{{ $path.'/api/application/roadexcavation' }}" method="post" enctype="multipart/form-data" class="uk-form bt-flabels js-flabels" data-parsley-validate data-parsley-errors-messages-disabled>
                @csrf
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="road_holding_no" data-parsley-required id="road_holding_no" value="{{ old('road_holding_no') }}" data-parsley-trigger="keyup" class="form-control @error('road_holding_no') is-invalid @enderror" autocomplete="road_holding_no" autofocus placeholder="Holding No" />
