...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center bg-primary" style="margin-top: 20px; margin-bottom: 20px; border-radius: 4px;">
                    <h4 style="color: white;"> নতুন হোল্ডিং
                        আবেদন</h4>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container">
        <form id="form-data" data-route="{{ $path.'/api/application/newholding' }}" method="post"
...
@enderror" placeholder="প্রস্তাবিত হোল্ডিং এর পার্শ্ববর্তী হোল্ডিং দিন" data-parsley-maxlength="100"
                        ...
                        <label for="holding_construction_date" class="col-sm-3 control-label">প্রস্তাবিত হোল্ডিং এর নির্মাণ তারিখ <span class="text-danger">*</span> </label>

                        <div class="col-sm-3 bt-flabels__wrapper">
                            <input type="text" name="holding_construction_date" id="holding_construction_date"
                                   value="{{ old('holding_construction_date') }}" class="form-control datepicker" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-parsley-type="date" data-parsley-maxlength="100"
                                   data-parsley-trigger="keyup" data-parsley-required />
