...
@section('content')
    <section>
        <div class="container">
            <div class="row">
                <div class="bg-primary col-md-12 text-center" style="margin-top: 20px; margin-bottom: 20px; border-radius: 4px;">
    ...
    <section>
        <div class="container">
            <form id="form-data" data-route="{{ $path.'/api/application/family' }}" method="post" enctype="multipart/form-data" class="uk-form bt-flabels js-flabels" data-parsley-validate data-parsley-errors-messages-disabled>
                @csrf
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="name_en_status">
                                <input type="text" name="name_en" id="name_en" value="{{ old('name_en') }}" class="form-control" placeholder="Full Name" autocomplete="name_en" autofocus data-parsley-pattern='^[a-zA-Z. ]+$' data-parsley-trigger="keyup" />
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="birth_date_status">
                                <input type="text" name="birth_date" value="{{ old('birth_date') }}" id="birth_date" class="form-control datepicker" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" autocomplete="birth_date" autofocus data-parsley-type="date" />
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="father_name_bn_status">
                                <input type="text" name="father_name_bn" id="father_name_bn" value="{{ old('father_name_bn') }}" class="form-control" autocomplete="father_name_bn" autofocus placeholder="পিতার নাম"  />
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="mother_name_bn_status">
                                <input type="text" name="mother_name_bn" id="mother_name_bn" value="{{ old('mother_name_bn') }}" class="form-control" autocomplete="mother_name_bn" autofocus placeholder="মাতার নাম" data-parsley-trigger="keyup"  />
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="present_ward_no_status">
                                <input type="text" name="present_ward_no" id="present_ward_no" value="{{ old('present_ward_no') }}" class="form-control" autocomplete="present_ward_no" autofocus  data-parsley-trigger="keyup" data-parsley-required  />
...
{{--                                </select>--}}
                ...
                <div class="row" style="margin-top: 50px;">
                    <div class="col-sm-12 text-center">
                        ...
                        <p style="font-size:15px; text-align:center; font-weight:normal;padding-top:10px;" id="addressCheck"> <input type="checkbox" name="permanentBtn" id="permanentBtn" {{ old('permanentBtn') ? 'checked' : '' }} />ঠিকানা একই হলে টিক দিন</p>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="permanent_ward_no_status">
                                <input type="text" name="permanent_ward_no" id="permanent_ward_no" value="{{ old('permanent_ward_no') }}" class="form-control" autocomplete="permanent_ward_no" autofocus  data-parsley-trigger="keyup" data-parsley-required/>
                                <span class="bt-flabels__error-desc">ওয়ার্ড নং দিন ইংরেজিতে....</span>
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="applicant_mobile_status">
                                <input type="text" name="applicant_mobile" value="{{ old('applicant_mobile') }}" class="form-control" autocomplete="mobile" autofocus data-parsley-type="digits" data-parsley-minlength="11" data-parsley-maxlength="11" data-parsley-trigger="keyup" placeholder="ইংরেজিতে প্রদান করুন" />
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="applicant_email_status">
                                <input type="text" name="applicant_email" value="{{ old('applicant_email') }}" class="form-control" autocomplete="email" autofocus placeholder="example@gmail.com" data-parsley-type="email" data-parsley-trigger="keyup" />
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="applicant_name_en_status">
                                <input type="text" name="applicant_name_en" id="applicant_name_en" value="{{ old('applicant_name_en') }}" class="form-control" autocomplete="applicant_name_en" autofocus data-parsley-pattern='^[a-zA-Z. ]+$' data-parsley-trigger="keyup" />
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="applicant_name_bn_status">
                                <input type="text" name="applicant_name_bn" id="applicant_name_bn" value="{{ old('applicant_name_bn') }}" class="form-control" autocomplete="applicant_name_bn" autofocus data-parsley-required />
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="applicant_father_name_en_status">
                                <input type="text" name="applicant_father_name_en" id="applicant_father_name_en" value="{{ old('applicant_father_name_en') }}" class="form-control" autocomplete="applicant_father_name_en" autofocus data-parsley-pattern='^[a-zA-Z. ]+$' data-parsley-trigger="keyup" />
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="applicant_father_name_bn_status">
                                <input type="text" name="applicant_father_name_bn" id="applicant_father_name_bn" value="{{ old('applicant_father_name_bn') }}" class="form-control" autocomplete="applicant_father_name_bn" autofocus data-parsley-required />
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            <div class="col-sm-2 bt-flabels__wrapper" id="warish_name_bn_0_status">
                                <input type="text" name="warish_name_bn[]" id="warish_name_bn_0" class="form-control" placeholder="নাম বাংলায়"/>
                                <span class="bt-flabels__error-desc">নাম দিন বাংলায়....</span>

                                <span id="warish_name_bn_0_feedback" class="help-block"></span>
                            </div>
                            <div class="col-sm-2 bt-flabels__wrapper" id="warish_name_en_0_status">
                                <input type="text" name="warish_name_en[]" id="warish_name_en_0" class="form-control" placeholder="নাম ইংরেজিতে" data-parsley-pattern='^[a-zA-Z. ]+$' data-parsley-trigger="keyup" />
                                <span class="bt-flabels__error-desc">নাম দিন ইংরেজিতে....</span>

                                <span id="warish_name_en_0_feedback" class="help-block"></span>
                            </div>
                            <div class="col-sm-2 bt-flabels__wrapper" id="relation_bn_0_status">
                                <input type="text" name="relation_bn[]" id="relation_bn_0" class="form-control"  placeholder="সম্পর্ক বাংলায়"/>
                            ...
                            <div class="col-sm-2 bt-flabels__wrapper" id="relation_en_0_status">
                                <input type="text" name="relation_en[]" id="relation_en_0" class="form-control" placeholder="সম্পর্ক ইংরেজিতে" data-parsley-pattern='^[a-zA-Z. ]+$' data-parsley-trigger="keyup" />
                            ...
                            <div class="col-sm-2 bt-flabels__wrapper" id="member_nid_0_status">
                                <input type="text" name="member_nid[]" id="member_nid_0" placeholder="পরিচয় পত্র নং ইংরেজিতে" class="form-control" data-parsley-type="number" data-parsley-trigger="keyup"/>
                                <span class="bt-flabels__error-desc"> পরিচয় পত্র নং ইংরেজিতে....</span>
