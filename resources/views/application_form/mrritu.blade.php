...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center bg-primary" style="margin-top: 20px; margin-bottom: 20px; border-radius: 4px;">
                    <h4 style="color: white;">মৃত্যু সনদের আবেদন</h4>
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container">
        <form id="form-data" data-route="{{ $path.'/api/application/mrritu' }}" method="post" enctype="multipart/form-data" class="uk-form bt-flabels js-flabels" data-parsley-validate data-parsley-errors-messages-disabled>
                @csrf
                ...
                <div class="row" style="margin-top: 50px;">
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            <label for="name_en" class="col-sm-3 control-label">মৃত ব্যাক্তির নাম (ইংরেজিতে)</label>
                            ...
                            <label for="name_bn" class="col-sm-3 control-label">মৃত ব্যাক্তির নাম (বাংলায়) <span>*</span></label>
...
{{--
                            ...
                            <label for="birth_date" class="col-sm-3 control-label">মৃত্যু তারিখ <span>*</span></label>

                            <div class="col-sm-3 bt-flabels__wrapper" id="birth_date_status">
                                <input type="text" name="birth_date" id="death_date" value="{{ old('birth_date') }}" class="form-control death_date" placeholder="yyyy-mm-dd" autocomplete="birth_date" autofocus data-parsley-type="date"  />
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            <label for="comment_en" class="col-sm-3 control-label">মৃত্যুর কারন ও স্থান দিন(ইংরেজিতে)</label>
                            ...
                            <label for="comment_bn" class="col-sm-3 control-label">মৃত্যুর কারন ও স্থান দিন (বাংলায়)</label>
