...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center bg-primary" style="margin-top: 20px; margin-bottom: 20px; border-radius: 4px;">
                    <h4 style="color: white;">পোষা প্রাণীর লাইসেন্সের আবেদন</h4>
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container">
        <form id="form-data" data-route="{{ $path.'/api/application/animal' }}" method="post"
            ...
            <div class="row" style="margin-top: 50px;">
                ...
                <div class="col-md-12">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-3 bt-flabels__wrapper">
                            <input type="text" name="jolatongko_date" value="{{ old('jolatongko_date') }}" id="jolatongko_date" class="form-control datepicker" autocomplete="jolatongko_date" autofocus data-parsley-type="date" data-parsley-trigger="keyup" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" />
                        ...
                        <div class="col-sm-3 bt-flabels__wrapper">
                            <input type="text" name="jolatongko_next_date" value="{{ old('jolatongko_next_date') }}"
                                   id="jolatongko_next_date" class="form-control datepicker"
                                   autocomplete="jolatongko_next_date" autofocus data-parsley-type="date"
                ...
                <div class="col-md-12">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-3 bt-flabels__wrapper">
                            <input type="text" name="animal_keeping_date" value="{{ old('animal_keeping_date') }}"
                                   id="animal_keeping_date" class="form-control datepicker"
                                   autocomplete="animal_keeping_date" autofocus data-parsley-type="date"
                                   data-parsley-trigger="keyup" data-parsley-required  placeholder="yyyy-mm-dd"  data-date-format="yyyy-mm-dd" />
