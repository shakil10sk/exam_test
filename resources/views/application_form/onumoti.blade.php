...
@section('content')
    ...
    <section>
        <div class="container">
        <form id="form-data" data-route="{{ $path.'/api/application/onumoti' }}" method="post" enctype="multipart/form-data" class="uk-form bt-flabels js-flabels" data-parsley-validate data-parsley-errors-messages-disabled>
                @csrf
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="job_sector_en_status">
                                <input type="text" name="job_sector_en" id="job_sector_en" class="form-control"  placeholder="" data-parsley-pattern='^[a-zA-Z.(),:;_ ]+$' data-parsley-trigger="keyup" />
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper" id="job_sector_bn_status">
                                <input type="text" name="job_sector_bn" id="job_sector_bn" class="form-control" placeholder=" অনুমতি পত্র  ক্ষেত্রে  যেমন-সেনাবাহিনীতে" data-parsley-required />
