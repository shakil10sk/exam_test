            ...
            <div class="row" style="margin-top: 50px;">
                <div class="col-md-8 col-sm-offset-2">
                    ...
                    <ul>
                        ...
                        <li id="role">আপনি যদি পূর্বে কোনো সনদ নিয়ে থাকেন, নিচের সার্চ বক্সে আপনার
                            ন্যাশনাল আইডি নং অথবা জন্ম নিবন্ধন নং অথবা পাসপোর্ট নং অথবা
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row form-group">
                                            ...
                                            <label for="present_village_bn_{{ $key }}"
                                                class="col-sm-3 control-label">গ্রাম/মহল্লা (বাংলায়) <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row form-group">
                                            ...
                                            <label for="present_ward_no_{{ $key }}"
                                                class="col-sm-3 control-label">ওয়ার্ড নং <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row form-group">
                                            <label for="present_district_id_{{ $key }}"
                                                class="col-sm-3 control-label">জেলা <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row form-group">
                                            <label for="present_upazila_id_{{ $key }}"
                                                class="col-sm-3 control-label">উপজেলা/থানা <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row form-group">
                                            <label for="present_postoffice_id_{{ $key }}"
                                                class="col-sm-3 control-label">পোষ্ট অফিস <span class="text-danger">*</span></label>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-3 bt-flabels__wrapper @error('trade_holding_no')has-error has-feedback @enderror"
                            ...
                            <input type="text" name="trade_holding_no" id="trade_holding_no"
                                ...
                                autocomplete="trade_holding_no" autofocus
                                data-parsley-trigger="keyup" />
                            <span class="bt-flabels__error-desc">হোল্ডিং নং দিন ইংরেজিতে....</span>
...
{{--                            </select>--}}
                        ...
                        <label for="trade_district" class="col-sm-3 control-label">জেলা <span class="text-danger">*</span></label>
                        <div class="col-sm-3">
...
{{--                            </select>--}}
                        ...
                        <label for="trade_upazila" class="col-sm-3 control-label">উপজেলা/থানা <span class="text-danger">*</span></label>
                        <div class="col-sm-3">
...
{{--                            </select>--}}
                        ...
                        <label for="trade_postoffice" class="col-sm-3 control-label">পোষ্ট অফিস <span class="text-danger">*</span></label>
                        <div class="col-sm-3">
...
{{--        <option {{ (old('business_type') == $item->id) ? 'selected="selected"' : '' }} value="{{$item->id}}"> {{$item->name_bn}} </option>--}}
{{--    @endforeach--}}
