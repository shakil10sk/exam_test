...
class Protibondi extends Model
{
    use SoftDeletes;

    //====protibondi application store====//
    ...
    //protibondi preview data
    public function protibondi_information($tracking = null, $union_id = null, $type = null)
    {
    ...
    //===protibondi edit data=======//
    public function protibondi_data($tracking, $union_id = null)
    {
    ...
    public function sonod_generate($receive)
    {
        ...
        $voucher_no =  IdGenerate::voucher($receive->union_id, $receive->fiscal_year_id, 22);
    ...
    //====protibondi certificate data=====//

    public function protibondi_certificate_data($sonod_no = null, $union_id = null, $type = null)
    {
    ...
    public function update_protibondi($receive)
    {
    ...
    //===protibondi info delete===//
    public function protibondi_info_delete($request)
    {
    ...
    //===protibondi applicant list data=====//

    public function protibondi_applicant_list_data($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //====protibondi certificate list data====//
    public function protibondi_certificate_list($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //get protibondi register data

    public function protibondi_register_data($union_id = null, $type = null, $from_date = null, $to_date = null){
