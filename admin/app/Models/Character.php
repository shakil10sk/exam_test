...
class Character extends Model
{
    ...
    public function character_information($tracking = null, $union_id = null, $type = null)
    {
    ...
    //===character edit data=======//
    public function character_data($tracking, $union_id = null)
    {
    ...
    public function sonod_generate($receive)
    {
        ...
        $voucher_no =  IdGenerate::voucher($receive->union_id, $receive->fiscal_year_id, 8);
    ...
    public function character_certificate_data($sonod_no = null, $union_id = null, $type = null)
    {
    ...
    public function update_character($receive)
    {
    ...
    //===character info delete===//
    public function character_info_delete($request)
    {
    ...
    //===character applicant list data=====//

    public function character_applicant_list_data($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //====character certificate list data====//
    public function character_certificate_list($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //get character register data

    public function character_register_data($union_id = null, $type = null, $from_date = null, $to_date = null){
