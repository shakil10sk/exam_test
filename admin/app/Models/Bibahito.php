...
class Bibahito extends Model
{
    use SoftDeletes;

    //====bibahito application store====//
    ...
    //bibahito preview data
    public function bibahito_information($tracking = null, $union_id = null, $type = null)
    {
    ...
    //===bibahito edit data=======//
    public function bibahito_data($tracking, $union_id = null)
    {
    ...
    public function sonod_generate($receive)
    {
        ...
        DB::transaction(function () use ($receive, $sonod_data, $transaction_data) {
    ...
    //====bibahito certificate data=====//

    public function bibahito_certificate_data($sonod_no = null, $union_id = null, $type = null)
    {
        ...
        $data = DB::table('certificate AS CRT')
                ...
                ->select('CTZ.*', 'APP.created_time as application_date', 'APP.present_village_bn', 'APP.present_village_en', 'APP.present_rbs_bn', 'APP.present_rbs_en', 'APP.present_ward_no', 'APP.present_holding_no', 'APP.present_postoffice_id','APP.present_upazila_id', 'APP.present_district_id', 'APP.tracking', 'APP.comment_bn', 'APP.comment_en', 'CRT.sonod_no', 'CRT.pin', 'CRT.fiscal_year_id', 'CRT.status', 'CRT.created_time as generate_date', 'BDL1.bn_name as permanent_district_name_bn', 'BDL1.en_name as permanent_district_name_en', 'BDL2.bn_name as permanent_upazila_name_bn', 'BDL2.en_name as permanent_upazila_name_en', 'BDL3.bn_name as permanent_postoffice_name_bn', 'BDL3.en_name as permanent_postoffice_name_en', 'BDL4.bn_name as present_district_name_bn', 'BDL4.en_name as present_district_name_en', 'BDL5.bn_name as present_upazila_name_bn', 'BDL5.en_name as present_upazila_name_en', 'BDL6.bn_name as present_postoffice_name_bn', 'BDL6.en_name as present_postoffice_name_en', 'APP.type','CTZ.wife_name_bn','CTZ.wife_name_en')
    ...
    public function update_bibahito($receive)
    {
    ...
    //===bibahito info delete===//
    public function bibahito_info_delete($request)
    {
    ...
    //===bibahito applicant list data=====//

    public function bibahito_applicant_list_data($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //====bibahito certificate list data====//
    public function bibahito_certificate_list($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //get bibahito register data

    public function bibahito_register_data($union_id = null, $type = null, $from_date = null, $to_date = null){
