...
class Vumihin extends Model
{
    use SoftDeletes;

    //====vumihin application store====//
    ...
    //vumihin preview data
    public function vumihin_information($tracking = null, $union_id = null, $type = null)
    {
...
// dd($data);
    ...
    //===vumihin edit data=======//
    public function vumihin_data($tracking, $union_id = null)
    {
    ...
    public function sonod_generate($receive)
    {
        ...
        $voucher_no =  IdGenerate::voucher($receive->union_id, $receive->fiscal_year_id, 11);
    ...
    //====vumihin certificate data=====//

    public function vumihin_certificate_data($sonod_no = null, $union_id = null, $type = null)
    {
    ...
    public function update_vumihin($receive)
    {
    ...
    //===vumihin info delete===//
    public function vumihin_info_delete($request)
    {
    ...
    //===vumihin applicant list data=====//

    public function vumihin_applicant_list_data($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //====vumihin certificate list data====//
    public function vumihin_certificate_list($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //get vumihin register data

    public function vumihin_register_data($union_id = null, $type = null, $from_date = null, $to_date = null){
