...
{
    use SoftDeletes;
    //====yearlyincome application store====//
    public function data_store($request)
    {
        ...
        DB::transaction(function () use ($request, $citizen_data, $application_data) {
            ...
            $citizen_extra_info = [
                ...
                'union_id'         => $request->union_id,
                'name_one'         => $request->earn_type,
                'name_two'         => $request->yearly_income,
                'type'             => $request->type,
                'created_by'       => $request->created_by,
                'created_time'     => Carbon::now(),
                'created_by_ip'    => $request->ip()
    ...
    //yearlyincome preview data
    public function yearlyincome_information($tracking = null, $union_id = null, $type = null)
    {
    ...
    //===yearlyincome edit data=======//
    public function yearlyincome_data($tracking, $union_id = null)
    {
        ...
        $data = DB::table('application AS APP')
            ...
            ->select('APP.*', 'APP.id as application_id', 'CTZ.*', 'CTZ.id as citizen_id', 'BDL1.bn_name as permanent_district_name_bn', 'BDL1.en_name as permanent_district_name_en', 'BDL2.bn_name as permanent_upazila_name_bn', 'BDL2.en_name as permanent_upazila_name_en', 'BDL3.bn_name as permanent_postoffice_name_bn', 'BDL3.en_name as permanent_postoffice_name_en', 'BDL4.bn_name as present_district_name_bn', 'BDL4.en_name as present_district_name_en', 'BDL5.bn_name as present_upazila_name_bn', 'BDL5.en_name as present_upazila_name_en', 'BDL6.bn_name as present_postoffice_name_bn', 'BDL6.en_name as present_postoffice_name_en', 'OPTINF.name_one as earn_type', 'OPTINF.name_two as amount')
    ...
    public function sonod_generate($receive)
    {
       ...
       $sonod_data = [
        ...
        $voucher_no =  IdGenerate::voucher($receive->union_id, $receive->fiscal_year_id, 21);
    ...
    //====yearlyincome certificate data=====//

    public function yearlyincome_certificate_data($sonod_no = null, $union_id = null, $type = null)
    {
    ...
    public function update_yearlyincome($receive)
    {
        ...
        DB::transaction(function () use ($receive, $citizen_update_data, $application_update_data) {
            ...
            $citizen_extra_info_update = [
                ...
                'name_one'         => $receive->earn_type,
                'name_two'         => $receive->yearly_income,
                'updated_by'            => Auth::User()->employee_id,
                'updated_time'          => Carbon::now(),
                'updated_by_ip'         => Request::ip(),
    ...
    //===yearlyincome info delete===//
    public function yearlyincome_info_delete($request)
    {
    ...
    //===yearlyincome applicant list data=====//

    public function yearlyincome_applicant_list_data($receive, $search_content)
    {
        DB::enableQueryLog();
        ...
        if($search_content != false){
            ...
            $query->Where("APP.tracking", "LIKE", $search_content)
    ...
    //====yearlyincome certificate list data====//
    public function yearlyincome_certificate_list($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //get yearlyincome register data

    public function yearlyincome_register_data($union_id = null, $type = null, $from_date = null, $to_date = null){
