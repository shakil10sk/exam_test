...
class Ekoinam extends Model
{
    use SoftDeletes;
    //====ekoinam application store====//
    public function data_store($request)
    {
        ...
        DB::transaction(function () use ($request, $citizen_data, $application_data) {
            ...
            $citizen_extra_info = [
                ...
                'union_id'         => $request->union_id,
	            'name_one'    	   => $request->nickname_en,
	            'name_two'    	   => $request->nickname_bn,
	            'type'        	   => $request->type,
	            'created_by'       => $request->created_by,
                'created_time'     => Carbon::now(),
                'created_by_ip'    => $request->ip(),
    ...
    //ekoinam preview data
    public function ekoinam_information($tracking = null, $union_id = null, $type = null)
    {
    ...
    //===ekoinam edit data=======//
    public function ekoinam_data($tracking, $union_id = null)
    {
        ...
        $data = DB::table('application AS APP')
            ...
            ->select('APP.*', 'APP.id as application_id', 'CTZ.*', 'CTZ.id as citizen_id', 'BDL1.bn_name as permanent_district_name_bn', 'BDL1.en_name as permanent_district_name_en', 'BDL2.bn_name as permanent_upazila_name_bn', 'BDL2.en_name as permanent_upazila_name_en', 'BDL3.bn_name as permanent_postoffice_name_bn', 'BDL3.en_name as permanent_postoffice_name_en', 'BDL4.bn_name as present_district_name_bn', 'BDL4.en_name as present_district_name_en', 'BDL5.bn_name as present_upazila_name_bn', 'BDL5.en_name as present_upazila_name_en', 'BDL6.bn_name as present_postoffice_name_bn', 'BDL6.en_name as present_postoffice_name_en', 'OPTINF.name_one as nickname_en', 'OPTINF.name_two as nickname_bn')
    ...
    public function sonod_generate($receive)
    {
       ...
       $sonod_data = [
        ...
        $voucher_no =  IdGenerate::voucher($receive->union_id, $receive->fiscal_year_id, 26);
    ...
    //====ekoinam certificate data=====//

    public function ekoinam_certificate_data($sonod_no = null, $union_id = null, $type = null)
    {
...
// dd($data);
    ...
    public function update_ekoinam($receive)
    {
        ...
        DB::transaction(function () use ($receive, $citizen_update_data, $application_update_data) {
            ...
            $citizen_extra_info_update = [
                ...
                'name_one'      => $receive->nickname_en,
                'name_two'      => $receive->nickname_bn,
                'updated_by'            => Auth::User()->employee_id,
                'updated_time'          => Carbon::now(),
                'updated_by_ip'         => Request::ip(),
    ...
    //===ekoinam info delete===//
    public function ekoinam_info_delete($request)
    {
    ...
    //===ekoinam applicant list data=====//

    public function ekoinam_applicant_list_data($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //====ekoinam certificate list data====//
    public function ekoinam_certificate_list($receive, $search_content)
    {
       DB::enableQueryLog();
    ...
    //get ekoinam register data

    public function ekoinam_register_data($union_id = null, $type = null, $from_date = null, $to_date = null){
