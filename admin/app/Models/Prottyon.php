...
use Request;
use Image;
class Prottyon extends Model
{
    use SoftDeletes;

    //====prottyon application store====//
    ...
    //prottyon preview data
    public function prottyon_information($tracking = null, $union_id = null, $type = null)
    {
    ...
    //===prottyon edit data=======//
    public function prottyon_data($tracking, $union_id = null)
    {
    ...
    public function sonod_generate($receive)
    {
        ...
        $voucher_no =  IdGenerate::voucher($receive->union_id, $receive->fiscal_year_id, 10);
    ...
    //====prottyon certificate data=====//

    public function prottyon_certificate_data($sonod_no = null, $union_id = null, $type = null)
    {
    ...
    public function update_prottyon($receive)
    {
    ...
    //===prottyon info delete===//

    public function prottyon_info_delete($request)
    {
    ...
    //===prottyon applicant list data=====//

    public function prottyon_applicant_list_data($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //====prottyon certificate list data====//
    public function prottyon_certificate_list($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //get prottyon register data

    public function prottyon_register_data($union_id = null, $type = null, $from_date = null, $to_date = null){
