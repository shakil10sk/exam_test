...
class Obibahito extends Model
{
    use SoftDeletes;

    //====obibahito application store====//
    ...
    //obibahito preview data
    public function obibahito_information($tracking = null, $union_id = null, $type = null)
    {
    ...
    //===obibahito edit data=======//
    public function obibahito_data($tracking, $union_id = null)
    {
    ...
    public function sonod_generate($receive)
    {
        ...
        $voucher_no =  IdGenerate::voucher($receive->union_id, $receive->fiscal_year_id, 14);
    ...
    //====obibahito certificate data=====//

    public function obibahito_certificate_data($sonod_no = null, $union_id = null, $type = null)
    {
    ...
    public function update_obibahito($receive)
    {
    ...
    //===obibahito info delete===//
    public function obibahito_info_delete($request)
    {
    ...
    //===obibahito applicant list data=====//

    public function obibahito_applicant_list_data($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //====obibahito certificate list data====//
    public function obibahito_certificate_list($receive, $search_content)
    {
        DB::enableQueryLog();

        $query = DB::table('certificate AS CRT')

            ->select(DB::raw('SQL_CALC_FOUND_ROWS CRT.id as certificate_id'), DB::raw('CONCAT(CRT.sonod_no) as sonod_no') , 'CRT.type','CRT.id', 'CRT.pin', 'CRT.tracking', 'CTZ.id as citizen_id', 'CTZ.name_bn','CTZ.marital_status', 'CTZ.photo', 'CTZ.father_name_bn', 'CTZ.mobile', 'CTZ.union_id', 'CTZ.permanent_district_id', 'CTZ.permanent_upazila_id', 'CTZ.permanent_postoffice_id', 'CRT.created_time as generate_date')
    ...
    //get obibahito register data

    public function obibahito_register_data($union_id = null, $type = null, $from_date = null, $to_date = null){
