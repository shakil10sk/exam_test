...
class Voter extends Model
{
    ...
    public function data_store($request)
    {
        ...
        DB::transaction(function () use ($request, $citizen_data, $application_data) {
            ...
            $citizen_extra_info = [
                ...
                'union_id'         => $request->union_id,
                'name_one'         => $request->union_name_en,
                'name_two'         => $request->union_name_bn,
                'type'             => $request->type,
                'created_by'       => $request->created_by,
                'created_time'     => Carbon::now(),
                'created_by_ip'    => $request->ip()
    ...
    //voter preview data
    public function voter_information($tracking = null, $union_id = null, $type = null)
    {
    ...
    //===voter edit data=======//
    public function voter_data($tracking, $union_id = null)
    {
        ...
        $data = DB::table('application AS APP')
            ...
            ->select('APP.*', 'APP.id as application_id', 'CTZ.*', 'CTZ.id as citizen_id', 'BDL1.bn_name as permanent_district_name_bn', 'BDL1.en_name as permanent_district_name_en', 'BDL2.bn_name as permanent_upazila_name_bn', 'BDL2.en_name as permanent_upazila_name_en', 'BDL3.bn_name as permanent_postoffice_name_bn', 'BDL3.en_name as permanent_postoffice_name_en', 'BDL4.bn_name as present_district_name_bn', 'BDL4.en_name as present_district_name_en', 'BDL5.bn_name as present_upazila_name_bn', 'BDL5.en_name as present_upazila_name_en', 'BDL6.bn_name as present_postoffice_name_bn', 'BDL6.en_name as present_postoffice_name_en', 'OPTINF.name_one as union_name_en', 'OPTINF.name_two as union_name_bn')
    ...
    public function sonod_generate($receive)
    {
       ...
       $sonod_data = [
        ...
        $voucher_no =  IdGenerate::voucher($receive->union_id, $receive->fiscal_year_id, 24);
    ...
    //====voter certificate data=====//

    public function voter_certificate_data($sonod_no = null, $union_id = null, $type = null)
    {
    ...
    public function update_voter($receive)
    {
        ...
        DB::transaction(function () use ($receive, $citizen_update_data, $application_update_data) {
            ...
            $citizen_extra_info_update = [
                ...
                'name_one'      => $receive->union_name_en,
                'name_two'      => $receive->union_name_bn,
                'updated_by'            => Auth::User()->employee_id,
                'updated_time'          => Carbon::now(),
                'updated_by_ip'         => Request::ip(),
    ...
    //===voter info delete===//
    public function voter_info_delete($request)
    {
    ...
    //===voter applicant list data=====//

    public function voter_applicant_list_data($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //====voter certificate list data====//
    public function voter_certificate_list($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    public function voter_register_data($union_id = null, $type = null, $from_date = null, $to_date = null){
