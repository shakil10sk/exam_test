...
class Death extends Model
{
    ...
    public function data_store($request)
    {
        ...
        $citizen_data = [
            ...
            // 'birth_date'              => $request->birth_date, // here birth date is used for death date
    ...
    //death preview data
    public function death_information($tracking = null, $union_id = null, $type = null)
    {
    ...
    //===death edit data=======//
    public function death_data($tracking, $union_id = null)
    {
...
// dd($data);
    ...
    public function sonod_generate($receive)
    {
        ...
        $voucher_no =  IdGenerate::voucher($receive->union_id, $receive->fiscal_year_id, 18);
    ...
    public function update_death($receive)
    {
        // dd($receive);
    ...
    //===death info delete===//
    public function death_info_delete($request)
    {
    ...
    public function death_applicant_list_data($receive, $search_content)
    {
        DB::enableQueryLog();
