...
class Nagorik extends Model
{
    ...
    //nagorik preview data
    public function nagorik_information($tracking = null, $union_id = null, $type = null)
    {
    ...
    //===nagorik edit data=======//
    public function nagorik_data($tracking = null, $union_id = null)
    {
    ...
    public function sonod_generate($receive)
    {
        ...
        $voucher_no =  IdGenerate::voucher($receive->union_id, $receive->fiscal_year_id, 4);
        ...
        try {
            ...
            DB::rollBack();
            return ["status" => "error", "message" => "সনদটি জেনারেট হয়নি।"];
        }
    }

    //====nagorik certificate data=====//

    public function nagorik_certificate_data($sonod_no = null, $union_id = null, $type = null)
    {
    ...
    public function update_nagorik($receive)
    {
    ...
    //===nagorik info delete===//
    public function nagorik_info_delete($request)
    {
    ...
    //===nagorik applicant list data=====//

    public function nagorik_applicant_list_data($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //====nagorik certificate list data====//
    public function nagorik_certificate_list($receive, $search_content)
    {
    ...
    public function money_receipt_data($sonod_no = null, $union_id = null, $type = null)
    {
        ...
        $query = DB::table('citizen_information AS CTZ')
            ...
            ->select('CTZ.name_bn', 'CRT.sonod_no','CTZ.father_name_bn', 'CTZ.pin', 'CTZ.permanent_village_bn', 'CTZ.permanent_ward_no', 'CRT.sonod_no', 'TRNS.voucher', 'TRNS.amount', 'TRNS.created_time')
    ...
    //get nagorik register data

    public function nagorik_register_data($union_id = null, $type = null, $from_date = null, $to_date = null)
    {
        $query = DB::table('certificate AS CRT')
