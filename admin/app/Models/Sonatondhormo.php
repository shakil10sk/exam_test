...
class Sonatondhormo extends Model
{
    use SoftDeletes;

    //====sonatondhormo application store====//
    ...
    //sonatondhormo preview data
    public function sonatondhormo_information($tracking = null, $union_id = null, $type = null)
    {
    ...
    //===sonatondhormo edit data=======//
    public function sonatondhormo_data($tracking, $union_id = null)
    {
    ...
    //====sonatondhormo certificate data=====//

    public function sonatondhormo_certificate_data($sonod_no = null, $union_id = null, $type = null)
    {
    ...
    //======sonatondhormo update====//

    public function update_sonatondhormo($receive)
    {
    ...
    //===sonatondhormo info delete===//
    public function sonatondhormo_info_delete($request)
    {
    ...
    //===sonatondhormo applicant list data=====//

    public function sonatondhormo_applicant_list_data($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //====sonatondhormo certificate list data====//
    public function sonatondhormo_certificate_list($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //get sonatondhormo register data

    public function sonatondhormo_register_data($union_id = null, $type = null, $from_date = null, $to_date = null){
