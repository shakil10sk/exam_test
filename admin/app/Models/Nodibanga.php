...
class Nodibanga extends Model
{
    use SoftDeletes;

    //====nodibanga application store====//
    ...
    //nodibanga preview data
    public function nodibanga_information($tracking = null, $union_id = null, $type = null)
    {
    ...
    //===nodibanga edit data=======//
    public function nodibanga_data($tracking, $union_id = null)
    {
    ...
    public function sonod_generate($receive)
    {
        ...
        $voucher_no =  IdGenerate::voucher($receive->union_id, $receive->fiscal_year_id, 15);
    ...
    //====nodibanga certificate data=====//

    public function nodibanga_certificate_data($sonod_no = null, $union_id = null, $type = null)
    {
    ...
    public function update_nodibanga($receive)
    {
    ...
    //===nodibanga info delete===//
    public function nodibanga_info_delete($request)
    {
    ...
    //===nodibanga applicant list data=====//

    public function nodibanga_applicant_list_data($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //====nodibanga certificate list data====//
    public function nodibanga_certificate_list($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //get nodibanga register data

    public function nodibanga_register_data($union_id = null, $type = null, $from_date = null, $to_date = null){
