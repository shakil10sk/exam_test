...
class Punobibaho extends Model
{
    use SoftDeletes;

    //====punobibaho application store====//
    ...
    //punobibaho preview data
    public function punobibaho_information($tracking = null, $union_id = null, $type = null)
    {
    ...
    //===punobibaho edit data=======//
    public function punobibaho_data($tracking, $union_id = null)
    {
    ...
    public function sonod_generate($receive)
    {
        ...
        $voucher_no =  IdGenerate::voucher($receive->union_id, $receive->fiscal_year_id, 23);
    ...
    //====punobibaho certificate data=====//

    public function punobibaho_certificate_data($sonod_no = null, $union_id = null, $type = null)
    {
    ...
    public function update_punobibaho($receive)
    {
    ...
    //===punobibaho info delete===//

    public function punobibaho_info_delete($request)
    {
    ...
    //===punobibaho applicant list data=====//

    public function punobibaho_applicant_list_data($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //====punobibaho certificate list data====//
    public function punobibaho_certificate_list($receive, $search_content)
    {
        DB::enableQueryLog();
    ...
    //get punobibaho register data

    public function punobibaho_register_data($union_id = null, $type = null, $from_date = null, $to_date = null){
