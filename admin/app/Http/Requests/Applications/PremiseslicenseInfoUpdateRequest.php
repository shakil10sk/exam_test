...
class PremiseslicenseInfoUpdateRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'organization_name_en'   => ['string', 'max:255', 'regex:/^[a-zA-Z. ()_,;:]+$/','nullable'],
            'organization_name_bn'   => ['required','string', 'max:255', 'regex:/^[\p{Bengali}. (),;_:]{0,100}$/u'],
    ...
    public function messages()
    {
        return [
            ...
            'organization_name_en.regex'             => 'প্রতিষ্ঠানের নাম ইংরেজি বর্ণের সাথে ডট (.), কমা (,), সেমিকোলন (;), কোলন (:), ড্যাশ (_) ও ব্রাকেট () দেওয়া যাবে না....',
            ...
            'organization_name_bn.regex'             => 'প্রতিষ্ঠানের নাম বাংলা বর্ণের সাথে ডট (.), কমা (,), সেমিকোলন (;), কোলন (:), ড্যাশ (_) ও ব্রাকেট () দেওয়া যাবে না....',
