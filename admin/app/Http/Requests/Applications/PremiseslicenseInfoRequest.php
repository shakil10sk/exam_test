...
class PremiseslicenseInfoRequest extends FormRequest
{
    ...
    public function rules(Request $r)
    {
        $validation = [
            ...
            'nid.*'                     => ['numeric','max:99999999999999999', Rule::unique('citizen_information', 'nid')->where(function ($query) {$query->whereNull('deleted_at');}), 'nullable'],
