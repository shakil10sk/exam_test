...
class HoldingNamjariUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'nid'                          => ['max:17',Rule::unique('citizen_information', 'nid')->ignore
            ($this->citizen_id)->where(function ($query) {$query->whereNull('deleted_at');}), 'nullable'],
