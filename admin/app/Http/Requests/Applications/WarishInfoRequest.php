...
class WarishInfoRequest extends FormRequest
{
    /**
    ...
    public function rules(Request $r)
    {
        $validation = [
            ...
            'nid'                          => ['numeric','max:99999999999999999',Rule::unique('citizen_information', 'nid')->whereNull('deleted_at'), 'nullable'],
            'birth_id'                     => ['numeric','max:99999999999999999',Rule::unique('citizen_information', 'birth_id')->whereNull('deleted_at'),'nullable'],
            'passport_no'                  => ['string','max:99999999999999999',Rule::unique('citizen_information', 'passport_no')->whereNull('deleted_at'),'nullable'],
            ...
            'father_age'                   => ['numeric', 'max:200', 'nullable'],
            'is_mother_alive'                 => ['required'],
            'mother_age'                   => ['numeric', 'max:200', 'nullable'],
            ...
            'warish_name_bn.*'            => ['nullable'],
            'relation_bn.*'                 => ['nullable'],
            'relation_age.*'                => ['nullable'],
    ...
    public function messages()
    {
        return [
            ...
            'is_father_alive.required'     => 'অনুগ্রহ করে নির্বাচন করুন....',
            'father_age.numeric'        => 'অনুগ্রহ করে পিতার বয়স দিন....',
            'father_age.max'            => 'পিতার বয়স ২০০ বছরের নিচে দিন....',
            'is_mother_alive.required'     => 'অনুগ্রহ করে নির্বাচন করুন....',
            'mother_age.numeric'        => 'অনুগ্রহ করে মাতার বয়স দিন....',
            'mother_age.max'            => 'মাতার বয়স ২০০ বছরের নিচে  দিন....',
