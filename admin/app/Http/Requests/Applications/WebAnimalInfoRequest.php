...
class WebAnimalInfoRequest extends FormRequest
{
    ...
    public function rules()
    {
        $validation = [
            ...
            'animal_name_en'               => ['string','nullable'],
            'animal_name_bn'               => ['required','string'],

            'animal_keeping_date'          => ['required', 'date'],
    ...
    {
        return [
            'animal_type.required'      => 'পোষা প্রাণীর ধরণ নির্বাচন করুন',
            ...
            'animal_name_en.string'     => 'পোষা প্রাণীর নাম অবশ্যই ইংরেজি বর্ণের হবে',
            'animal_name_bn.required'   => 'পোষা প্রাণীর নাম দিন বাংলায়',
            'animal_name_bn.string'     => 'পোষা প্রাণীর নাম অবশ্যই বাংলা বর্ণের হবে',
            'animal_keeping_date.required' => 'পোষা প্রাণী পালনের তারিখ দিন',
