...
class FormRequestRule extends FormRequest
{
    /**
    ...
    public function rules(Request $r)
    {
        ...
        if(route('death_store') == url()->current())
        {
            unset($validation['birth_date']);
        }

        if(route('bibahito_store') == url()->current())
        {
            unset($validation['marital_status']);
        }

        if(!empty($r->pin)){
            unset($validation['nid'], $validation['birth_id'], $validation['passport_no'], $validation['resident'], $validation['religion'], $validation['marital_status']);
        }
