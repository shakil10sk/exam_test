...
var protibondi_table, fiscal_year_id, from_date, to_date;
 ...
 function applicant_list_search(){
    ...
    $("#protibondi_applicant_table").dataTable().fnSettings().ajax.data.fiscal_year_id = fiscal_year_id;
            ...
            success:function(response){
                ...
                if(response['status'] == "success"){
                    ...
                    response['data'].forEach(function(data) { 
                        ...
                        if (data.id == 28)
                            option += '<option value ="' + data.id + '"> প্রকৃত বাক ও শ্রবণ প্রতিবন্ধী সনদ</option>';
...
//this is for protibondi certificate list search
 function certificate_list_search() {
    ...
    $("#protibondi_certificate_table").dataTable().fnSettings().ajax.data.fiscal_year_id = fiscal_year_id;
