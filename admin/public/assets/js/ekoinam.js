...
var ekoinam_table, fiscal_year_id, from_date, to_date;
 ...
 function applicant_list_search(){
    ...
    $("#ekoinam_applicant_table").dataTable().fnSettings().ajax.data.fiscal_year_id = fiscal_year_id;
            ...
            success:function(response){
                ...
                if(response['status'] == "success"){
                    ...
                    response['data'].forEach(function(data) { 
                        ...
                        if (data.id == 28)
                            option += '<option value ="' + data.id + '"> একই নামের প্রত্যয়ন</option>';
...
//this is for ekoinam certificate list search
 function certificate_list_search() {
    ...
    $("#ekoinam_certificate_table").dataTable().fnSettings().ajax.data.fiscal_year_id = fiscal_year_id;
