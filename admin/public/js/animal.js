...
//===datepicker===//
$('#animal_generate_date, #from_date, #to_date').datepicker({
    language: 'en',
    autoClose: true,
    dateFormat: 'yy-mm-dd',
});

var animal_table, from_date, to_date;
                ...
                $.ajax({
                 ...
                 success: function(response) {
                    ...
                    swal({
                        ...
                        showConfirmButton: true,
                        confirmButtonText: '<a href="'+animal_bangla_sonod_url+'/'+response.sonod_no+'" target="_blank">প্রিন্ট করুন</a>',
                        closeOnConfirm: true,
         ...
         columns: [{
             ...
             },
             {
                 ...
                 render: function(data, type, row, meta) {
                    ...
                    if($('#regenerate').val()){
                        regenerate = "<a  href='javascript:void(0)' onclick='animal_regenerate("+meta.row+")' ><p class='btn btn-sm btn-primary custom_button'>রি-জেনারেট</p></a> ";
                    }
...
// this is for animal certificate list search
 ...
 // ==== animal re-generate ==== //
    function animal_regenerate(row_index){
        ...
        $("#animal_regenerate_modal").modal('show');
    }
             ...
             preConfirm: function() {
                $.ajax({
                 ...
                 success: function(response) {
                    ...
                    $("#animal_regenerate_modal").modal('hide');
