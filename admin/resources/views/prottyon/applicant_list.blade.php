...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    ...
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='prottyon_applicant_table'>
                <thead>
                    <tr>
...
@can('generate')
<div class="modal fade" id="prottyon_generate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title" id="myLargeModalLabel">প্রত্যয়ন পত্র জেনারেট</h4>
...
<script>
    ...
    var prottyon_applicant_data_url = '@php echo  url("prottyon/applicant_data") @endphp';

    var prottyon_generate_url = '@php echo  url("prottyon/generate") @endphp';

    var prottyon_delete_url = '@php echo  url("prottyon/delete") @endphp';

    //for applicant csrf
    var prottyon_applicant_csrf = '@php echo csrf_token() @endphp';

    var prottyon_generate_csrf = '@php echo csrf_token() @endphp';

    var prottyon_delete_csrf = '@php echo csrf_token() @endphp';
