...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="title text-center">
                        <h4 class="text-center application_head">প্রত্যয়ন পত্র আবেদন</h4>
                    </div>
    ...
    <section>
        <div class="container">
            <form id="form-data" action="{{ route('prottyon_store') }}" method="post" enctype="multipart/form-data" class="uk-form bt-flabels js-flabels" data-parsley-validate data-parsley-errors-messages-disabled>
                @csrf
                ...
                <div class="row" style="margin-bottom: 100px;">
                    <div class="offset-6 col-sm-6 button-style">
                        ...
                        <input type="hidden" value="7" id="app-type">
