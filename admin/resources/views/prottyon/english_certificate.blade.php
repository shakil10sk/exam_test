...
<body>
        ...
        <table style="width:95%; margin-left:48px;border-color:lightgray;border-collapse:collapse;margin-top:10px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td rowspan="3" valign="top" style="text-align: left;" >
                     @if($prottyon->photo != '' )
                        <img src="{{ asset('images/application/'.$prottyon->photo) }}" height="100px" width="100px" style="" alt="profile" />
                    @endif
                </td>
    ...
    <table class="jolchap" align="center" border="0" height="415px" width='99%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed; line-height: 1.5;">
        ...
        <tr>
            <td align="left" style="font-size:16px;text-indent:55px; font-color:black; width: 200px; padding-left: 50px">Name </font>
            </td>
            <td>
        ...
        <tr>
            <td align="left" style="font-size:16px;text-indent:55px; font-color:black; width: 200px; padding-left: 50px">Husband Name</td>
            <td>
        ...
        <tr>
            <td align="left" style="font-size:16px;text-indent:55px; font-color:black; width: 200px; padding-left: 50px ">Father's Name </td>
            <td>
        ...
        <tr>
            <td align="left" style="font-size:16px;text-indent:55px; font-color:black; width: 200px; padding-left: 50px">Mother's Name</td>
            <td>
        ...
        <tr>
            <td nowrap align="left" style="font-size:16px;text-indent:55px; font-color:black; width: 200px; padding-left: 50px;vertical-align:top; ">Present Address </td>
        ...
        <tr>
            <td nowrap align="left" style="font-size:16px;text-indent:55px; font-color:black; width: 200px; padding-left: 50px; vertical-align:top; ">Permanent Address </td>
        ...
        <tr>
            <td align="left" nowrap style="font-size:16px;text-indent:55px; font-color:black; width: 200px; padding-left: 50px">Ward No </td>
            <td>
       ...
       @if($prottyon->nid  > 0)
        ...
        <tr>
            <td align="left" nowrap style="font-size:16px;text-indent:55px; font-color:black; width: 200px; padding-left: 50px">Birth ID </td>
            <td>
        ...
        <tr>
            <td align="left" nowrap style="font-size:16px;text-indent:55px; font-color:black; width: 200px; padding-left: 50px">Passport No </td>
            <td>
        ...
        <tr>
            <td align="left" nowrap style="font-size:16px;text-indent:55px; font-color:black; width: 200px; padding-left: 50px">Date </td>
            <td>
        ...
        <tr>
            ...
            <td rowspan="1" style="border-left:1px solid black; border-top:1px solid black;">
               ...
               <?php
                ...
                $url = $url.'/verify/prottyon_en/'.$prottyon->sonod_no.'/'.$prottyon->union_id.'/'.$prottyon->type;
