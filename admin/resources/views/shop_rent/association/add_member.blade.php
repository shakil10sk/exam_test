...
@section('content')
    ...
    <section>
        <div class="container">
            <form id="form-data" action="{{ route('association_member_store') }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                ...
                                ('chanda_amount') }}" class="form-control @error('chanda_amount')is-invalid
