...
@section('content')
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="title">
                    <h4><i class="icon-copy fa fa-file-text" aria-hidden="true"></i> বিল-জেনারেট</h4>
                </div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">বিল-জেনারেট</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
        <div class="clearfix mb-20">
            ...
            <div class="row justify-content-center  mt-2">
                <label class="col-md-2">পেমেন্ট তারিখ</label>
                <div class="col-md-2">
                    <input type="text" class="form-control" name="last_payment_date" id="last_payment_date"
                           value="{{ date('Y-m-d') }}">
                    <span id="last_payment_error" class="error"></span>
                </div>
            </div>
            <div class="row justify-content-center mt-3">
                <input type="button" name="" value="জেনারেট" class="col-md-2
            btn btn-primary btn-xs" onclick="bill_generate_save()">
            </div>
