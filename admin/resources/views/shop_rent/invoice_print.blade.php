...
<div class="jolchap fast_part">
    <table border="0" width="95%" align="center" style="border-collapse:collapse; margin:10px auto;">
        ...
        <tr>
            <td style="padding-left: 50px;width: 150px;"><b>দোকানের নাম </b></td>
            <td>
                <font>&nbsp;:&nbsp;{{ $data->shop_name }}</font>
            </td>

            <td align='right'><b> মালিকের নাম </b></td>
            <td>
                <font>&nbsp;:&nbsp;{{ $data->owner_name  }} </font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align='right'><b>মাস</b></td>
            <td>
                <font>&nbsp;:&nbsp;{{ $data->month_name }}</font>
            </td>
        </tr>
    ...
    <table border="1" width="95%" align="center" style="border-collapse:collapse; margin:2px auto; padding-top: 50px">
        ...
        <tr style="height: 100px">
            ...
            <td height="100" style="border: 1px solid black;padding-left:10px;">ভাড়া বাবদ ফি</td>
        ...
        <tr>
            ...
            <td height='23'
                style="text-align:right;padding-right:20px; font-size:12px;">{{ BanglaConverter::bn_number($data->amount) }} টাকা।
            </td>
        </tr>
