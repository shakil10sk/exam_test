        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">অনাপত্তি পত্র</li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='onapotti_certificate_table'>
                <thead>
                    <tr>
    ...
    @can('regenerate')
    <div class="modal fade" id="onapotti_regenerate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title" id="myLargeModalLabel">অনাপত্তি রি-জেনারেট</h4>
    ...
    <script>
        ...
        var onapotti_certificate_data_url = '@php echo  url("onapotti/certificate_list_data") @endphp';

        var onapotti_certificate_csrf = '@php echo  csrf_token() @endphp';

        // console.log(img_path);

        var onapotti_regenerate_url = '@php echo  url("onapotti/regenerate") @endphp';

        var onapotti_regenerate_csrf = '@php echo csrf_token() @endphp';
