...
@section('content')
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="title">
                    <h4><i class="icon-copy fa fa-group" aria-hidden="true"></i> সনদ গ্রহণকারীগণের তালিকা</h4>
                </div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">নাগরিক সনদ গ্রহনকারিগন
                        </li>
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
        <div class="clearfix mb-20">
            ...
            <div class="row">
                <table class="stripe hover multiple-select-row data-table-export nowrap" id='nagorik_certificate_table'>
                    <thead>
                        <tr>
    ...
    @can('regenerate')
        <div class="modal fade" id="nagorik_regenerate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <h4 class="modal-title" id="myLargeModalLabel">নাগরিক সনদ রি-জেনারেট</h4>
                    ...
                    <form action="javascript:void(0)" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <input class="form-control col-md-6" type="text" name="nagorik_generate_date"
                                    id="nagorik_generate_date" value="{{ date('Y-m-d') }}" />
                            </div><br>
...
@section('script')
    ...
    <script>
        ...
        var nagorik_certificate_data_url = '@php echo  url("nagorik/certificate_list_data") @endphp';

        var nagorik_certificate_csrf = '@php echo  csrf_token() @endphp';

        // console.log(img_path);


        var nagorik_regenerate_url = '@php echo  url("nagorik/regenerate") @endphp';

        var nagorik_regenerate_csrf = '@php echo csrf_token() @endphp';
