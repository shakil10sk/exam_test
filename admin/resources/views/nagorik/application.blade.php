...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="title text-center">
                        <h4 class="text-center application_head"> নাগরিক আবেদন</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container">
            <form id="form-data" action="{{ route('nagorik_store') }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="col-md-4">
                        <label for="cropzee-input">
                            <div class="image-overlay">
                                <img src="{{ asset('images/application/default.jpg') }}" class="image-previewer image"
                    ...
                    <div class="col-md-12" id="genderErr">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 @error('gender')is-invalid @enderror" id="genderErrMess">
                                ...
                                <input type="radio" id="gender_1" {{ (old('gender') == 1) ? 'checked' : '' }} name="gender" value="1"/>পুরুষ</label>

                                <label class="radio-inline gender">
                                <input type="radio" id="gender_2" {{ (old('gender') == 2) ? 'checked' : '' }} name="gender" value="2"/>মহিলা</label>

                                <label class="radio-inline gender">
                                <input type="radio" id="gender_3" {{ (old('gender') == 3) ? 'checked' : '' }} name="gender" value="3"/>অন্যান্য</label>
                            ...
                            <label for="Marital-status" class="col-sm-3 control-label">বৈবাহিক সম্পর্ক <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-3 bt-flabels__wrapper">
                ...
                <div class="row">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="present_ward_no" id="present_ward_no"
                                       ...
                                       autocomplete="present_ward_no" autofocus
                                       data-parsley-trigger="keyup" data-parsley-required/>
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                {{-- <select onchange="getLocation($(this).val(), 'present_district', 'present_upazila_append', 'present_upazila_id', 'present_upazila', 3 )"
                            ...
                            <div class="col-sm-3">
                                <input type="text" disabled id="present_district" value="জেলা" class="form-control"
                                       placeholder="" value="{{ old('present_district_id') }}"/>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="permanent_ward_no" id="permanent_ward_no"
                                       ...
                                       autocomplete="permanent_ward_no" autofocus
                                       data-parsley-trigger="keyup" data-parsley-required/>
                                <span class="bt-flabels__error-desc">ওয়ার্ড নং দিন ইংরেজিতে....</span>
                ...
                <div class="row" style="margin-bottom: 100px;">
                    <div class="offset-6 col-sm-6 button-style">
                        ...
                        <input type="hidden" value="1" id="app-type">
