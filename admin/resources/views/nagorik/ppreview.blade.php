...
<html lang="en-US">
    ...
    <body>
        ...
        <table border="0" cellpadding="5" cellspacing="5" style="border-collapse:collapse;margin-left: 50px; margin-top: 20px; " width="95%">
            <tr>
                <td style="text-align: center; {{($nagorik->photo)?"padding-left:110px;":""}} padding-bottom:50px;">
                    <h2>
                ...
                <td  valign="top" style="text-align: center;" >
                    ...
                    @if($nagorik->photo)
                        <img src="{{ asset('images/application/'. $nagorik->photo) }}" height="80px" width="80px"/>
                    @endif
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-left: 50px;" width="95%">
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ BanglaConverter::bn_number(date('d-m-Y', strtotime($nagorik->created_time))) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($nagorik->pin) }}
                    </span>
                </td>
                ...
                <td colspan="2" style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($nagorik->tracking) }}
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                @endif @if ($nagorik->marital_status == 2 && $nagorik->gender == 1 && !empty($nagorik->wife_name_bn))
                <td colspan="" style="border-left: none">
                    স্ত্রীর নাম
                </td>
                <td colspan="" style="border-left:none;">
            ...
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($nagorik->birth_id) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    হোল্ডিং নং
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($nagorik->permanent_holding_no) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        :
                        <?php echo BanglaConverter::bn_number(date('d-m-Y', strtotime($nagorik->
                        birth_date)));?>
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($nagorik->mobile) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    ই-মেইল
            ...
            <tr>
                ...
                <td colspan="" style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($nagorik->nid) }}
                    </span>
                </td>
                ...
                <td style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($nagorik->passport_no) }}
                    </span>
                </td>
            </tr>
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none;height: 80px;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $nagorik->present_village_bn }},   রোড/ব্লক/সেক্টর : {{ $nagorik->present_rbs_bn }},ওয়ার্ড নং : {{ BanglaConverter::bn_number($nagorik->present_ward_no) }}
                        <br/>
                        &nbsp;&nbsp;পোষ্ট অফিস : {{ $nagorik->present_postoffice_name }},
                        উপজেলা/থানা :{{ $nagorik->present_upazila_name }},
                        জেলা :{{ $nagorik->present_district_name }}
                    </p>
                </td>
            </tr>
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none; border-bottom:none;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $nagorik->permanent_village_bn }},   রোড/ব্লক/সেক্টর : {{ $nagorik->permanent_rbs_bn }},ওয়ার্ড নং : {{ BanglaConverter::bn_number($nagorik->permanent_ward_no) }}
                        <br/>
                        &nbsp;&nbsp;পোষ্ট অফিস :{{ $nagorik->permanent_postoffice_name }}
    ...
    <table width="95%"  cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;margin-left: 50px; margin-top: 20px; ">
        ...
        <tr>
            ...
            <td rowspan="4" style="height:140px;width:160px; border-top:1px solid black; border-left:1px solid black;">
                    ...
                    $url = $url.'/verify/nagorik_application/'.$nagorik->tracking.'/'.$nagorik->union_id.'/'.$nagorik->type;
