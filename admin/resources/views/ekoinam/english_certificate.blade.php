...
<head>
    <base href='' />
    <meta charset="utf-8">
    <title>English Same name Certificate</title>
...
<body>
        ...
        <table style="width:95%; margin-left:48px;border-color:lightgray;border-collapse:collapse;margin-top:10px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td rowspan="3" valign="top" style="text-align: left;" >
                    @if($ekoinam->photo != '' )
                        <img src="{{ asset('images/application/'.$ekoinam->photo) }}" height="100px" width="100px" style="" alt="profile" />
                    @endif
                </td>
    ...
    <table class="jolchap" align="center" border="0" height="415px" width='99%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed; line-height: 1.6;">

        <tr>
            <td align="left" style="font-size:16px;text-indent:55px; font-color:black; width: 150px; padding-left: 50px">Name </font>
            </td>
            <td>
                <font style="font-size:16px;">:  {{ $ekoinam->name_en }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px; ">: {{ $ekoinam->husband_name_en }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px; ">: {{ $ekoinam->father_name_en }} </font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">: {{ $ekoinam->mother_name_en }} </font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                <p style="line-height:25px;font-size:16px; ">
                    ...
                    : Village : {{ $ekoinam->present_village_en }}
                    <br> &nbsp; Post Office: {{ $ekoinam->present_postoffice_name_en }}
                    <br> &nbsp; Upazila/Thana: {{ $ekoinam->present_upazila_name_en }}
                    <br> &nbsp; District: {{ $ekoinam->present_district_name_en}}</p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                ...
                <p style="line-height:25px;font-size:16px;  ">
                    : Village: {{ $ekoinam->permanent_village_en }}
                    <br> &nbsp; Post Office: {{ $ekoinam->permanent_postoffice_name_en }}
                    <br> &nbsp; Upazila/Thana: {{ $ekoinam->permanent_upazila_name_en }}
                    <br> &nbsp; District: {{ $ekoinam->permanent_district_name_en }}
                </p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">:  {{ $ekoinam->permanent_ward_no }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: {{ $ekoinam->nid }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ $ekoinam->birth_id }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ $ekoinam->passport_no }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                 <font style="font-size:16px;">:  <?php echo date('d-m-Y', strtotime($ekoinam->generate_date)); ?></font>
            </td>
        </tr>
    ...
    <table border='0' width='98%' cellpadding='0' cellspacing='0' style="border-collapse:collapse;margin:0 auto;padding-top:10px;">
        ...
        <tr>
            <td style="font-size:17px;  padding-left:50px;" height="80">&nbsp; &nbsp; &nbsp; &nbsp;{{ ($ekoinam->gender == 1) ? 'He' : 'She' }} is {{ ($ekoinam->gender == 1) ? 'temporary' : 'permanent' }} resident at {{ $ekoinam->permanent_ward_no }} No ward under this union. To the best of my knowledge {{ $ekoinam->name_en }} is known as both of the same person as {{ $ekoinam->nickname_en }}.</td>

        </tr>

        <tr>
            <td style="padding-left:72px; font-size:17px; height: 20px">I wish {{ ($ekoinam->gender == 1) ? 'him' : 'her' }} all the best and prosperity.</td>
        </tr>
    ...
    <table border="0" width='99%' style="border-collapse:collapse; margin:5px auto; height: 100px" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td  style="font-size:18px;">&nbsp;{{ $ekoinam->comment_en }}
            </td>
        </tr>
    ...
    <table border='0' width="99%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;table-layout:fixed;margin:0px auto;">
        ...
        <tr>
            ...
            <td rowspan="1" style="border-left:1px solid black; border-top:1px solid black;">
                ...
                $url = $url.'/verify/ekoinam_en/'.$ekoinam->sonod_no.'/'.$ekoinam->union_id.'/'.$ekoinam->type;
