...
<body>
    ...
    <div class="page-border">
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                ...
                <p style="line-height:25px;font-size:16px;  ">
                    : গ্রামঃ {{ $ekoinam->permanent_village_bn }} <br>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: {{ BanglaConverter::bn_others($ekoinam->nid) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ BanglaConverter::bn_others($ekoinam->birth_id) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ BanglaConverter::bn_others($ekoinam->passport_no) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: <?php echo BanglaConverter::bn_others(date('d-m-Y', strtotime($ekoinam->generate_date))); ?></font>
            </td>
        </tr>
    ...
    <table border='0' width='98%' cellpadding='0' cellspacing='0' style="border-collapse:collapse;margin:0 auto;padding-top:10px;">
        ...
        <tr>
            <td style="font-size:17px;  padding-left:50px;" height="80">&nbsp; &nbsp; &nbsp; &nbsp; তিনি মধুখািল পৌরসভার সংশ্লিষ্ট ওয়ার্ডের
                {{-- {{ BanglaConverter::bn_number($ekoinam->permanent_ward_no) }} নং ওয়ার্ডের --}}
                 {{ ($ekoinam->resident == 1) ? "অস্থায়ী" : "স্থায়ী" }} বাসিন্দা, আমার জানামতে {{ $ekoinam->nickname_bn }} প্রকাশে {{ $ekoinam->name_bn }} একই ব্যাক্তি উভয় নামে পরিচিত।
            </td>
    ...
    <table border='0' width="99%" cellpadding='0' cellspacing='0' style="border-collapse: collapse;margin: 2px auto;table-layout:fixed;">
        ...
        <tr>
            <td style="width: 75%;text-align:center;padding-left: 20px">
                <font style="font-size:11px">{{ $union->sub_domain }}.digitalpoura.org</font>
                <span>-</span>
