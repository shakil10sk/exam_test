        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">একইনাম সনদ</li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    ...
    <div class="clearfix mb-20">
        ...
        <div class="row">
			<table class="stripe hover multiple-select-row data-table-export nowrap" id='ekoinam_applicant_table'>
				<thead>
					<tr>
	...
	@can('generate')
	<div class="modal fade" id="ekoinam_generate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			...
			<div class="modal-content">
				...
				<form action="javascript:void(0)" method="post">
					...
					<div class="row">
						...
						<input class="form-control col-md-6" type="text" name="ekoinam_generate_date" id="ekoinam_generate_date" value="{{ date('Y-m-d') }}" />
					</div><br>
...
@section('script')
	...
	<script>
		...
		//url for print ekoinam sonod
		var ekoinam_bangla_sonod_url = '@php echo  url("ekoinam/print_bn") @endphp';

		var ekoinam_applicant_data_url = '@php echo  url("ekoinam/applicant_data") @endphp';

		var ekoinam_generate_url = '@php echo  url("ekoinam/generate") @endphp';

		var ekoinam_delete_url = '@php echo  url("ekoinam/delete") @endphp';


		//for applicant csrf
		var ekoinam_applicant_csrf = '@php echo csrf_token() @endphp';

		var ekoinam_generate_csrf = '@php echo csrf_token() @endphp';

		var ekoinam_delete_csrf = '@php echo csrf_token() @endphp';
	...
	<script src="{{ asset('js/ekoinam.js') }}"></script>
