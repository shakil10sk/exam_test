...
<html lang="en-US">
    ...
    <body>
        ...
        <table border="0" cellpadding="5" cellspacing="5" style="border-collapse:collapse;margin-left: 50px; margin-top: 20px; " width="95%">
            <tr>
                <td style="text-align: center; {{($ekoinam->photo)?"padding-left:150px;":""}} padding-bottom:50px;">
                    <h2>
                        <span style="border-bottom: 1px solid; ">
                            একই নামের প্রত্যয়ন আবেদন
                        </span>
                    </h2>
                </td>
                <td  valign="top" style="text-align: center;" >
                    ...
                    @if($ekoinam->photo)
                        <img src="{{ asset('images/application/'. $ekoinam->photo) }}" height="80px" width="80px"/>
                    @endif
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-left: 50px;" width="95%">
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ BanglaConverter::bn_others(date('d-m-Y', strtotime($ekoinam->created_time))) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ BanglaConverter::bn_others($ekoinam->pin) }}
                    </span>
                </td>
                ...
                <td colspan="2" style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_others($ekoinam->tracking) }}
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="1">প্রকাশে নাম (বাংলা)</td>
                <td colspan="2" style="border-left:none;border-bottom:none;"><span>: {{ $ekoinam->nickname_bn }}</span></td>

                <td  colspan="1" style="border-left:none;border-bottom:none;">প্রকাশে নাম  (ইংরেজী)</td>
                <td colspan="2" style="border-left:none;"><span>: {{ $ekoinam->nickname_en }}</span></td>
            ...
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
						...
						@if($ekoinam->marital_status == 1)
						 	অবিবাহিত
						@elseif($ekoinam->marital_status == 2)
							বিবাহিত
						@elseif($ekoinam->marital_status == 3)
							তালাকপ্রাপ্ত
						@elseif($ekoinam->marital_status == 4)
							বিধবা
						@else
							অন্যান্য
						@endif
                ...
                @if ($ekoinam->marital_status == 2 && $ekoinam->gender == 2 && !empty($ekoinam->husband_name_bn))
                <td colspan="">
                    স্বামীর নাম
                </td>
                <td colspan="" style="border-left:none;">
                    <span>
                        :  {{ $ekoinam->husband_name_bn }}
                    </span>
                </td>
                @endif @if ($ekoinam->marital_status == 2 && $ekoinam->gender == 1 && !empty($ekoinam->wife_name_bn))
                <td colspan="" style="border-left: none">
                    স্ত্রীর নাম
                </td>
                <td colspan="" style="border-left:none;">
                    <span>
                        :  {{ $ekoinam->wife_name_bn }}
                    </span>
                </td>
                @endif
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : 
					@if($ekoinam->religion == 1)
					 	ইসলাম
					@elseif($ekoinam->religion == 2)
						হিন্দু
					@elseif($ekoinam->religion == 3)
						বৌদ্ধ ধর্ম
					@elseif($ekoinam->religion == 4)
						খ্রিস্ট ধর্ম
					@else
						অন্যান্য
					@endif
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_others($ekoinam->birth_id) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    হোল্ডিং নং
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($ekoinam->permanent_holding_no) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ $ekoinam->educational_qualification }}
                    </span>
                </td>
                <td style="border-left:none ">
                    জন্ম তারিখ
                ...
                <td style="border-left:none;">
                    <span>
                        :
                        <?php echo BanglaConverter::bn_others(date('d-m-Y', strtotime($ekoinam->
                        birth_date)));?>
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_others($ekoinam->mobile) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    ই-মেইল
            ...
            <tr>
                ...
                <td colspan="" style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_others($ekoinam->nid) }}
                    </span>
                </td>
                ...
                <td style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ BanglaConverter::bn_others($ekoinam->passport_no) }}
                    </span>
                </td>
            </tr>
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none;height: 80px;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $ekoinam->present_village_bn }},   রোড/ব্লক/সেক্টর : {{ $ekoinam->present_rbs_bn }},     পোষ্ট অফিস :{{ $ekoinam->present_postoffice_name }},   ওয়ার্ড নং : {{ BanglaConverter::bn_number($ekoinam->present_ward_no) }}
                        <br/>
                        উপজেলা/থানা :{{ $ekoinam->present_upazila_name }},     জেলা :{{ $ekoinam->present_district_name }}
                    </p>
                </td>
            </tr>
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none; border-bottom:none;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $ekoinam->permanent_village_bn }},   রোড/ব্লক/সেক্টর : {{ $ekoinam->permanent_rbs_bn }},     পোষ্ট অফিস :{{ $ekoinam->permanent_postoffice_name }},   ওয়ার্ড নং : {{ BanglaConverter::bn_number($ekoinam->permanent_ward_no) }}
                        <br/>
                        উপজেলা/থানা :{{ $ekoinam->permanent_upazila_name }},     জেলা :{{ $ekoinam->permanent_district_name }}
                    </p>
                </td>
            </tr>
        </table>
                ...
                <br>
                    ...
                    ৫) আবেদন কপি টি প্রিন্ট করে ১৫দিনের মধ্যে সংশ্লিষ্ট শাখায় জমা দিন। অন্যথায় আবেদন টি বাতিল বলে গণ্য হবে।
                        ...
                        <td rowspan="4" style="height:140px;width:160px; border-top:1px solid black; border-left:1px solid black;">
                            ...
                            $url = $url.'/verify/ekoinam_application/'.$ekoinam->tracking.'/'.$ekoinam->union_id.'/'.$ekoinam->type;
