        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ইমারত আবেদন পত্র</li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    ...
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='emarat_applicant_table'>
                <thead>
                    <tr>
...
@can('generate')
<div class="modal fade" id="emarot_generate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title" id="myLargeModalLabel">ইমারত সনদ জেনারেট</h4>
                ...
                <form action="javascript:void(0)" method="post">
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" type="number" name="fee" id="fee" value="0.00"
                               onchange="emarot_amount_calculation()" />
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" type="text" name="tax" id="tax" value="0"
                               onchange="emarot_amount_calculation()" readonly />
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" type="text" name="namjari_generate_date"
                               id="prottyon_generate_date" value="{{ date('Y-m-d') }}" />
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <input type="hidden" name="namjari_id" id="emarot_id"  >
...
<script>
    ...
    var emarat_bangla_sonod_url = '@php echo  url("emarot/print_bn") @endphp';

    var emarat_applicant_data_url = '@php echo  url("emarot/applicant_data") @endphp';

    var emarat_generate_url = '@php echo  url("emarot/generate") @endphp';

    var emarat_delete_url = '@php echo  url("emarot/delete") @endphp';

    //for applicant csrf
    var emarat_applicant_csrf = '@php echo csrf_token() @endphp';

    var emarat_generate_csrf = '@php echo csrf_token() @endphp';

    var emarat_delete_csrf = '@php echo csrf_token() @endphp';
    ...
    $('document').ready(function() {
        ...
        emarat_applicant_list();

    });
</script>

<script src="{{ asset('js/emarat.js') }}"></script>
