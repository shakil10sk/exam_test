        ...
        <tr>
            ...
            <td valign='top' style="text-align:right;">
                ...
                @if(isset($data['fee_data']['95']))
                    ...
                    <?php $fee = $data['fee_data']['95']['amount']; echo BanglaConverter::bn_number(number_format
                    ($data['fee_data']['95']['amount'])); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
