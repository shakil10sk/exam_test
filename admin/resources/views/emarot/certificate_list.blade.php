        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ইমারত সনদ পত্র</li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='emarot_certificate_table'>
                <thead>
                    <tr>
...
@can('regenerate')
<div class="modal fade" id="emarot_regenerate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title" id="myLargeModalLabel">ইমারত সনদ রি-জেনারেট</h4>
            ...
            <div class="modal-body">
                ...
                <form action="javascript:void(0)" method="post">
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" type="number" name="fee" id="fee" value="0.00" onchange="emarot_amount_calculation()" />
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" type="text" name="emarot_generate_date"
                               id="emarot_generate_date" value="{{ date('Y-m-d') }}" />
                    </div>
                    <br>
                    <div class="row">
...
<script>
    ...
    var emarot_certificate_data_url = '@php echo  url("emarot/certificate_list_data") @endphp';

    var emarot_certificate_csrf = '@php echo  csrf_token() @endphp';

    // console.log(img_path);

    var emarot_regenerate_url = '@php echo  url("emarot/regenerate") @endphp';

    var emarot_regenerate_csrf = '@php echo csrf_token() @endphp';

    //url for print prottyon sonod
    var emarot_bangla_sonod_url = '@php echo  url("emarot/print_bn") @endphp';
