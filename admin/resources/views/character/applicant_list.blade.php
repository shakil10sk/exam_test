        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">চারিত্রিক সনদ</li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    ...
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='character_applicant_table'>
                <thead>
                    <tr>
...
@can('generate')
<div class="modal fade" id="character_generate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <form action="javascript:void(0)" method="post">
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" type="text" name="character_generate_date" id="character_generate_date" value="{{ date('Y-m-d') }}" />
                    </div>
                    <br>
...
<script>
    ...
    //url for print character sonod
    var character_bangla_sonod_url = '@php echo  url("character/print_bn") @endphp';

    var character_applicant_data_url = '@php echo  url("character/applicant_data") @endphp';

    var character_generate_url = '@php echo  url("character/generate") @endphp';

    var character_delete_url = '@php echo  url("character/delete") @endphp';

    //for applicant csrf
    var character_applicant_csrf = '@php echo csrf_token() @endphp';

    var character_generate_csrf = '@php echo csrf_token() @endphp';

    var character_delete_csrf = '@php echo csrf_token() @endphp';
