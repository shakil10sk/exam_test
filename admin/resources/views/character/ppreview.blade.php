...
<html lang="en-US">
    ...
    <body>
        ...
        <table border="0" cellpadding="5" cellspacing="5" style="border-collapse:collapse;margin-left: 50px; margin-top: 20px; " width="95%">
            <tr>
                <td style="text-align: center; {{($character->photo)?"padding-left:150px;":""}} padding-bottom:50px;">
                    <h2>
                ...
                <td  valign="top" style="text-align: center;" >
                    ...
                    @if($character->photo)
                        <img src="{{ asset('images/application/'. $character->photo) }}" height="80px" width="80px"/>
                    @endif
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-left: 50px;" width="95%">
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ BanglaConverter::bn_others(date('d-m-Y', strtotime($character->created_time))) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ BanglaConverter::bn_others($character->pin) }}
                    </span>
                </td>
                ...
                <td colspan="2" style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_others($character->tracking) }}
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_others($character->birth_id) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    হোল্ডিং নং
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($character->permanent_holding_no) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        :
                        <?php echo BanglaConverter::bn_others(date('d-m-Y', strtotime($character->
                        birth_date)));?>
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_others($character->mobile) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    ই-মেইল
            ...
            <tr>
                ...
                <td colspan="" style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_others($character->nid) }}
                    </span>
                </td>
                ...
                <td style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ BanglaConverter::bn_others($character->passport_no) }}
                    </span>
                </td>
            </tr>
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none;height: 80px;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $character->present_village_bn }},   রোড/ব্লক/সেক্টর : {{ $character->present_rbs_bn }},     পোষ্ট অফিস :{{ $character->present_postoffice_name }},   ওয়ার্ড নং : {{ BanglaConverter::bn_number($character->present_ward_no) }}
                        <br/>
            ...
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none; border-bottom:none;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $character->permanent_village_bn }},   রোড/ব্লক/সেক্টর : {{ $character->permanent_rbs_bn }},     পোষ্ট অফিস :{{ $character->permanent_postoffice_name }},   ওয়ার্ড নং : {{ BanglaConverter::bn_number($character->permanent_ward_no) }}
                        <br/>
                ...
                <br>
                    ...
                    ৫) আবেদন কপি টি প্রিন্ট করে ১৫দিনের মধ্যে সংশ্লিষ্ট শাখায় জমা দিন। অন্যথায় আবেদন টি বাতিল বলে গণ্য হবে।
                        ...
                        <td rowspan="4" style="height:140px;width:160px; border-top:1px solid black; border-left:1px solid black;">
                            ...
                            $url = $url.'/verify/character_application/'.$character->tracking.'/'.$character->union_id.'/'.$character->type;
