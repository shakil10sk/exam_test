...
<head>
    <base href='' />
    <meta charset="utf-8">
    <title>বাংলা চারিত্রিক সনদপত্র</title>
    ...
    <div class="page-border">
        ...
        @endif
            ...
            <table style="width:95%; margin-left:48px;border-color:lightgray;border-collapse:collapse;margin-top:10px;" cellpadding="0" cellspacing="0" >
                <tr>
                    <td style="text-align:left;font-size:10px;font-weight:bold;padding-bottom: 15px">
                        <font style="font-size: 13px">
                            ইসু তারিখ: <?php echo BanglaConverter::bn_others(date('d-m-Y', strtotime
                            ($character->generate_date))); ?>
                        </font>
                    </td>
                    <td colspan="4" style=" text-align:left;font-size:25px;font-weight:bold;padding-bottom: 15px;
                margin-right: 40px">
                        <font style="">
                            <u>চারিত্রিক সনদ</u>
                        </font>
...
{{--                </td>--}}
            ...
            <tr>
                <td colspan="2" style="font-size:18px; text-indent:50px; padding-top: 5px; padding-bottom: 5px;">এই
                    মর্মে প্রত্যয়ন করা যাচ্ছে যে,</td>
            </tr>
        </table>
    ...
    <table class="jolchap" align="center" border="0" height="415px" width='99%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed; line-height: 1.5;">
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ $character->name_bn }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px; ">: {{ $character->husband_name_bn }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px; ">: {{ $character->father_name_bn }} </font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">: {{ $character->mother_name_bn }} </font>
            </td>
        </tr>
        @if ($character->marital_status == 2 && $character->gender == 1 && !empty($character->wife_name_bn) )

            <tr>
                <td align="left" style="font-size:16px;text-indent:55px; font-color:black; width: 150px; padding-left: 50px">স্ত্রীর নাম</td>
                <td>
                    <font style="font-size:16px; ">: {{ $character->wife_name_bn }}</font>
                </td>
            </tr>
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                <p style="line-height:25px;font-size:16px; ">
                    ...
                    : গ্রাম/মহল্লাঃ {{ trim($character->present_village_bn)}}
                    <br> &nbsp; {{ !empty($character->present_rbs_bn)? "রোড/ব্লক/সেক্টরঃ "
                    .$character->present_rbs_bn."," : ""  }} ওয়ার্ড নং {{ Converter::en2bn($character->present_ward_no) }},
                    ডাকঘরঃ {{
                    $character->present_postoffice_name_bn }}
                    <br> &nbsp; উপজেলাঃ {{ $character->present_upazila_name_bn }}
                    <br> &nbsp; জেলাঃ {{ $character->present_district_name_bn}}</p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                ...
                <p style="line-height:25px;font-size:16px;  ">
                    : গ্রাম/মহল্লাঃ {{ $character->permanent_village_bn }}
                    <br> &nbsp; {{ !empty($character->permanent_rbs_bn)? "
                    রোড/ব্লক/সেক্টরঃ "
                    .$character->permanent_rbs_bn."," : ""  }} ওয়ার্ড নং {{ Converter::en2bn($character->permanent_ward_no)
                    }}, ডাকঘরঃ {{
                    $character->permanent_postoffice_name_bn }}
                    <br> &nbsp; উপজেলাঃ {{ $character->permanent_upazila_name_bn }}
                    <br> &nbsp; জেলাঃ {{ $character->permanent_district_name_bn }}
                </p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: {{ BanglaConverter::bn_others($character->nid) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ BanglaConverter::bn_others($character->birth_id) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ BanglaConverter::bn_others($character->passport_no) }}</font>
            </td>
        </tr>
        @endif
...
{{--            <td>--}}
               {{-- <font style="font-size:16px;">:
                    <?php
                        //  echo BanglaConverter::bn_others(date('d-m-Y', strtotime($character->generate_date)));
                         ?>
                </font> --}}
{{--            </td>--}}
{{--        </tr>--}}
    ...
    <table border='0' width='98%' cellpadding='0' cellspacing='0' style="border-collapse:collapse;margin:0 auto;padding-top:10px;">
        ...
        <tr>
            <td style="font-size:17px;  padding-left:50px;" height="80">&nbsp; &nbsp; &nbsp; &nbsp;  {{ ($character->resident == 1) ? "অস্থায়ী" : "স্থায়ী" }}
                </font> বাসিন্দা। তিনি জন্মগতভাবে বাংলাদেশী এবং আমার পরিচিত। তাহার স্বভাব ও নৈতিক চরিত্র ভাল এবং প্রশংসনীয়।  </td>
...
{{--            <td valign="top" style="font-size:16px; text-indent:70px; width:150px; font-weight:bold; padding-left: 55px; padding-top: 10px; height: 50px; font-size: 18px">--}}
{{--                <span style="">সংযুক্তিঃ</span>--}}
{{--            </td>--}}

{{--            <td  style="font-size:16px;" valign="middle">&nbsp;{{ $character->comment_bn }}--}}
{{--            </td>--}}
{{--        </tr>--}}
    ...
    <tr>
        ...
        <tr>
            ...
            <td rowspan="1" style="border-left:1px solid black; border-top:1px solid black;">
                ...
                <?php
                    $url = $url.'/verify/character_bn/'.$character->sonod_no.'/'.$character->union_id.'/'.$character->type;
                ?>
