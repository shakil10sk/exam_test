...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="title text-center">
                        <h4 class="text-center application_head">সনাতন ধর্ম অবলম্বী সনদের আবেদন</h4>
                    </div>
    ...
    <section>
        <div class="container">
            <form id="form-data" action="{{ route('sonaton_store') }}" method="post" enctype="multipart/form-data" class="uk-form bt-flabels js-flabels" data-parsley-validate data-parsley-errors-messages-disabled>
                @csrf
                ...
                <div class="row" style="margin-top: 50px;">
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type='hidden' name="religion" id="sonaton" value="2" class="form-control" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="row" style="margin-bottom: 100px;">
                    <div class="offset-6 col-sm-6 button-style">
                        ...
                        <input type="hidden" value="6" id="app-type">
