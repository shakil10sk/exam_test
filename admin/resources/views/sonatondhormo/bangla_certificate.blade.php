...
<head>
    <base href='' />
    <meta charset="utf-8">
    <title>বাংলা সনাতন ধর্ম  অবলম্বী সনদপত্র</title>
...
<body>
    ...
    <table class="jolchap" align="center" border="0" height="415px" width='99%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed; line-height: 1.5;">
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ $sonaton->name_bn }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px; ">: {{ $sonaton->husband_name_bn }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px; ">: {{ $sonaton->father_name_bn }} </font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">: {{ $sonaton->mother_name_bn }} </font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                <p style="line-height:25px;font-size:16px; ">
                    ...
                    : গ্রামঃ {{ $sonaton->present_village_bn }}
                    <br> &nbsp; ডাকঘরঃ {{ $sonaton->present_postoffice_name_bn }}
                    <br> &nbsp; উপজেলাঃ {{ $sonaton->present_upazila_name_bn }}
                    <br> &nbsp; জেলাঃ {{ $sonaton->present_district_name_bn}}</p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                ...
                <p style="line-height:25px;font-size:16px;  ">
                    : গ্রামঃ {{ $sonaton->permanent_village_bn }}
                    <br> &nbsp; ডাকঘরঃ {{ $sonaton->permanent_postoffice_name_bn }}
                    <br> &nbsp; উপজেলাঃ {{ $sonaton->permanent_upazila_name_bn }}
                    <br> &nbsp; জেলাঃ {{ $sonaton->permanent_district_name_bn }}
                </p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">:  {{ BanglaConverter::bn_number($sonaton->permanent_ward_no) }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: {{ BanglaConverter::bn_number($sonaton->nid) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ BanglaConverter::bn_number($sonaton->birth_id) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ BanglaConverter::bn_number($sonaton->passport_no) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: <?php echo BanglaConverter::bn_number(date('d-m-Y', strtotime($sonaton->generate_date))); ?></font>
            </td>
        </tr>
    ...
    <table border='0' width='98%' cellpadding='0' cellspacing='0' style="border-collapse:collapse;margin:0 auto;padding-top:10px;">
        ...
        <tr>
            <td style="font-size:17px;  padding-left:50px;" height="80">&nbsp; &nbsp; &nbsp; &nbsp;
                আমার জানামতে সে অত্র পৌরসভা এর {{ BanglaConverter::bn_number($sonaton->permanent_ward_no) }} নং ওয়ার্ডের সনাতন ধর্ম অবলম্বী একজন {{ ($sonaton->resident == 1) ? "অস্থায়ী" : "স্থায়ী" }} বাসিন্দা ।
    ...
    <table border="0" width='99%' style="border-collapse:collapse; margin:5px auto; height: 100px" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td  style="font-size:16px;">&nbsp;{{ $sonaton->comment_bn }}
            </td>
        </tr>
    ...
    <tr>
        ...
        <tr>
            ...
            <td rowspan="1" style="border-left:1px solid black; border-top:1px solid black;">
                ...
                $url = $url.'/verify/sonaton_bn/'.$sonaton->sonod_no.'/'.$sonaton->union_id.'/'.$sonaton->type;
