...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    ...
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='land_use_applicant_table'>
                <thead>
                    <tr>
...
@can('generate')
    <div class="modal fade" id="land_use_generate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title" id="myLargeModalLabel">ভূমি ব্যবহারের সনদ সনদ জেনারেট</h4>
            ...
            <form action="javascript:void(0)" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" type="number" onchange="calculation()" name="fee"
                               id="fee" value="0.00" />
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" type="number" name="vat" id="vat" value="0" readonly />
                    ...
                    <div class="row">
                        <label  class="col-md-4 text-right">রাস্তার জন্য ছাড়াছাড়ি</label>

                        <textarea class="form-control col-md-6" id="road_consider" name="road_consider" rows="4" cols="5">
                        </textarea>
                    </div><br>
...
<script>
    ...
    var applicant_data_url = '@php echo  url("landuse/applicant_data") @endphp';

    var generate_url = '@php echo  url("landuse/generate") @endphp';

    var delete_url = '@php echo  url("landuse/delete") @endphp';

    //for applicant csrf
    var applicant_csrf = '@php echo csrf_token() @endphp';

    var generate_csrf = '@php echo csrf_token() @endphp';

    var delete_csrf = '@php echo csrf_token() @endphp';
