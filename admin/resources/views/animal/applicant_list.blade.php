        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">পোষা প্রাণীর লাইসেন্সের আবেদন</li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    ...
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='animal_applicant_table'>
                <thead>
                    <tr>
...
@can('generate')
<div class="modal fade bs-example-modal-lg" id="animal_generate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
...
<script>
    ...
    var animal_applicant_data_url = '@php echo  url("animal/applicant_data") @endphp';

    var animal_generate_url = '@php echo  url("animal/generate") @endphp';

    var animal_delete_url = '@php echo  url("animal/delete") @endphp';

    //for applicant csrf
    var animal_applicant_csrf = '@php echo csrf_token() @endphp';

    var animal_generate_csrf = '@php echo csrf_token() @endphp';

    var animal_delete_csrf = '@php echo csrf_token() @endphp';
