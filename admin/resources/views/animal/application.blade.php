...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="title text-center">
                        <h4 class="text-center application_head">পোষা প্রাণীর লাইসেন্সের আবেদন</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container">
            <form id="form-data" action="{{ route('animal_store') }}" method="post" enctype="multipart/form-data" class="uk-form bt-flabels js-flabels" data-parsley-validate data-parsley-errors-messages-disabled>
                @csrf
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <select name="animal_type" id="animal_type" selected="selected" class="form-control @error('animal_type')is-invalid @enderror" data-parsley-required >
                                    ...
                                    <option value="" {{ (old('animal_type') == '') ? 'selected="selected"' : '' }}>চিহ্নিত করুন</option>

                                    <option value='1' {{ (old('animal_type') == 1) ? 'selected="selected"' : '' }}>কুকুর</option>

                                    <option value='2' {{ (old('animal_type') == 2) ? 'selected="selected"' : '' }}>বিড়াল</option>

                                    <option value='3' {{ (old('animal_type') == 3) ? 'selected="selected"' : '' }}>হাতি</option>

                                    <option value='4' {{ (old('animal_type') == 4) ? 'selected="selected"' : '' }}>ঘোড়া</option>

                                    <option value='5' {{ (old('animal_type') == 5) ? 'selected="selected"' : '' }}>হরিণ</option>

                                    <option value='6' {{ (old('animal_type') == 6) ? 'selected="selected"' : '' }}>খরগোস</option>

                                    <option value='7' {{ (old('animal_type') == 7) ? 'selected="selected"' : '' }}>বাঘ</option>

                                    <option value='8' {{ (old('animal_type') == 8) ? 'selected="selected"' : '' }}>সিংহ</option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="animal_name_en" id="animal_name_en" value="{{ old('animal_name_en') }}" data-parsley-pattern='^[a-zA-Z. ]+$' data-parsley-trigger="keyup" class="form-control @error('animal_name_en') is-invalid @enderror" autocomplete="animal_name_en" autofocus placeholder="Animal's Name" />
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="animal_name_bn" id="animal_name_bn" value="{{ old('animal_name_bn') }}" class="form-control @error('animal_name_bn') is-invalid @enderror" autocomplete="animal_name_bn" autofocus placeholder="প্রাণীর নাম" data-parsley-trigger="keyup" data-parsley-required />
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="animal_type_en" id="animal_type_en" value="{{ old('animal_type_en') }}" data-parsley-pattern='^[a-zA-Z. ]+$' data-parsley-trigger="keyup" class="form-control @error('animal_type_en') is-invalid @enderror" autocomplete="animal_type_en" autofocus placeholder="Animal Category" />
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="animal_type_bn" id="animal_type_bn" value="{{ old('animal_type_bn') }}" class="form-control @error('animal_type_bn') is-invalid @enderror" autocomplete="animal_type_bn" autofocus placeholder="প্রাণীর জাত" data-parsley-trigger="keyup" data-parsley-required />
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="animal_color_en" id="animal_color_en" value="{{ old('animal_color_en') }}" data-parsley-pattern='^[a-zA-Z. ]+$' data-parsley-trigger="keyup" class="form-control @error('animal_color_en') is-invalid @enderror" autocomplete="animal_color_en" autofocus placeholder="Animal's color" />
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="animal_color_bn" id="animal_color_bn" value="{{ old('animal_color_bn') }}" class="form-control @error('animal_color_bn') is-invalid @enderror" autocomplete="animal_color_bn" autofocus placeholder="প্রাণীর গায়ের রঙ" data-parsley-trigger="keyup" data-parsley-required />
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="jolatongko_date" value="{{ old('jolatongko_date') }}" id="jolatongko_date" class="form-control date @error('jolatongko_date') is-invalid @enderror" autocomplete="jolatongko_date" autofocus data-parsley-type="date" data-parsley-trigger="keyup" placeholder="yyyy-mm-dd" />
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="jolatongko_next_date" value="{{ old('jolatongko_next_date') }}" id="jolatongko_next_date" class="form-control date @error('jolatongko_next_date') is-invalid @enderror" autocomplete="jolatongko_next_date" autofocus data-parsley-type="date" data-parsley-trigger="keyup" placeholder="yyyy-mm-dd" />
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="animal_age" id="animal_age" value="{{ old('animal_age') }}" class="form-control @error('animal_age') is-invalid @enderror" autocomplete="animal_age" autofocus placeholder="প্রাণীর বয়স" data-parsley-trigger="keyup" data-parsley-required />
                ...
                <div class="row" style="margin-bottom: 100px;">
                    <div class="offset-6 col-sm-6 button-style">
                        ...
                        <input type="hidden" value="91" id="app-type">
