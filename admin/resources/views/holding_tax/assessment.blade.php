...
@section('content')
    ...
    <section>
        <div class="container">
            <form action="{{ route('holding.assessment.store') }}" method="post" enctype="multipart/form-data" class="uk-form bt-flabels js-flabels" data-parsley-validate data-parsley-errors-messages-disabled>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="holding_no" id="holding_no" value="{{ old('holding_no') }}" class="form-control @error('holding_no')is-invalid @enderror" autocomplete="holding_no" autofocus required />
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="assessment_date" id="assessment_date" value="{{ old('assessment_date') }}" class="form-control @error('assessment_date')is-invalid @enderror" autocomplete="assessment_date" autofocus required placeholder="yyyy-mm-dd" />
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="ward_name" id="ward_name" value="{{ old('ward_name') }}" class="form-control @error('ward_name')is-invalid @enderror" readonly/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                ...
                                <option value="2">আধা কাঁচা</option>
                                <option value="3">পাকা</option>
                                <option value="4">আধা পাকা</option>
                                </select>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="road_width" id="road_width" value="{{ old('road_width') }}" class="form-control @error('road_width')is-invalid @enderror" placeholder="রাস্তার প্রস্থ" autocomplete="road_width" autofocus />
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-2 bt-flabels__wrapper">
                                <input type="text" name="rent_area" id="rent_area" value="{{ old('rent_area') }}" class="form-control" autocomplete="rent_area" onkeyup="calculateTotalArea(this.value, own_area.value)" />
                            </div>

                            <label for="own_area" class="col-sm-2 control-label"> নিজস্ব জায়গার পরিমান (বর্গফুট) <span>*</span></label>

                            <div class="col-sm-2 bt-flabels__wrapper">
                                <input type="text" name="own_area" id="own_area" value="{{ old('own_area') }}" class="form-control" autocomplete="own_area" autofocus required onkeyup="calculateTotalArea(rent_area.value, this.value)" />
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-2 bt-flabels__wrapper">
                                <input type="text" name="depreciation" id="depreciation" value="{{ old('depreciation') }}" class="form-control" autocomplete="depreciation" onkeyup="calculateAppreciationDepreciation()" />
                            </div>

                            <label for="appreciation" class="col-sm-2 control-label"> Apreciation </label>

                            <div class="col-sm-2 bt-flabels__wrapper">
                                <input type="text" name="appreciation" id="appreciation" value="{{ old('appreciation') }}" class="form-control" autocomplete="appreciation" onkeyup="calculateAppreciationDepreciation()" />
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="annual_rental_value" id="annual_rental_value" class="form-control" readonly />
                            </div>

                            <label for="final_annual_rental_value" class="col-sm-3 control-label"> Final Annual Rental Value (ARV) </label>

                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="final_annual_rental_value" id="final_annual_rental_value" class="form-control" readonly />
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="annual_tax" id="annual_tax" class="form-control" readonly />
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="monthly_tax" id="monthly_tax" class="form-control" readonly/>
                            </div>
