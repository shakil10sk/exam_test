        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-30">
            <div class="pd-20 bg-white border-radius-4 box-shadow height-100-p">
                ...
                <div class="row justify-content-end mb-3">
                    <div class="col-2">
                        <button type="button" onclick="addNewPropertyType()" class="btn btn-primary">
        ...
        <div class="modal-content">
            <form action="javascript:void(0);">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">নতুন ভবনের ধরন</h5>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="savePropertyType()" class="btn btn-primary" id="action_btn">Save</button>
