        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ভূমিহিন সনদ</li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    ...
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='vumihin_applicant_table'>
                <thead>
                    <tr>
...
@can('generate')
<div class="modal fade" id="vumihin_generate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title" id="myLargeModalLabel">ভূমিহীন সনদ জেনারেট</h4>
            ...
            <div class="modal-body">
                ...
                <form action="javascript:void(0)" method="post">
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" type="text" name="vumihin_generate_date" id="vumihin_generate_date" value="{{ date('Y-m-d') }}" />
                    </div>
                    <br>
...
<script>
    ...
    //url for print vumihin sonod
    var vumihin_bangla_sonod_url = '@php echo  url("vumihin/print_bn") @endphp';

    var vumihin_applicant_data_url = '@php echo  url("vumihin/applicant_data") @endphp';

    var vumihin_generate_url = '@php echo  url("vumihin/generate") @endphp';

    var vumihin_delete_url = '@php echo  url("vumihin/delete") @endphp';

    //for applicant csrf
    var vumihin_applicant_csrf = '@php echo csrf_token() @endphp';

    var vumihin_generate_csrf = '@php echo csrf_token() @endphp';

    var vumihin_delete_csrf = '@php echo csrf_token() @endphp';
    ...
    $('document').ready(function() {
        ...
        vumihin_applicant_list();

    });
</script>

<script src="{{ asset('js/vumihin.js') }}"></script>
