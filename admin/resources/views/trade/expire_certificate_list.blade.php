        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">মেয়াদ উত্তীর্ন ট্রেড লাইসেন্স সমূহ</li>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width: 840px">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myLargeModalLabel">ট্রেড লাইসেন্স রি-জেনারেট</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <input class="form-control col-md-7" type="text" name="pesha_vat" id="pesha_vat" onchange="calculation()" />
                                </div>
                                </br>
...
<script type="text/javascript">
    ...
    $(function () {
      ...
      var table = $('#trade_certificate_table').DataTable({
        scrollCollapse: true,
        autoWidth: false,
        responsive: true,
        serverSide: true,
        processing: true,
          ajax: "{{ route('expire_certificate_list') }}",
          columns: [
...

              {
                data: 'certificate_id', name: 'certificate_id',
                    render: function(data, type, row, meta) {
                        ...
                        return "<a  href='javascript:void(0)' onclick='ex_trade_regenerate("+meta.row+")' ><p class='btn btn-sm btn-primary custom_button'>রি-জেনারেট</p></a>"
                    }
              },
          ]
      });
