...
@section('head')
    ...
    <!--  -->
    <link href="{{ asset('css/form_validate.css') }}" rel="stylesheet"/>
...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="title text-center">
                        <h4 class="text-center application_head">ট্রেড লাইসেন্স আবেদন</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container">
            <form id="form-data" action="{{ route('tradelicense_store') }}" method="post" enctype="multipart/form-data"
                ...
                <div class="row">
                    <div class="offset-2 col-md-8 mt-3">
                        ...
                        <hr/>
                        <ul>
                            <li><i class="icon-copy ion-disc"></i> বাংলায় সার্টিফিকেট পেতে শুধুমাত্র বাংলায় ঘর গুলো
                                পূরন করুন ।
                            </li>
                            <li><i class="icon-copy ion-disc"></i> ইংরেজি সার্টিফিকেট পেতে বাংলা এবং ইংরেজি উভয় ঘর পূরন
                                করুন ।
                            </li>
                            <li id="role" {{ (old('type_of_organization') >= 2)? 'style=display:none' : 'style=' }}><i
                                    class="icon-copy icon-disc"></i> আপনি যদি পূর্বে কোনো সনদ নিয়ে থাকেন, নিচের সার্চ
                                বক্সে আপনার
                        ...
                        <div class="input-group mt-5"
                             id="search" {{ (old('type_of_organization') >= 2)? 'style=display:none' : 'style=' }}>
                            <input type="search" class="form-control" id="search-data-0"
                                   placeholder="মোবাইল/এন.আই.ডি.নং/জন্ম নিবন্ধন নং/পাসপোর্ট নং/পিন নং দিন ইংরেজিতে">
                            <span class="input-group-btn">
                                <button class="btn btn-primary " onclick="getCitizenInformation(0)" type="button" id="search-btn"
                                        >
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="name_Of_organization_en" id="name_Of_organization_en"
                                       value="{{ old('name_Of_organization_en') }}"
                                       class="form-control @error('name_Of_organization_en')is-invaliid @enderror"
                                       autocomplete="name_Of_organization_en" autofocus data-parsley-trigger="keyup"/>
                            ...
                            <label for="name_Of_organization_bn" class="col-sm-3 control-label">প্রতিষ্ঠানের নাম
                                (বাংলায়) <span class="text-danger">*</span></label>
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="name_Of_organization_bn" id="name_Of_organization_bn"
                                       value="{{ old('name_Of_organization_bn') }}"
                                       class="form-control @error('name_Of_organization_bn')is-invalid @enderror"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <select name="type_of_organization" id="type_of_organization"
                                        class="form-control @error('type_of_organization')is-invalid @enderror"
                                        selected="selected" data-parsley-required>
                                    <option
                                        value="" {{ (old('type_of_organization') == '') ? 'selected="selected"' : '' }}>
                                        চিহ্নিত করুন
                                    </option>
                                    <option
                                        value="1" {{ (old('type_of_organization') == 1) ? 'selected="selected"' : '' }}>
                                        ব্যক্তি মালিকানাধীন
                                    </option>
                                    <option
                                        value="2" {{ (old('type_of_organization') == 2) ? 'selected="selected"' : '' }}>
                                        যৌথ মালিকানা
                                    </option>
                                    <option
                                        value="3" {{ (old('type_of_organization') == 3) ? 'selected="selected"' : '' }}>
                                        কোম্পানী
                                    </option>
{{--                                    <option--}}
{{--                                        value="4" {{ (old('type_of_organization') == 4) ? 'selected="selected"' : '' }}>--}}
{{--                                        ব্যাংক অথবা আর্থিক প্রতিষ্ঠান--}}
{{--                                    </option>--}}
                                </select>
                    ...
                    <ul class="nav nav-tabs" id="tab-append" role="tablist">
                        ...
                        <li class="nav-item" id="add-btn">
                            <button type="button" value="{{ $owner }}" id="owner-plus-btn"
                                    class="btn btn-primary" {{ (old('type_of_organization') == 2 || old('type_of_organization') == 3) ? 'style=display:block;' : 'style=display:none;' }}>
                                ...
                                <div class="card card-info">
                                    ...
                                    <div class="card-body">
                                        <div class="row justify-content-center mb-3"
                                             id="searchForMutilpleOwner" {{ (old('type_of_organization') < 2)?
                                             'style=display:none' : 'style=' }} >
                                            <input type="search" style="width: 40%" class="form-control"
                                                   placeholder="মোবাইল/এন.আই.ডি.নং/জন্ম নিবন্ধন নং/পাসপোর্ট নং/পিন নং দিন ইংরেজিতে">
                                            <span class="input-group-btn ml-2">
                                                    <button class="btn btn-primary" onclick="getCitizenInformation(0)" type="button"
                                                            data-id="0">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-sm-3 bt-flabels__wrapper">
                                                            <input type="text" name="name_en[]" id="name_en_{{ $key }}"
                                                                   value="{{ old('name_en.'.$key) }}"
                                                                   class="form-control @error('name_en.'.$key)is-invalid @enderror"
                                                                   placeholder="Full Name" autofocus
                                                                   data-parsley-trigger="keyup"/>
                                                            <span class="bt-flabels__error-desc">ওয়ার্ড নং নাম দিন ইংরেজিতে....</span>
                                                        ...
                                                        <label for="name_bn_{{ $key }}" class="col-sm-3 control-label">মালিকের
                                                            নাম(বাংলায়) <span class="text-danger">*</span></label>
                                                        <div class="col-sm-3 bt-flabels__wrapper">
                                                            <input type="text" name="name_bn[]" id="name_bn_{{ $key }}"
                                                                   value="{{ old('name_bn.'.$key) }}"
                                                    ...
                                                    <div class="row form-group">
                                                        <label for="nid_{{ $key }}" id="nid_section" class="col-sm-3
                                                        control-label">জাতীয়
                                                        ...
                                                        control-label financialBusinessSection"
                                                        >জন্ম
                                                            নিবন্ধন নং(ইংরেজিতে)</label>
                                                        <div
                                                            class="col-sm-3 bt-flabels__wrapper
                                                            financialBusinessSection  @error('birth_id.0')
                                                                is-invalid @enderror"
                                                            id="birth_id_div_1">
                                                            <input type="text" name="birth_id[]"
                                                                   id="birth_id_{{ $key }}"
                                                                   value="{{ old('birth_id.'.$key) }}"
                                                    ...
                                                    <div class="financialBusinessSection">
                                                        <div class="row form-group">
                                                            ...
                                                            <label class="col-sm-3 control-label">ধর্ম <span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-sm-3 bt-flabels__wrapper">
                                                                <select name="religion[]" id="religion_{{ $key }}"
                                                                        selected="selected"
                                                                        class="form-control financialBusinessInput
                                                                    @error('religion.'.$key) is-invalid @enderror"
                                                                        data-parsley-required>
                                                                    <option
                                                                        value='' {{ (old('resident.'.$key) == '') ? 'selected="selected"' : '' }}>
                                                                        চিহ্নিত করুন
                                                                    </option>
                                                                    <option
                                                                        value='1' {{ (old('resident.'.$key) == 1) ? 'selected="selected"' : '' }}>
                                                                        ইসলাম
                                                                    </option>
                                                                    <option
                                                                        value='2' {{ (old('resident.'.$key) == 2) ? 'selected="selected"' : '' }}>
                                                                        হিন্দু
                                                                    </option>
                                                                    <option
                                                                        value='3' {{ (old('resident.'.$key) == 3) ? 'selected="selected"' : '' }}>
                                                                        বৌদ্ধ ধর্ম
                                                                    </option>
                                                                    <option
                                                                        value='4' {{ (old('resident.'.$key) == 4) ? 'selected="selected"' : '' }}>
                                                                        খ্রিস্ট ধর্ম
                                                                    </option>
                                                                    <option
                                                                        value='5' {{ (old('resident.'.$key) == 5) ? 'selected="selected"' : '' }}>
                                                                        অন্যান্য
                                                                    </option>
                                                                </select>
                                                        ...
                                                        <div class="row form-group">
                                                            ...
                                                            <label class="col-sm-3 control-label">বাসিন্দা <span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-sm-3 bt-flabels__wrapper">
                                                ...
                                                <div class="col-md-3">
                                                    <label for="cropzee-input_{{ $key }}"
                                                        ...
                                                        <div class="image-overlay">
                                                            <img src="{{ asset('images/application/default.jpg') }}"
                                        ...
                                        <div class="financialBusinessSection">
                                            <div class="col-sm-12" id="genderError_{{ $key }}">
                                                <div class="row form-group">
                                                    <label class="col-sm-3 control-label wrap">লিঙ্গ <span
                                                            class="text-danger">*</span></label>
                                                    <div class="col-sm-3 wrap">
                                                        <label class="radio-inline"><input type="radio" id="gender_1"
                                                                                           class="financialBusinessInput  @error('gender.'
                                                                                           .$key)is-invalid @enderror"
                                                                                           name="gender[{{ $key }}]"
                                                                                           {{ (old('gender.'.$key) == 1) ? 'checked' : '' }} onclick="genderStatus({{ $key }})"
                                                                                           value="1">পুরুষ </label>
                                                        <label class="radio-inline"><input type="radio" id="gender_2"
                                                                                           class="@error('gender.'.$key)is-invalid @enderror"
                                                                                           name="gender[{{ $key }}]"
                                                                                           {{ (old('gender.'.$key) == 2) ? 'checked' : '' }} onclick="genderStatus({{ $key }})"
                                                                                           value="2">মহিলা</label>

                                                        <p class="has-danger" id="genderErrorField_{{ $key }}"
                                                           role="alert"></p>
                                                        @error('gender.'.$key)
                                                        <span class="invalid-feedback"
                                                              role="alert"><strong>{{ $message }}</strong></span>
                                                    ...
                                                    <label for="marital_status_{{ $key }}"
                                                        ...
                                                        সম্পর্ক <span class="text-danger">*</span></label>
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <select name="marital_status[]" id="marital_status_{{ $key }}"
                                                                ...
                                                                data-parsley-required>
                                                            <option
                                                                {{ (old('marital_status.'.$key) == '') ? 'selected="selected"' : '' }} value="">
                                                                চিহ্নিত করুন
                                                            </option>
                                                            <option
                                                                {{ (old('marital_status.'.$key) == 1) ? 'selected="selected"' : '' }} value='1'>
                                                                অবিবাহিত
                                                            </option>
                                                            <option
                                                                {{ (old('marital_status.'.$key) == 2) ? 'selected="selected"' : '' }} value='2'>
                                                                বিবাহিত
                                                            </option>
                                                        </select>
                                                        <span
                                        ...
                                        <div class="row financialBusinessSection">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="present_village_en[]"
                                                               ...
                                                               value="{{ old('present_village_en.'.$key) }}"
                                                    ...
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="present_village_bn[]"
                                                               ...
                                                               value="{{ old('present_village_bn.'.$key) }}"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row form-group">
                                                    <label for="present_district_id_{{ $key }}"
                                                           class="col-sm-3 control-label">জেলা <span
                                                            class="text-danger">*</span></label>
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        {{-- <select onchange="getLocation($(this).val(), 'present_district_{{ $key }}', 'present_upazila_append_{{ $key }}', 'present_upazila_id_{{ $key }}', 'present_upazila_{{ $key }}', 3 )"
                                                            class="custom-select2 form-control financialBusinessInput @error('present_district_id.'.$key)is-invalid @enderror"
                                                            id="present_district_id_{{ $key }}"
                                                ...
                                                <input class="form-control @error('present_district_id.'.$key) is-invalid @enderror" id="present_district_txt_{{$key}}" name="present_district_txt[]" style="width: 100%; height: 38px;" data-parsley-required onchange="locationCopy('present_district_txt_{{$key}}', 'present_district_{{$key}}')" value="{{ old('present_district_txt[$key]') }}" />

                                                <input type="hidden" id="present_district_id_{{$key}}" name="present_district_id[]" />
                                                ...
                                                <div class="row form-group">
                                                    <label for="present_upazila_id_{{ $key }}"
                                                           class="col-sm-3 control-label">উপজেলা/থানা <span
                                                            class="text-danger">*</span></label>
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        {{-- <select onchange="getLocation($(this).val(), 'present_upazila_{{ $key }}', 'present_post_office_append_{{ $key }}', 'present_postoffice_id_{{ $key }}', 'present_postoffice_{{ $key }}', 6 )"
                                                            name="present_upazila_id[]"
                                                            id="present_upazila_id_{{ $key }}"
                                                            class="custom-select2 form-control financialBusinessInput @error('present_upazila_id.'.$key)
                                                                is-invalid @enderror"
                                                            data-parsley-required>
                                                    ...
                                                    <input class="form-control @error('present_upazila_id.'.$key) is-invalid @enderror" id="present_upazila_txt_{{$key}}" name="present_upazila_txt[]" style="width: 100%; height: 38px;" data-parsley-required onchange="locationCopy('present_upazila_txt_{{$key}}', 'present_upazila_{{$key}}')" value="{{ old('present_upazila_txt[$key]') }}" />

                                                    <input type="hidden" id="present_upazila_id_{{$key}}" name="present_upazila_id[]" />
                                                ...
                                                <div class="row form-group">
                                                    <label for="present_postoffice_id_{{ $key }}"
                                                           class="col-sm-3 control-label">পোষ্ট অফিস <span
                                                            class="text-danger">*</span></label>
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        {{-- <select onchange="getLocation($(this).val(), 'present_postoffice_{{ $key }}')"
                                                            name="present_postoffice_id[]"
                                                            id="present_postoffice_id_{{ $key }}"
                                                            class="custom-select2 form-control financialBusinessInput @error('present_postoffice_id.'
                                                            .$key)is-invalid @enderror"
                                                            data-parsley-required>
                                                    ...
                                                    <input class="form-control @error('present_postoffice_id.'.$key) is-invalid @enderror" id="present_postoffice_txt_{{$key}}" name="present_postoffice_txt[]" style="width: 100%; height: 38px;" data-parsley-required onchange="locationCopy('present_postoffice_txt_{{$key}}', 'present_postoffice_{{$key}}')" value="{{ old('present_postoffice_txt[$key]') }}" />

                                                    <input type="hidden" id="present_postoffice_id_{{$key}}" name="present_postoffice_id[]" />
                                        ...
                                        <div class="row financialBusinessSection">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="permanent_village_en[]"
                                                               ...
                                                               value="{{ old('permanent_village_en.'.$key) }}"
                                                    ...
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="permanent_village_bn[]"
                                                               ...
                                                               value="{{ old('permanent_village_bn.'.$key) }}"
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="permanent_rbs_en[]"
                                                               ...
                                                               value="{{ old('permanent_rbs_en.'.$key) }}"
                                                    ...
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="permanent_rbs_bn[]"
                                                               ...
                                                               value="{{ old('permanent_rbs_bn.'.$key) }}"
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <input class="form-control @error('permanent_district_id.'.$key) is-invalid @enderror" id="permanent_district_txt_{{$key}}" name="permanent_district_txt[]" style="width: 100%; height: 38px;" data-parsley-required onchange="locationCopy('permanent_district_txt_{{$key}}', 'permanent_district_{{$key}}')" value="{{ old('permanent_district_txt[$key]') }}" />

                                                <input type="hidden" id="permanent_district_id_{{$key}}" name="permanent_district_id[]" />

                                                        <span
                                                            class="bt-flabels__error-desc">জেলা নির্বাচন করুন....</span>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row form-group">
                                                    ...
                                                    <input class="form-control @error('permanent_upazila_id.'.$key) is-invalid @enderror" id="permanent_upazila_txt_{{$key}}" name="permanent_upazila_txt[]" style="width: 100%; height: 38px;" data-parsley-required onchange="locationCopy('permanent_upazila_txt_{{$key}}', 'permanent_upazila_{{$key}}')" value="{{ old('permanent_upazila_txt[$key]') }}" />

                                                    <input type="hidden" id="permanent_upazila_id_{{$key}}" name="permanent_upazila_id[]" />
                                            ...
                                            <input type="hidden" value="" name="pin" id="nagorik-pin-{{ $key }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row" style="margin-top: 50px;">
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="signboard_length" id="signboard_length"
                                       value="{{ old('signboard_length') }}"
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="signboard_width" id="signboard_width"
                                       value="{{ old('signboard_width') }}"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <select name="signboard_type" id="signboard_type"
                                    ...
                                    <option value="nion">নিয়ন</option>
                                    <option value="lighting">আলোকসজ্জা</option>
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <label for="business_type" class="col-sm-3 control-label">ব্যবসার ধরন (বাংলায়) <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-3 bt-flabels__wrapper ">

                                <input type="text" class="form-control @error('business_type')is-invalid @enderror"
                                       name="business_type" id="business_type" data-parsley-required/>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="trade_village_en" id="trade_village_en"
                                       value="{{ old('trade_village_en') }}"
                                       class="form-control @error('trade_village_en')is-invalid @enderror"
                                       autocomplete="trade_village_en" autofocus placeholder=""
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="trade_village_bn" id="trade_village_bn"
                                       value="{{ old('trade_village_bn') }}"
                                       class="form-control @error('trade_village_bn')is-invalid @enderror"
                                       autocomplete="trade_village_bn" autofocus placeholder=""
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <label for="Road-block-sector-bangla" class="col-sm-3 control-label">রোড/ব্লক/সেক্টর
                                (বাংলায়)</label>
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" disabled id="trade_rbs_bn" value="রোড/ব্লক/সেক্টর"
                                       class="form-control" placeholder="রোড/ব্লক/সেক্টর"/>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="trade_holding_no" id="trade_holding_no"
                                       ...
                                       autocomplete="trade_holding_no" autofocus data-parsley-trigger="keyup"/>
                            ...
                            <label for="Word-no-english" class="col-sm-3 control-label">ওয়ার্ড নং <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <select class="custom-select2 form-control @error('trade_ward_no') is-invalid @enderror"
                                        id="trade_ward_no" name="trade_ward_no" style="width: 100%; height: 38px;"
                                ...
                                <span class="bt-flabels__error-desc">ওয়ার্ড নং সিলেক্ট করুন....</span>
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                ...
                                <input class="form-control @error('trade_district_id') is-invalid @enderror" id="trade_district_txt" name="trade_district_txt" style="width: 100%; height: 38px;" data-parsley-required onchange="locationCopy('trade_district_txt', 'trade_district')"/>

                                <input type="hidden" id="trade_district_id" name="trade_district_id" />
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            <label for="trade_upazila_id" class="col-sm-3 control-label">উপজেলা/থানা <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-3 bt-flabels__wrapper">
                                {{-- <select onchange="getLocation($(this).val(), 'trade_upazila', 'trade_post_office_append', 'trade_postoffice_id', 'trade_postoffice', 6 )"
                                    name="trade_upazila_id" id="trade_upazila_id"
                                    class="custom-select2 form-control @error('trade_upazila_id')is-invalid @enderror"
                                    data-parsley-required>
                                    <option value="" id="trade_upazila_append">চিহ্নিত করুন</option>
                                </select> --}}

                                <input class="form-control @error('trade_upazila_id') is-invalid @enderror" id="trade_upazila_txt" name="trade_upazila_txt" style="width: 100%; height: 38px;" data-parsley-required onchange="locationCopy('trade_upazila_txt', 'trade_upazila')"/>

                                <input type="hidden" id="trade_upazila_id" name="trade_upazila_id" />
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                ...
                                <input class="form-control @error('trade_postoffice_id') is-invalid @enderror" id="trade_postoffice_txt" name="trade_postoffice_txt" style="width: 100%; height: 38px;" data-parsley-required onchange="locationCopy('trade_postoffice_txt', 'trade_postoffice')"/>

                                <input type="hidden" id="trade_postoffice_id" name="trade_postoffice_id" />
                            ...
                            <div class="col-sm-3">
                                <input type="text" disabled id="trade_postoffice" value="পোষ্ট অফিস"
