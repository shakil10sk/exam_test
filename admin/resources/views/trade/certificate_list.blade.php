...
<!-- Export Datatable End -->
    ...
    @can('generate')
    <div class="modal fade bs-example-modal-lg" id="trade_regenerate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    ...
                    <form action="javascript:void(0)" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <span class="error" id="expired_error"></span>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <input class="form-control col-md-7" type="text" name="tr_sonod_no" id="tr_sonod_no" readonly />
                                ...
                                <div class="row">
                                    ...
                                    <input class="form-control col-md-7" type="text" name="due" id="due" readonly />
                                </div>
                                </br>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary" onclick="re_generate_save()">জেনারেট</button>
...
@section('script')
    ...
    <script>
        ...
        var trade_certificate_data_url = '@php echo  url("trade/certificate_list_data") @endphp';
        ...
        $('document').ready(function() {
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    general_settings['max_source_tax'] = parseInt(gs.max_source_tax) || 0;
                    general_settings['vat'] = parseInt(gs.vat) || 15;
                    general_settings['running_sarcharge'] = parseInt(gs.running_sarcharge) || 0;
                    general_settings['sarcharge_on_due'] = parseInt(gs.sarcharge_on_due) || 0;
                    general_settings['nion'] = parseInt(gs.nion) || 0;
                    general_settings['lighting'] = parseInt(gs.lighting) || 0;
                    general_settings['general'] = parseInt(gs.general) || 0;

                    response.data.business_fee.forEach(function(item){
                        business_fee[item.business_type_id] = parseInt(item.fees) || 0;
                    });
                }
            });
