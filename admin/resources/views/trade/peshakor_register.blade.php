...
<body>
    ...
    <table align="center" border="1"  width='95%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed;">
    ...
    ?>
      ...
      <tr>
          ...
          <td><?php echo BanglaConverter::bn_number($row->voucher)?></td>

          <td><?php echo $row->organization_name_bn?></td>

          <td><?php echo BanglaConverter::bn_number($row->amount); $fees += $row->amount; ?></td>
