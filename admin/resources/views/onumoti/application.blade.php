...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="title text-center">
                        <h4 class="text-center application_head">অনুমতি পত্রের আবেদন</h4>
                    </div>
    ...
    <section>
        <div class="container">
            <form id="form-data" action="{{ route('onumoti_store') }}" method="post" enctype="multipart/form-data" class="uk-form bt-flabels js-flabels" data-parsley-validate data-parsley-errors-messages-disabled>
                @csrf
                ...
                <div class="row" style="margin-top: 50px;">
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="job_sector_en" id="job_sector_en" class="form-control @error('job_sector_en') is-invalid @enderror"  placeholder="" data-parsley-pattern='^[a-zA-Z.(),:;_ ]+$' data-parsley-trigger="keyup" />
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="job_sector_bn" id="job_sector_bn" class="form-control @error('job_sector_bn') is-invalid @enderror" placeholder=" অনুমতি পত্র  ক্ষেত্রে  যেমন-সেনাবাহিনীতে" data-parsley-required />
                ...
                <div class="row" style="margin-bottom: 100px;">
                    <div class="offset-6 col-sm-6 button-style">
                        ...
                        <input type="hidden" value="13" id="app-type">
