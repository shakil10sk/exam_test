...
<html lang="en-US">
    ...
    <body>
        ...
        <table border="0" cellpadding="5" cellspacing="5" style="border-collapse:collapse;margin-left: 50px; margin-top: 20px; " width="95%">
            <tr>
                <td style="text-align: center; {{($onumoti->photo)?"padding-left:150px;":""}} padding-bottom:50px;">
                    <h2>
                ...
                <td  valign="top" style="text-align: center;" >
                    ...
                    @if($onumoti->photo)
                        <img src="{{ asset('images/application/'. $onumoti->photo) }}" height="80px" width="80px"/>
                    @endif
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-left: 50px;" width="95%">
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ BanglaConverter::bn_number(date('d-m-Y', strtotime($onumoti->created_time))) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($onumoti->pin) }}
                    </span>
                </td>
                ...
                <td colspan="2" style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($onumoti->tracking) }}
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($onumoti->birth_id) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    হোল্ডিং নং
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($onumoti->permanent_holding_no) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        :
                        <?php echo BanglaConverter::bn_number(date('d-m-Y', strtotime($onumoti->
                        birth_date)));?>
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($onumoti->mobile) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    ই-মেইল
            ...
            <tr>
                ...
                <td colspan="" style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($onumoti->nid) }}
                    </span>
                </td>
                ...
                <td style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($onumoti->passport_no) }}
                    </span>
                </td>
            </tr>
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none;height: 80px;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $onumoti->present_village_bn }},   রোড/ব্লক/সেক্টর : {{ $onumoti->present_rbs_bn }},     পোষ্ট অফিস :{{ $onumoti->present_postoffice_name }},   ওয়ার্ড নং : {{ BanglaConverter::bn_number($onumoti->present_ward_no) }}
                        <br/>
            ...
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none; border-bottom:none;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $onumoti->permanent_village_bn }},   রোড/ব্লক/সেক্টর : {{ $onumoti->permanent_rbs_bn }},     পোষ্ট অফিস :{{ $onumoti->permanent_postoffice_name }},   ওয়ার্ড নং : {{ BanglaConverter::bn_number($onumoti->permanent_ward_no) }}
                        <br/>
        ...
        <hr/>
			...
			<table width="95%"  cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;margin-left: 50px; margin-top: 100px; ">
                ...
                <td rowspan="4" style="height:140px;width:160px; border-top:1px solid black; border-left:1px solid black;">
                    ...
                    $url = $url.'/verify/onumoti_application/'.$onumoti->tracking.'/'.$onumoti->union_id.'/'.$onumoti->type;
