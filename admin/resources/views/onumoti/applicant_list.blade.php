        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">অনুমতি পত্র</li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    ...
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='onumoti_applicant_table'>
                <thead>
                    <tr>
...
@can('generate')
<div class="modal fade" id="onumoti_generate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title" id="myLargeModalLabel">একই নামের প্রত্যয়ন জেনারেট</h4>
            ...
            <div class="modal-body">
                ...
                <form action="javascript:void(0)" method="post">
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" type="text" name="onumoti_generate_date" id="onumoti_generate_date" value="{{ date('Y-m-d') }}" />
                    </div>
                    <br>
...
<script>
    ...
    //url for print onumoti sonod
    var onumoti_bangla_sonod_url = '@php echo  url("onumoti/print_bn") @endphp';

    var onumoti_applicant_data_url = '@php echo  url("onumoti/applicant_data") @endphp';

    var onumoti_generate_url = '@php echo  url("onumoti/generate") @endphp';

    var onumoti_delete_url = '@php echo  url("onumoti/delete") @endphp';

    //for applicant csrf
    var onumoti_applicant_csrf = '@php echo csrf_token() @endphp';

    var onumoti_generate_csrf = '@php echo csrf_token() @endphp';

    var onumoti_delete_csrf = '@php echo csrf_token() @endphp';
    ...
    $('document').ready(function() {
        ...
        onumoti_applicant_list();

    });
</script>

<script src="{{ asset('js/onumoti.js') }}"></script>
