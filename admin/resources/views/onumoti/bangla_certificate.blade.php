...
<body>
        ...
        <table style="width:95%; margin-left:48px;border-color:lightgray;border-collapse:collapse;margin-top:10px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td rowspan="3" valign="top" style="text-align: left;" >
                    @if($onumoti->photo != '' )
                        <img src="{{ asset('images/application/'.$onumoti->photo) }}" height="100px" width="100px" style="" alt="profile" />
                    @endif
                </td>
    ...
    <table class="jolchap" align="center" border="0" height="415px" width='99%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed; line-height: 1.5;">
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">:  {{ BanglaConverter::bn_number($onumoti->permanent_ward_no) }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: {{ BanglaConverter::bn_number($onumoti->nid) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ BanglaConverter::bn_number($onumoti->birth_id) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ BanglaConverter::bn_number($onumoti->passport_no) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: <?php echo BanglaConverter::bn_number(date('d-m-Y', strtotime($onumoti->generate_date))); ?></font>
            </td>
        </tr>
    ...
    <tr>
        ...
        <tr>
            <td colspan="{{$colspan+1}}" style="padding-left:40px;font-size:16px;box-sizing: border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;border-bottom: 1px solid black; vertical-align: bottom;">
                <b >নির্দেশাবলীঃ </b>
                <br />
            ...
            <td rowspan="1" style="padding-right:40px; border-left:1px solid black; border-top:1px solid black;">

                <?php

                $url = $url.'/verify/onumoti_bn/'.$onumoti->sonod_no.'/'.$onumoti->union_id.'/'.$onumoti->type;
