...
<head>
    <base href='' />
    <meta charset="utf-8">
    <title>জন্ম, মৃত্যু নিবন্ধন ক্যাশবুক</title>
...
<body>
        ...
        <table style="width:95%; margin-left:48px;border-color:lightgray;border-collapse:collapse;margin-top:10px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td style="text-align:center;font-size:20px;font-weight:bold;padding-bottom: 10px">
                    <font style="">
                        <u>জন্ম, মৃত্যু নিবন্ধন ক্যাশবুক</u>
                    </font>
                </td>
            </tr>
   ...
   <table class="jolchap" align="center" border="1"  width='95%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed;">
      ...
      <tr>
          ...
          <td style="text-align: center; width:150px;">আয়ের খাত</td>
  ...
  <tr>
       ...
       <td><?php if(isset($data['income'][$i])):echo $data['income'][$i]->account_name; $credit_total += $data['income'][$i]->amount;endif;  ?></td>


      <td><?php if(isset($data['income'][$i])):echo BanglaConverter::bn_number($data['income'][$i]->amount);endif;  ?></td>

      <td><?php if(isset($data['income'][$i])):echo $data['income'][$i]->comment;endif;  ?></td>


      <td><?php if(isset($data['expense'][$i])):echo $data['expense'][$i]->account_name;endif;  ?></td>


      <td><?php if(isset($data['expense'][$i])):echo BanglaConverter::bn_number($data['expense'][$i]->amount); $debit_total += $data['expense'][$i]->amount;  endif;  ?></td>

      <td><?php if(isset($data['expense'][$i])):echo $data['expense'][$i]->comment;endif;  ?></td>
  </tr>
