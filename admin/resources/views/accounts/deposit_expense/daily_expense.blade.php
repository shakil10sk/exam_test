...
@section('content')
			...
			<div class="page-header">
		        <div class="row">
		            <div class="col-md-12 col-sm-12">
                        <div class="title">
                            <h4><i class="icon-copy fa fa-file-text" aria-hidden="true"></i> দৈনিক খরচ</h4>
                        </div>
		                <nav aria-label="breadcrumb" role="navigation">
		                    <ol class="breadcrumb">
		                        ...
		                        <li class="breadcrumb-item active" aria-current="page">দৈনিক খরচ</li>
		                    </ol>
		                </nav>
		            </div>
		        </div>
			...
			<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                <form action="javascript:void(0)" method="POST">
                    ...
                    <div class="clearfix mb-20">
                        <div class="row">
                            <label class="col-md-2">খরচের বিস্তারিত</label>
                            <div class="col-md-4">
                    ...
                    <div class="clearfix mb-20">
                        <div class="row">
                            <label class="col-md-2">খরচের প্রধান খাত</label>
                            <div class="col-md-4">
                            ...
                            <label class="col-md-2" id="tsub_label" style="display: none;">খরচের সাব-খাত</label>
