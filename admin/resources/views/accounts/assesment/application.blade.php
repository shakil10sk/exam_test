...
@section('content')
    ...
    <section>
        <div class="container">
            <form action="{{ route('assesment_store') }}" method="post" enctype="multipart/form-data" class="uk-form bt-flabels js-flabels" data-parsley-validate data-parsley-errors-messages-disabled>
                ...
                <div class="row" style="margin-top: 50px;">
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="birth_date" value="{{ old('birth_date') }}" id="birth_date" class="form-control date @error('birth_date') is-invalid @enderror" autocomplete="birth_date" autofocus data-parsley-type="date" data-parsley-trigger="keyup" data-parsley-required  placeholder="0000-00-00" />
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <label for="Village-bangla" class="col-sm-3 control-label">গ্রাম/মহল্লা  <span>*</span></label>
                            <div class="col-sm-3 bt-flabels__wrapper">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="male" id="male" value="{{ old('male') }}" class="form-control @error('male')is-invalid @enderror" placeholder="পুরষের সংখ্যা" autocomplete="male" autofocus data-parsley-type="male" data-parsley-trigger="keyup" />
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="female" id="female" value="{{ old('female') }}" class="form-control @error('female')is-invalid @enderror" placeholder="মহিলার সংখ্যা" autocomplete="female" autofocus data-parsley-type="female" data-parsley-trigger="keyup" />
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="ripe_house" id="ripe_house" value="{{ old('ripe_house') }}" class="form-control" placeholder="পাকা বাড়ী সংখ্যা" autocomplete="ripe_house" autofocus data-parsley-type="ripe_house" data-parsley-trigger="keyup" />
                            </div>
                            <label for="semi_ripe_house" class="col-sm-3 control-label">আধাপাকা বাড়ী</label>
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="semi_ripe_house" id="semi_ripe_house" value="{{ old('semi_ripe_house') }}" class="form-control" placeholder="আধাপাকা বাড়ী সংখ্যা" autocomplete="semi_ripe_house" autofocus data-parsley-type="semi_ripe_house" data-parsley-trigger="keyup" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="raw_house" id="raw_house" value="{{ old('raw_house') }}" class="form-control" placeholder="কাচা বাড়ী সংখ্যা" autocomplete="raw_house" autofocus data-parsley-type="raw_house" data-parsley-trigger="keyup" />
                            </div>

                            <label for="probable_rate" class="col-sm-3 control-label">আনুমানিক মূল্য (৭.৫%)</label>
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="probable_rate" id="probable_rate" value="{{ old('probable_rate') }}" class="form-control" placeholder="00" autocomplete="probable_rate" autofocus data-parsley-type="probable_rate" data-parsley-trigger="keyup" />
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="halson_tax" id="halson_tax" value="{{ old('halson_tax') }}" class="form-control @error('halson_tax')is-invalid @enderror" placeholder="00" autocomplete="halson_tax" autofocus data-parsley-type="halson_tax" data-parsley-trigger="keyup" />
                            ...
                            {{-- <label for="Female" class="col-sm-3 control-label">বকেয়া কর</label>
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="due_tax" id="due_tax" value="{{ old('due_tax') }}" class="form-control" placeholder="00" autocomplete="due_tax" autofocus data-parsley-type="due_tax" data-parsley-trigger="keyup" />
