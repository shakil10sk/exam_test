        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">রাস্তা খননের অনুমতির সনদ</li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='road_excavation_certificate_table'>
                <thead>
                    <tr>
    ...
    <script>
        ...
        var certificate_data_url = '@php echo  url("roadexcavation/certificate_list_data") @endphp';

        var certificate_csrf = '@php echo  csrf_token() @endphp';

        var regenerate_url = '@php echo  url("roadexcavation/regenerate") @endphp';
