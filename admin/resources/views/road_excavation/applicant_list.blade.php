        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">রাস্তা খননের অনুমতির আবেদন</li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    ...
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='road_excavation_applicant_table'>
                <thead>
                    <tr>
...
@can('generate')
    <div class="modal fade" id="road_excavation_generate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
...
<script>
    ...
    //url for print sonod
    var bangla_sonod_url = '@php echo  url("roadexcavation/print_bn") @endphp';

    var applicant_data_url = '@php echo  url("roadexcavation/applicant_data") @endphp';

    var generate_url = '@php echo  url("roadexcavation/generate") @endphp';

    var delete_url = '@php echo  url("roadexcavation/delete") @endphp';
    ...
    $('document').ready(function() {
        ...
        road_excavation_applicant_list();
    });
</script>

<script src="{{ asset('js/road_excavation.js') }}"></script>
