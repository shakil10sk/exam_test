...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="title text-center">
                        <h4 class="text-center application_head">রাস্তা খননের অনুমতির আবেদন</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container">
            <form id="form-data" action="{{ route('road_store') }}" method="post" enctype="multipart/form-data" class="uk-form bt-flabels js-flabels" data-parsley-validate data-parsley-errors-messages-disabled>
                @csrf
                ...
                <div class="row" style="margin-top: 20px;">
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <label for="road_holding_no" class="col-sm-3 control-label">হোল্ডিং নং <span>*</span></label>

                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="road_holding_no" id="road_holding_no" value="{{ old('road_holding_no') }}" data-parsley-trigger="keyup" class="form-control @error('road_holding_no') is-invalid @enderror" autocomplete="road_holding_no" autofocus placeholder="Holding No" />
                            ...
                            <label for="road_cutting_amount" class="col-sm-3 control-label"> রাস্তা কাটা/বোরিং এর পরিমাণ <span>*</span></label>

                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="road_cutting_amount" id="road_cutting_amount" value="{{ old('road_cutting_amount') }}" class="form-control @error('road_cutting_amount') is-invalid @enderror" autocomplete="road_cutting_amount" autofocus placeholder="রাস্তা কাটা/বোরিং এর পরিমাণ" data-parsley-trigger="keyup" data-parsley-required />
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="road_moholla_en" id="road_moholla_en" value="{{ old('road_moholla_en') }}" data-parsley-pattern='^[a-zA-Z. ]+$' data-parsley-trigger="keyup" class="form-control @error('road_moholla_en') is-invalid @enderror" autocomplete="road_moholla_en" autofocus placeholder="Moholla" />
                            ...
                            <label for="road_moholla_bn" class="col-sm-3 control-label">মহল্লা (বাংলায়) <span>*</span></label>

                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="road_moholla_bn" id="road_moholla_bn" value="{{ old('road_moholla_bn') }}" class="form-control @error('road_moholla_bn') is-invalid @enderror" autocomplete="road_moholla_bn" autofocus placeholder="মহল্লা" data-parsley-trigger="keyup" data-parsley-required />
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="road_name_en" id="road_name_en" value="{{ old('road_name_en') }}" data-parsley-pattern='^[a-zA-Z. ]+$' data-parsley-trigger="keyup" class="form-control @error('road_name_en') is-invalid @enderror" autocomplete="road_name_en" autofocus placeholder="Road Name" />
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="road_name_bn" id="road_name_bn" value="{{ old('road_name_bn') }}" class="form-control @error('road_name_bn') is-invalid @enderror" autocomplete="road_name_bn" autofocus placeholder="রাস্তার নাম" data-parsley-trigger="keyup" data-parsley-required />
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <select name="road_type" id="road_type" selected="selected" class="form-control @error('road_type')is-invalid @enderror" data-parsley-required >
                                    ...
                                    <option value='4' {{ (old('road_type') == 4) ? 'selected="selected"' : '' }}>কার্পেটিং</option>

                                    <option value='5' {{ (old('road_type') == 5) ? 'selected="selected"' : '' }}>ডব্লিউ.বি.এম</option>

                                    <option value='6' {{ (old('road_type') == 5) ? 'selected="selected"' : '' }}>এইচ.বি.বি</option>

                                    <option value='7' {{ (old('road_type') == 5) ? 'selected="selected"' : '' }}>সোলিং</option>

                                    <option value='8' {{ (old('road_type') == 5) ? 'selected="selected"' : '' }}>আর.সি.সি</option>
                            ...
                            <label for="road_cutting_cause" class="col-sm-3 control-label">রাস্তা কাটার কারন <span>*</span></label>

                            <div class="col-sm-3 bt-flabels__wrapper">
                                <select name="road_cutting_cause" id="road_cutting_cause" selected="selected" class="form-control @error('road_cutting_cause')is-invalid @enderror" data-parsley-required >
                                    <option value="" {{ (old('road_cutting_cause') == '') ? 'selected="selected"' : '' }}>চিহ্নিত করুন</option>

                                    <option value='1' {{ (old('road_cutting_cause') == 1) ? 'selected="selected"' : '' }}>গ্যাস লাইন সংযোগ</option>

                                    <option value='2' {{ (old('road_cutting_cause') == 2) ? 'selected="selected"' : '' }}>পানির লাইন সংযোগ</option>

                                    <option value='3' {{ (old('road_cutting_cause') == 3) ? 'selected="selected"' : '' }}>বিদ্যুৎ লাইন সংযোগ</option>
                ...
                <div class="row" style="margin-bottom: 100px;">
                    <div class="offset-6 col-sm-6 button-style">
                        ...
                        <input type="hidden" value="94" id="app-type">
