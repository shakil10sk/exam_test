        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">হোল্ডিং নামজারি পত্র</li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='namjari_certificate_table'>
                <thead>
                    <tr>
...
@can('regenerate')
<div class="modal fade" id="namjari_regenerate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title" id="myLargeModalLabel">নামজারী সনদ রি-জেনারেট</h4>
            ...
            <div class="modal-body">
                ...
                <form action="javascript:void(0)" method="post">
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" type="number" name="fee" id="fee" value="0.00" onchange="najmari_amount_calculation()" />
...
<script>
    ...
    var namjari_certificate_data_url = '@php echo  url("holdingnamjari/certificate_list_data") @endphp';

    var namjari_certificate_csrf = '@php echo  csrf_token() @endphp';

    // console.log(img_path);

    var namjari_regenerate_url = '@php echo  url("holdingnamjari/regenerate") @endphp';
