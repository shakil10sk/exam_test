...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="title text-center">
                        <h4 class="text-center application_head">হোল্ডিং নামজারির আবেদন</h4>
                    </div>
    ...
    <section>
        <div class="container">
            <form id="form-data" action="{{ route('holdingnamjari_store') }}" method="post"
...
@enderror" data-parsley-type="number" data-parsley-maxlength="50" data-parsley-trigger="keyup"/>
                ...
                <div class="row" style="margin-bottom: 100px;">
                    <div class="offset-6 col-sm-6 button-style">
                        ...
                        <input type="hidden" value="93" id="app-type">
