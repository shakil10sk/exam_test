        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">হোল্ডিং নামজারির</li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    ...
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='namjari_applicant_table'>
                <thead>
                    <tr>
                        <th class="table-plus datatable-nosort">নং</th>
                        <th>ছবি</th>
                        <th>সাবেক মালিকের নাম</th>
                        <th>পিতা</th>
                        <th>ট্রাকিং</th>
                        <th>পিন</th>
...
@can('generate')
<div class="modal fade" id="namjari_generate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title" id="myLargeModalLabel">হোল্ডিং নামজারী জেনারেট</h4>
            ...
            <div class="modal-body">
                ...
                <form action="javascript:void(0)" method="post">
                    ...
                    <div class="row">
                        <label class="col-md-4 text-right">সাবেক মালিকের নাম</label>
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" type="number" name="fee" id="fee" value="0.00"
                               onchange="najmari_amount_calculation()" />

                    </div>
                    <br>
                    <div class="row">
                        <label class="col-md-4 text-right">ধার্যকৃত পৌরকর</label>

                        <input class="form-control col-md-6" type="number" name="holding_tax" id="holding_tax"
                               value="0.00" onchange="najmari_amount_calculation()" />

                    </div>
                    <br>
                    <div class="row">
                        <label class="col-md-4 text-right">পূর্বোক্ত হোল্ডিং এর পৌরকর</label>

                        <input class="form-control col-md-6" type="number" name="prev_holding_tax" id="prev_holding_tax"
                               value="0.00" onchange="najmari_amount_calculation()" />
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" name="memo_no" id="memo_no" />
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" type="text" name="namjari_generate_date"
                               id="namjari_generate_date" value="{{ date('Y-m-d') }}" />
                    </div>
                    <br>
                    <div class="row">
                        <label class="col-md-4 text-right">বর্তমান নামজারীকৃত হোল্ডিং নং:</label>

                        <input class="form-control col-md-6" type="text" name="current_holding_no"
                               id="current_holding_no"
                               value="" />
                    </div>
                    <br>
                    <div class="row">
                        <label class="col-md-4 text-right">প্রাপ্ত মালিকানা</label>

                        সম্পূর্ন<input  type="radio" name="malikana" value="সম্পূর্ন" id="malikana">
                        আংশিক<input  type="radio" name="malikana" value="আংশিক" id="malikana">
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" type="text" name="total_amount"
                               id="total_amount"
                               value="" readonly />
                    </div>
                    <br>
                    ...
                    <input type="hidden" name="namjari_id" id="namjari_id"  >
...
<script>
    ...
    var namjari_bangla_sonod_url = '@php echo  url("holdingnamjari/print_bn") @endphp';

    var namjari_applicant_data_url = '@php echo  url("holdingnamjari/applicant_data") @endphp';

    var namjari_generate_url = '@php echo  url("holdingnamjari/generate") @endphp';

    var namjari_delete_url = '@php echo  url("holdingnamjari/delete") @endphp';

    //for applicant csrf
    var namjari_applicant_csrf = '@php echo csrf_token() @endphp';

    var namjari_generate_csrf = '@php echo csrf_token() @endphp';

    var namjari_delete_csrf = '@php echo csrf_token() @endphp';
    ...
    $('document').ready(function() {
        ...
        namjari_applicant_list();

    });
</script>

<script src="{{ asset('js/namjari.js') }}"></script>
