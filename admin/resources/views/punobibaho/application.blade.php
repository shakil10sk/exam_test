...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="title text-center">
                        <h4 class="text-center application_head"> পুনঃ বিবাহ না হওয়া সনদের আবেদন</h4>
                    </div>
    ...
    <section>
        <div class="container">
            <form id="form-data" action="{{ route('punobibaho_store') }}" method="post" enctype="multipart/form-data" class="uk-form bt-flabels js-flabels" data-parsley-validate data-parsley-errors-messages-disabled>
                @csrf
                ...
                <div class="row" style="margin-top: 50px;">
                    ...
                    <div class="col-md-12" id="genderErr">
                        ...
                        <div class="row form-group">
                            <label for="Marital-status" class="col-sm-3 control-label"> স্বামী/স্ত্রী  মৃত <span>*</span></label>
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <select name="is_dead" id="is_dead" selected="selected" class="form-control @error('marital_status')is-invalid @enderror" data-parsley-required >
                ...
                <div class="row" style="margin-bottom: 100px;">
                    <div class="offset-6 col-sm-6 button-style">
                        ...
                        <input type="hidden" value="4" id="app-type">
