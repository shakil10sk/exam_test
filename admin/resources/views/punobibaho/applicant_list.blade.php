        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">পুনঃবিবাহ না হওয়া সনদ</li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    ...
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='punobibaho_applicant_table'>
                <thead>
                    <tr>
...
@can('generate')
<div class="modal fade" id="punobibaho_generate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title" id="myLargeModalLabel">পুনঃবিবাহ না হওয়া সনদ জেনারেট</h4>
            ...
            <div class="modal-body">
                ...
                <form action="javascript:void(0)" method="post">
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" type="text" name="punobibaho_generate_date" id="punobibaho_generate_date" value="{{ date('Y-m-d') }}" />
                    </div>
                    <br>
...
<script>
    ...
    //url for print punobibaho sonod
    var punobibaho_bangla_sonod_url = '@php echo  url("punobibaho/print_bn") @endphp';

    var punobibaho_applicant_data_url = '@php echo  url("punobibaho/applicant_data") @endphp';

    var punobibaho_generate_url = '@php echo  url("punobibaho/generate") @endphp';

    var punobibaho_delete_url = '@php echo  url("punobibaho/delete") @endphp';

    //for applicant csrf
    var punobibaho_applicant_csrf = '@php echo csrf_token() @endphp';

    var punobibaho_generate_csrf = '@php echo csrf_token() @endphp';

    var punobibaho_delete_csrf = '@php echo csrf_token() @endphp';
    ...
    $('document').ready(function() {
        ...
        punobibaho_applicant_list();

    });
</script>

<script src="{{ asset('js/punobibaho.js') }}"></script>
