...
<head>
    <base href='' />
    <meta charset="utf-8">
    <title>বাংলা পুনঃবিবাহ না হওয়া সনদ</title>
...
<body>
    <div class="page-border">
        ...
        <table style="width:95%; margin-left:48px;border-color:lightgray;border-collapse:collapse;margin-top:10px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font style="">
                        <u>পুনঃবিবাহ না হওয়া সনদ</u>
                    </font>
                </td>
                    <td style="text-align:right;font-size:10px;font-weight:bold;padding-bottom: 15px">
                        <font>
                            ইস্যু তারিখ:<?php echo BanglaConverter::bn_number(date('d-m-Y', strtotime($punobibaho->generate_date))); ?>
                        </font>
                    </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <table border="1" style="width: 600px;border-color:lightgray;border-collapse:collapse;" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            $sonod = str_split($punobibaho->sonod_no);

                            for($i=0; $i<strlen($punobibaho->sonod_no); $i++):
                ...
                <td rowspan="3" valign="top" style="text-align: right; padding-right: 10px" >
                    @if($punobibaho->photo != '' )
                        <img src="{{ asset('images/application/'.$punobibaho->photo) }}" height="100px" width="100px" style="" alt="profile" />
                    @endif
                </td>
    ...
    <table class="jolchap" align="center" border="0" height="415px" width='99%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed; line-height: 1.5;">
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ $punobibaho->name_bn }}</font>
            </td>
        </tr>

        @if ($punobibaho->marital_status == 2 && $punobibaho->gender == 2 )

        <tr>
            <td align="left" style="font-size:16px;text-indent:55px; font-color:black; width: 150px; padding-left: 50px">স্বামীর নাম</td>
            <td>
                <font style="font-size:16px; ">: {{ $punobibaho->husband_name_bn }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px; ">: {{ $punobibaho->father_name_bn }} </font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">: {{ $punobibaho->mother_name_bn }} </font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                <p style="line-height:25px;font-size:16px; ">
                    ...
                    : গ্রামঃ {{ $punobibaho->present_village_bn }}
                    <br> &nbsp; ডাকঘরঃ {{ $punobibaho->present_postoffice_name_bn }}
                    <br> &nbsp; উপজেলাঃ {{ $punobibaho->present_upazila_name_bn }}
                    <br> &nbsp; জেলাঃ {{ $punobibaho->present_district_name_bn}}</p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                ...
                <p style="line-height:25px;font-size:16px;  ">
                    : গ্রামঃ {{ $punobibaho->permanent_village_bn }}
                    <br> &nbsp; ডাকঘরঃ {{ $punobibaho->permanent_postoffice_name_bn }}
                    <br> &nbsp; উপজেলাঃ {{ $punobibaho->permanent_upazila_name_bn }}
                    <br> &nbsp; জেলাঃ {{ $punobibaho->permanent_district_name_bn }}
                </p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">:  {{ BanglaConverter::bn_number($punobibaho->permanent_ward_no) }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: {{ BanglaConverter::bn_number($punobibaho->nid) }}</font>
            </td>
        </tr>
        @endif

        @if($punobibaho->birth_id > 0)
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ BanglaConverter::bn_number($punobibaho->birth_id) }}</font>
            </td>
        </tr>
        @endif

        @if($punobibaho->passport_no > 0)
        <tr>
            <td align="left" nowrap style="font-size:16px;text-indent:55px; font-color:black; width: 150px; padding-left: 50px">পাসপোর্ট নং </td>
            <td>
                <font style="font-size:16px;">:  {{ BanglaConverter::bn_number($punobibaho->passport_no) }}</font>
            </td>
        </tr>
        @endif
        ...
        <!-- <tr>
            ...
            <td>
                <font style="font-size:16px;">: <?php echo BanglaConverter::bn_number(date('d-m-Y', strtotime($punobibaho->generate_date))); ?></font>
            </td>
        </tr> -->
    ...
    <table border='0' width='98%' cellpadding='0' cellspacing='0' style="border-collapse:collapse;margin:0 auto;padding-top:10px;">
        ...
        <tr>
            <td style="font-size:17px;  padding-left:50px;" height="80">&nbsp; &nbsp; &nbsp; &nbsp;  অত্র পৌরসভার একজন <font style="font-size:17px;">{{ ($punobibaho->resident == 1) ? "অস্থায়ী" : "স্থায়ী" }}
                </font> বাসিন্দা। আমার জানামতে তাহার {{ ($punobibaho->gender == 1) ? "স্ত্রী" : "স্বামী" }}{{ ($punobibaho->is_dead == 1) ? "র মৃত্যুর  পর " : " জীবিত অবস্থায় " }} সে অদ্যবদী দ্বিতীয় বিবাহ বন্ধনে আবব্ধ হয় নাই । তাহার নৈতিক চরিত্র ভাল।
            </td>
    ...
    <table border="0" width='99%' style="border-collapse:collapse; margin:5px auto; height: 100px" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td  style="font-size:16px;">&nbsp;{{ $punobibaho->comment_bn }}
            </td>
        </tr>
    ...
    <tr>
        ...
        <tr>
            ...
            <td rowspan="1" style="border-left:1px solid black; border-top:1px solid black;">
                ...
                $url = $url.'/verify/punobibaho_bn/'.$punobibaho->sonod_no.'/'.$punobibaho->union_id.'/'.$punobibaho->type;
