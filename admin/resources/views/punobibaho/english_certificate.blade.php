...
<head>
    <base href='' />
    <meta charset="utf-8">
    <title>English Re-Marriage Certificate</title>
...
<body>
    ...
    <table class="jolchap" align="center" border="0" height="415px" width='99%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed; line-height: 1.5;">
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ $punobibaho->name_en }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px; ">: {{ $punobibaho->husband_name_en }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px; ">: {{ $punobibaho->father_name_en }} </font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">: {{ $punobibaho->mother_name_en }} </font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                <p style="line-height:25px;font-size:16px; ">
                    ...
                    : Village : {{ $punobibaho->present_village_en }}
                    <br> &nbsp; Post Office: {{ $punobibaho->present_postoffice_name_en }}
                    <br> &nbsp; Upazila/Thana: {{ $punobibaho->present_upazila_name_en }}
                    <br> &nbsp; District: {{ $punobibaho->present_district_name_en}}</p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                ...
                <p style="line-height:25px;font-size:16px;  ">
                    : Village: {{ $punobibaho->permanent_village_en }}
                    <br> &nbsp; Post Office: {{ $punobibaho->permanent_postoffice_name_en }}
                    <br> &nbsp; Upazila/Thana: {{ $punobibaho->permanent_upazila_name_en }}
                    <br> &nbsp; District: {{ $punobibaho->permanent_district_name_en }}
                </p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">:  {{ $punobibaho->permanent_ward_no }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: {{ $punobibaho->nid }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ $punobibaho->birth_id }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ $punobibaho->passport_no }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                 <font style="font-size:16px;">:  <?php echo date('d-m-Y', strtotime($punobibaho->generate_date)); ?></font>
            </td>
        </tr>
    ...
    <table border='0' width='98%' cellpadding='0' cellspacing='0' style="border-collapse:collapse;margin:0 auto;padding-top:10px;">
        ...
        <tr>
            <td style="font-size:17px;  padding-left:50px;" height="80">&nbsp; &nbsp; &nbsp; &nbsp;
                ...
                @if($punobibaho->is_dead == 1)
                    {{ ($punobibaho->gender == 1) ? 'his wife death he' : 'her husband death she' }} was no longer married to a second marriage. {{ ($punobibaho->gender == 1) ? 'His' : 'Her' }}
                    @else
                    As {{ ($punobibaho->gender == 1) ? 'his wife alive he was no longer married.' : 'her husbend alive she was no longer married.' }}
                @endif
                {{ ($punobibaho->gender == 1) ? 'His' : 'Her' }} moral character is good.
        ...
        <tr>
            <td style="padding-left:72px; font-size:17px; height: 20px">I wish {{ ($punobibaho->gender == 1) ? 'him' : 'her' }} all the best and prosperity.</td>
        </tr>
    ...
    <table border="0" width='99%' style="border-collapse:collapse; margin:5px auto; height: 100px" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td  style="font-size:16px;">&nbsp;{{ $punobibaho->comment_en }}
            </td>
        </tr>
    ...
    <table border='0' width="99%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;table-layout:fixed;margin:0px auto;">
        ...
        <tr>
            ...
            <td rowspan="1" style="border-left:1px solid black; border-top:1px solid black;">
                ...
                $url = $url.'/verify/punobibaho_en/'.$punobibaho->sonod_no.'/'.$punobibaho->union_id.'/'.$punobibaho->type;
