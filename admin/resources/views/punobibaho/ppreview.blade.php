...
<html lang="en-US">
    ...
    <body>
        ...
        <table border="0" cellpadding="5" cellspacing="5" style="border-collapse:collapse;margin-left: 50px; margin-top: 20px; " width="95%">
            <tr>
                <td style="text-align: center; {{($punobibaho->photo)?"padding-left:150px;":""}} padding-bottom:50px;">
                    <h2>
                ...
                <td  valign="top" style="text-align: center;" >
                    ...
                    @if($punobibaho->photo)
                        <img src="{{ asset('images/application/'. $punobibaho->photo) }}" height="80px" width="80px"/>
                    @endif
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-left: 50px;" width="95%">
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ BanglaConverter::bn_number(date('d-m-Y', strtotime($punobibaho->created_time))) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2" style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($punobibaho->pin) }}
                    </span>
                </td>
                ...
                <td colspan="2" style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($punobibaho->tracking) }}
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($punobibaho->birth_id) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    হোল্ডিং নং
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($punobibaho->permanent_holding_no) }}
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        :
                        <?php echo BanglaConverter::bn_number(date('d-m-Y', strtotime($punobibaho->
                        birth_date)));?>
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($punobibaho->mobile) }}
                    </span>
                </td>
                <td style="border-left:none;">
                    ই-মেইল
            ...
            <tr>
                ...
                <td colspan="" style="border-left:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($punobibaho->nid) }}
                    </span>
                </td>
                ...
                <td style="border-left:none;border-bottom:none;">
                    <span>
                        : {{ BanglaConverter::bn_number($punobibaho->passport_no) }}
                    </span>
                </td>
            </tr>
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none;height: 80px;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $punobibaho->present_village_bn }},   রোড/ব্লক/সেক্টর : {{ $punobibaho->present_rbs_bn }},     পোষ্ট অফিস :{{ $punobibaho->present_postoffice_name }},   ওয়ার্ড নং : {{ BanglaConverter::bn_number($punobibaho->present_ward_no) }}
                        <br/>
            ...
            <tr style="height:100px;">
                ...
                <td colspan="5" style="border-left:none; border-bottom:none;">
                    <p>
                        :  গ্রাম/মহল্লা : {{ $punobibaho->permanent_village_bn }},   রোড/ব্লক/সেক্টর : {{ $punobibaho->permanent_rbs_bn }},     পোষ্ট অফিস :{{ $punobibaho->permanent_postoffice_name }},   ওয়ার্ড নং : {{ BanglaConverter::bn_number($punobibaho->permanent_ward_no) }}
                        <br/>
        ...
        <table width="95%" cellpadding="0" cellspacing="0" border="0"
			...
			<table width="95%"  cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;margin-left: 50px; margin-top: 100px; ">
                ...
                <td rowspan="4" style="height:140px;width:160px; border-top:1px solid black; border-left:1px solid black;">
                    ...
                    $url = $url.'/verify/punobibaho_application/'.$punobibaho->tracking.'/'.$punobibaho->union_id.'/'.$punobibaho->type;
