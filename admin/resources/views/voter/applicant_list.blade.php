        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ভোটার আইডি স্থানান্তর সনদ</li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    ...
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='voter_applicant_table'>
                <thead>
                    <tr>
...
@can('generate')
<div class="modal fade" id="voter_generate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title" id="myLargeModalLabel">ভোটার আইডি স্থানান্তর জেনারেট</h4>
            ...
            <div class="modal-body">
                ...
                <form action="javascript:void(0)" method="post">
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" type="text" name="voter_generate_date" id="voter_generate_date" value="{{ date('Y-m-d') }}" />
                    </div>
                    <br>
...
<script>
    ...
    //url for print voter sonod
    var voter_bangla_sonod_url = '@php echo  url("voter/print_bn") @endphp';

    var voter_applicant_data_url = '@php echo  url("voter/applicant_data") @endphp';

    var voter_generate_url = '@php echo  url("voter/generate") @endphp';

    var voter_delete_url = '@php echo  url("voter/delete") @endphp';

    //for applicant csrf
    var voter_applicant_csrf = '@php echo csrf_token() @endphp';

    var voter_generate_csrf = '@php echo csrf_token() @endphp';

    var voter_delete_csrf = '@php echo csrf_token() @endphp';
