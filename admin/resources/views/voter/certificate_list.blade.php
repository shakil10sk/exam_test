...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='voter_certificate_table'>
                <thead>
                    <tr>
    ...
    @can('regenerate')
    <div class="modal fade" id="voter_regenerate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title" id="myLargeModalLabel">ভোটার আইডি স্থানান্তর সনদ রি-জেনারেট</h4>
    ...
    <script>
        ...
        var voter_certificate_data_url = '@php echo  url("voter/certificate_list_data") @endphp';

        var voter_certificate_csrf = '@php echo  csrf_token() @endphp';

        // console.log(img_path);

        var voter_regenerate_url = '@php echo  url("voter/regenerate") @endphp';

        var voter_regenerate_csrf = '@php echo csrf_token() @endphp';
