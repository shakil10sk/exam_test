...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="title text-center">
                        <h4 class="text-center application_head">ভোটার আইডি স্থানান্তর সনদের আবেদন</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container">
            <form id="form-data" action="{{ route('voter_store') }}" method="post" enctype="multipart/form-data" class="uk-form bt-flabels js-flabels" data-parsley-validate data-parsley-errors-messages-disabled>
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="row form-group">
                        ...
                        <label for="union_name_bn" class="col-sm-3 control-label">পূর্বের পৌরসভা (বাংলায়) <span>*</span></label>
                        <div class="col-sm-3 bt-flabels__wrapper">
