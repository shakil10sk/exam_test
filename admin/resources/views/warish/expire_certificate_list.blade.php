@extends('layouts.app') @section('content')
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">ওয়ারিশ ব্যবস্থাপনা</li>
                        <li class="breadcrumb-item active" aria-current="page"> মেয়াদ উত্তীর্ন সনদ তালিকা
                        </li>
        ...
        <div class="clearfix mb-20">
            ...
            <div class="row">
                ...
                <div class="col-md-1" style="margin-bottom: 20px">
                    <button type="submit" class="btn btn-primary" onclick="expire_certificate_list_search()">সার্চ করুন
                    </button>
                </div>
            </div>

            <div class="row">
                <table class="stripe hover multiple-select-row data-table-export nowrap" id='warish_expire_certificate_table'>
                    <thead>
                    <tr>
    ...
    @can('regenerate')
        <div class="modal fade" id="warish_regenerate_modal" tabindex="-1" role="dialog"
             aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <h4 class="modal-title" id="myLargeModalLabel">ওয়ারিশ সনদ রি-জেনারেট</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <form action="javascript:void(0)" method="post">
                            ...
                            <div class="row">
                                ...
                                <input class="form-control col-md-6" type="text" name="sonod_no" id="sonod_no"
                                       readonly="readonly"/>
                            </div>
                            <br>
                            ...
                            <div class="row">
                                ...
                                <input class="form-control col-md-6" type="text" name="pin" id="pin"
                                       readonly="readonly"/>
                            </div>
                            <br>
                            ...
                            <br>
                            <div class="row pb-1">
                                <label class="col-md-4 text-right">তদন্তকারীর নাম (বাংলা) <span
                                        class='text-danger'>*</span></label>

                                <input class="form-control col-md-6" type="text" name="investigator_name_bn"
                                       id="investigator_name_bn" placeholder='বাংলায় নাম প্রদান করুন'/>
                                <span class='investigator_error text-danger pull-right'></span>
                            </div>
                            <style>.error {
                            ...
                            <div class="row pb-1">
                                <label class="col-md-4 text-right">তদন্তকারীর নাম (ইংরেজী) </label>

                                <input class="form-control col-md-6" type="text" name="investigator_name_en"
                                       id="investigator_name_en" placeholder='ইংরেজীতে নাম প্রদান করুন'/>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <input class="form-control col-md-6" type="text" name="warish_generate_date"
                                       id="warish_generate_date" value="{{ date('Y-m-d') }}"/>
                            </div>
                            <br>
...
@section('script')
    ...
    <script>
        ...
        var warish_expire_certificate_data_url = '@php echo  url("warish/expire_certificate_list_data") @endphp';

        var warish_expire_certificate_csrf = '@php echo  csrf_token() @endphp';

        // console.log(img_path);

        var warish_regenerate_url = '@php echo  url("warish/regenerate") @endphp';

        var warish_regenerate_csrf = '@php echo csrf_token() @endphp';

        //url for print warish sonod
        var warish_bangla_sonod_url = '@php echo  url("warish/print_bn") @endphp';
        ...
        $('document').ready(function () {
            ...
            warish_expire_certificate_list();

        });
    </script>

    <script src="{{ asset('js/warish.js') }}"></script>
