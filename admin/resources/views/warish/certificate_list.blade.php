            ...
            <div class="col-md-12 col-sm-12">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> সনদ গ্রহনকারিগন
                        </li>
        ...
        <div class="clearfix mb-20">
            ...
            <div class="row">
                ...
                <div class="col-md-1" style="margin-bottom: 20px">
                    <button type="submit" class="btn btn-primary" onclick="certificate_list_search()">সার্চ করুন
                    </button>
                </div>
            </div>

            <div class="row">
                <table class="stripe hover multiple-select-row data-table-export nowrap" id='warish_certificate_table'>
                    <thead>
                    <tr>
...
@section('script')
    ...
    <script>
        ...
        var warish_certificate_data_url = '@php echo  url("warish/certificate_list_data") @endphp';

        var warish_certificate_csrf = '@php echo  csrf_token() @endphp';
