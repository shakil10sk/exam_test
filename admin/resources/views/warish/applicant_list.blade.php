...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    ...
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='warish_applicant_table'>
                <thead>
                    <tr>
    ...
    @can('generate')
    <div class="modal fade" id="warish_generate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title" id="myLargeModalLabel">ওয়ারিশ সনদ জেনারেট</h4>
                ...
                <div class="modal-body">
                    ...
                    <form action="javascript:void(0)" method="post">
                        ...
                        <div class="row pb-1">
                            <label class="col-md-4 text-right">তদন্তকারীর নাম<span class='text-danger'>*</span></label>
                
                            <input class="form-control col-md-6" type="text" name="investigator_name_bn" id="investigator_name_bn" placeholder='বাংলায় নাম প্রদান করুন'  />
                            <span class='investigator_error text-danger pull-right' ></span>
                        </div>
                        <style>.error{border:2px solid red;}</style>

                        <div class="row pb-1">
                            <label class="col-md-4 text-right">তদন্তকারীর নাম</label>

                            <input class="form-control col-md-6" type="text" name="investigator_name_en" id="investigator_name_en" placeholder='ইংরেজীতে নাম প্রদান করুন' />
                        </div>
                        ...
                        <div class="row pb-1">
                            ...
                            <input class="form-control col-md-6" type="text" name="warish_generate_date" id="warish_generate_date" value="{{ date('Y-m-d') }}" />
                        </div>
    ...
    <script>
        ...
        var warish_applicant_data_url = '@php echo  url("warish/applicant_data") @endphp';

        var warish_generate_url = '@php echo  url("warish/generate") @endphp';

        var warish_delete_url = '@php echo  url("warish/delete") @endphp';

        //for applicant csrf
        var warish_applicant_csrf = '@php echo csrf_token() @endphp';

        var warish_generate_csrf = '@php echo csrf_token() @endphp';

        var warish_delete_csrf = '@php echo csrf_token() @endphp';
