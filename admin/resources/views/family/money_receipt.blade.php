...
<head>
    <base href="" />
    <title>পারিবারিক সনদের মানি রসিদ</title>
    <style>
         body {
...
<body>
    ...
    <table border="0" width="95%" align="center" style="border-collapse:collapse; margin:2px auto; padding-top: 50px">
            <tr>
                <td style="width:1.5in; text-align:center;"><img src="{{ asset('images/union_profile/'.$union->main_logo) }}" height="75px" width="80px" /></td>

                <td style="text-align:center;">
                    <font style="font-size:10px; font-weight:bold; color:blue;">{{ $union->bn_name }}</font>
                ...
                <td style="width:1.2in; text-align:left;">
                   ...
                   @if($union->brand_logo != '')
                    <img src="{{ asset('images/union_profile/'.$union->brand_logo) }}" height="75px" width="80px" style="position:relative;right:10px;" />
                    @endif
        ...
        <table border="0" width="95%" align="center" style="border-collapse:collapse; margin:10px auto;">
            ...
            <tr>
                ...
                <td>
                    <font>&nbsp;:&nbsp;
                    {{-- {{$data->permanent_ward_no > 0 ? BanglaConverter::bn_number($data->permanent_ward_no) . ' নং ওয়ার্ড, ' : ''}} --}}

                    {{ BanglaConverter::bn_number($data->permanent_ward_no) }}. নং ওয়ার্ড,
                     {{$data->permanent_village_bn}},
                     {{-- {{ $data->postoffice_name }} --}}
        ...
        <table border="1" width="95%" align="center" style="border-collapse:collapse; margin:2px auto; padding-top: 40px">
        ...
        <table border="0" width="95%" align="center" style="border-collapse:collapse; margin:50px 0px auto;">
        ...
        <!----------------second part----------------->
         ...
         <table border="0" width="95%" align="center" style="border-collapse:collapse; margin:2px auto; padding-top: 40px">
            <tr>
                <td style="width:1.5in; text-align:center;"><img src="{{ asset('images/union_profile/'.$union->main_logo) }}" height="75px" width="80px" /></td>
                ...
                <td style="width:1.2in; text-align:left;">
                    @if($union->brand_logo != '')
                    <img src="{{ asset('images/union_profile/'.$union->brand_logo) }}" height="70px" width="80px" style="position:relative;right:10px;" />
                    @endif
                </td>
        ...
        <table border="0" width="95%" align="center" style="border-collapse:collapse; margin:40px 0px auto;">
