        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">পারিবারিক ব্যবস্থাপনা</li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    ...
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='family_applicant_table'>
                <thead>
                    <tr>
    ...
    @can('generate')
    <div class="modal fade" id="family_generate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title" id="myLargeModalLabel">পারিবারিক সনদ জেনারেট</h4>
                ...
                <div class="modal-body">
                    ...
                    <form action="javascript:void(0)" method="post">
                        ...
                        <div class="row">
                            ...
                            <input class="form-control col-md-6" type="text" name="family_generate_date" id="family_generate_date" value="{{ date('Y-m-d') }}" />
                        </div>
                        <br>
    ...
    <script>
        ...
        //url for print family sonod
        var family_bangla_sonod_url = '@php echo  url("family/print_bn") @endphp';

        var family_applicant_data_url = '@php echo  url("family/applicant_data") @endphp';

        var family_generate_url = '@php echo  url("family/generate") @endphp';

        var family_delete_url = '@php echo  url("family/delete") @endphp';

        //for applicant csrf
        var family_applicant_csrf = '@php echo csrf_token() @endphp';

        var family_generate_csrf = '@php echo csrf_token() @endphp';

        var family_delete_csrf = '@php echo csrf_token() @endphp';
