...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="title text-center">
                        <h4 class="text-center application_head">পারিবারিক সনদের আবেদন</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container">
            <form id="form-data" action="{{ route('family_store') }}" method="post" enctype="multipart/form-data" class="uk-form bt-flabels js-flabels" data-parsley-validate data-parsley-errors-messages-disabled>
                @csrf
                ...
                <div class="row" style="margin-top: 50px;">
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="birth_date" value="{{ old('birth_date') }}" id="birth_date" class="form-control date @error('birth_date')is-invalid @enderror" autocomplete="birth_date" autofocus data-parsley-type="date" placeholder="yyyy-mm-dd" />
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3">
                                <label>পরিচয় পত্র নং (ইংরেজিতে)</label>
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-2 bt-flabels__wrapper">
                                <input type="text" name="member_nid[]" id="member_nid" placeholder="পরিচয় পত্র নং ইংরেজিতে" class="form-control @error('member_nid.0')is-invalid @enderror" />
                ...
                <div class="row" style="margin-bottom: 100px;">
                    <div class="offset-4 col-sm-3 button-style">
                        ...
                        <input type="hidden" value="18" id="app-type">
