...
<style type="text/css">::placeholder {color: grey !important;opacity: .1;}.error{color:red;width: 100%;padding-left: 140px;}</style>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    ...
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='premises_applicant_table'>
                <thead>
                    <tr>
    ...
    @can('generate')
    <div class="modal fade bs-example-modal-lg" id="premises_generate_modal" tabindex="-1" role="dialog"
         aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width: 840px">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myLargeModalLabel">প্রিমিসেস লাইসেন্স জেনারেট</h4>
                    ...
                    <form action="javascript:void(0)" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <label class="col-md-4 text-right">চালান/মেমো/স্লিপ নাম্বার</label>

                                    <input class="form-control col-md-8" type="text" name="memo_no" id="memo_no" value="" />
                                </div>
    ...
    <script>
        ...
        var premises_applicant_data_url = '@php echo  url("premises/applicant_data") @endphp';

        var premises_generate_url = '@php echo  url("premises/generate") @endphp';

        var premises_delete_url = '@php echo  url("premises/delete") @endphp';

        //for applicant csrf
        var premises_applicant_csrf = '@php echo csrf_token() @endphp';

        var premises_generate_csrf = '@php echo csrf_token() @endphp';

        var premises_delete_csrf = '@php echo csrf_token() @endphp';
