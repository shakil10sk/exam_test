...
<head>
    <base href='' />
    <meta charset="utf-8">
    <title>প্রিমিসেস লাইসেন্স রেজিষ্টার</title>
...
<body>
        ...
        <table style="width:95%; margin-left:48px;border-color:lightgray;border-collapse:collapse;margin-top:10px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td style="text-align:center;font-size:20px;font-weight:bold;padding-bottom: 10px">
                    <font style="">
                        <u>প্রিমিসেস লাইসেন্স রেজিষ্টার</u>
                    </font>
                </td>
            </tr>
    ...
    <table class="jolchap" align="center" border="1"  width='95%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed;">
      ...
      <tr>
          ...
          <td style="text-align: center;">ব্যবসার ধরন</td>
          <td style="text-align: center;">মেমো/চালান/<br></br>স্লীপ</td>
          ...
          <td style="text-align: center;">সাইনবোর্ড কর</td>
          <td style="text-align: center;">উৎসের কর</td>
          <td style="text-align: center;">সার চার্জ</td>
    ...
    ?>
      ...
      <tr>
          ...
          <td><?php echo BanglaConverter::bn_number($row['due']); $dues += $row['due']; ?></td>
          ...
          <td><?php echo BanglaConverter::bn_number($row['signbord_vat']); $signbords += $row['signbord_vat']; ?></td>


          <td><?php echo BanglaConverter::bn_number($row['source_vat']); $source_vat += $row['source_vat']; ?></td>
          <td><?php echo BanglaConverter::bn_number($row['sarcharge']); $sarcharges += $row['sarcharge']; ?></td>

          <td><?php $total = ( $row['fee'] + $row['due'] + $row['vat'] + $row['signbord_vat'] + $row['pesha_vat'] +
                  $row['source_vat'] + $row['sarcharge']) -  $row['discount']; echo BanglaConverter::bn_number($total); $totals
                  += $total;  ?></td>
    ...
    <?php endforeach;?>
      ...
      <tr>
          ...
          <td><?php echo BanglaConverter::bn_number($dues);?></td>
          <td><?php echo BanglaConverter::bn_number($discounts);?></td>
          <td><?php echo BanglaConverter::bn_number($vats);?></td>
          <td><?php echo BanglaConverter::bn_number($signbords);?></td>
          <td><?php echo BanglaConverter::bn_number($source_vat);?></td>
          <td><?php echo BanglaConverter::bn_number($sarcharges);?></td>
