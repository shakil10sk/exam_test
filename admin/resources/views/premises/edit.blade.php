...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="title text-center">
                        <h4 class="text-center application_head">প্রিমিসেস লাইসেন্স তথ্য সংশোধন </h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container">
        <form action="{{ route('premises_update') }}" method="post" enctype="multipart/form-data" class="uk-form bt-flabels js-flabels" data-parsley-validate data-parsley-errors-messages-disabled>
                @csrf
                <div class="row mt-3">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            <label for="organization_name_en" class="col-sm-3 control-label">প্রতিষ্ঠানের নাম (ইংরেজিতে)</label>
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="organization_name_en" id="organization_name_en" value="{{ old('organization_name_en')? old('organization_name_en') : $organization->organization_name_en }}" class="form-control @error('organization_name_en')is-invaliid @enderror" autocomplete="organization_name_en" autofocus  data-parsley-pattern='^[a-zA-Z. ]+$' data-parsley-trigger="keyup" />
                            ...
                            <label for="organization_name_bn" class="col-sm-3 control-label">প্রতিষ্ঠানের নাম (বাংলায়) <span>*</span></label>
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="organization_name_bn" id="organization_name_bn" value="{{ old('organization_name_bn')? old('organization_name_bn') : $organization->organization_name_bn }}" class="form-control @error('organization_name_bn')is-invalid @enderror" autocomplete="organization_name_bn" autofocus data-parsley-trigger="keyup" data-parsley-required />
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            <label for="owner_type" class="col-sm-3 control-label">প্রতিষ্ঠানের মালিকানার ধরণ <span>*</span></label>
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <select name="owner_type" id="ownerType" class="form-control @error('owner_type')is-invalid @enderror" selected="selected" data-parsley-required >
                                    <option value="" {{ (old('owner_type')? old('owner_type') : $organization->owner_type  == '') ? 'selected="selected"' : '' }}>চিহ্নিত করুন</option>
                                    <option value="1" {{ (old('owner_type')? old('owner_type') : $organization->owner_type == 1) ? 'selected="selected"' : '' }}>ব্যক্তি মালিকানাধীন</option>
                                    <option value="2" {{ (old('owner_type')? old('owner_type') : $organization->owner_type == 2) ? 'selected="selected"' : '' }}>যৌথ মালিকানা</option>
                                    <option value="3" {{ (old('owner_type')? old('owner_type') : $organization->owner_type == 3) ? 'selected="selected"' : '' }}>কোম্পানী</option>
                                </select>
                    ...
                    <ul class="nav nav-tabs" id="tab-append" role="tablist">
                        ...
                        <button type="button" value="{{ $owner }}" id="owner-plus-btn" class="btn btn-primary" {{ ((old('owner_type')? old('owner_type') : $organization->owner_type) == 2 || (old('owner_type')? old('owner_type') : $organization->owner_type) == 3) ? 'style=display:block;' : 'style=display:none;' }}><i class="icon-copy ion-plus-circled"></i></button>
                        </li>
                    </ul>
                                ...
                                <div class="card card-info">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-sm-3 bt-flabels__wrapper">
                                                            <input type="text" name="name_en[]" id="name_en_{{ $key }}" value="{{ old('name_en.'.$key)? old('name_en.'.$key) : $value['name_en'] }}" class="form-control @error('name_en.'.$key)is-invalid @enderror" placeholder="Full Name" autofocus data-parsley-pattern='^[a-zA-Z. ]+$' data-parsley-trigger="keyup" />
                                                        ...
                                                        <label for="name_bn_{{ $key }}" class="col-sm-3 control-label">মালিকের নাম(বাংলায়) <span>*</span></label>
                                                        <div class="col-sm-3 bt-flabels__wrapper">
                                                            <input type="text" name="name_bn[]" id="name_bn_{{ $key }}" value="{{ old('name_bn.'.$key)? old('name_bn.'.$key) : $value['name_bn'] }}" class="form-control @error('name_bn.'.$key)is-invalid @enderror" placeholder="পূর্ণ নাম" autofocus data-parsley-trigger="keyup" data-parsley-required />
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-sm-3 bt-flabels__wrapper" id="nid_id_div_1">
                                                            <input type="text" name="nid[]" id="nid_{{ $key }}" value="{{ old('nid.'.$key)? old('nid.'.$key) : $value['nid'] }}" class="form-control @error('nid.'.$key)is-invalid @enderror" data-parsley-maxlength="17" autofocus data-parsley-type="number" data-parsley-trigger="keyup"  placeholder="1616623458679011" />
                                                        ...
                                                        <div class="col-sm-3 bt-flabels__wrapper @error('birth_id.0')is-invalid @enderror" id="birth_id_div_1">
                                                            <input type="text" name="birth_id[]" id="birth_id_{{ $key }}" value="{{ old('birth_id.'.$key)? old('birth_id.'.$key) : $value['birth_id'] }}" class="form-control @error('birth_id.'.$key)is-invalid @enderror" data-parsley-maxlength="17" autofocus data-parsley-type="number" data-parsley-trigger="keyup" placeholder="1919623458679011" />
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-sm-3 bt-flabels__wrapper">
                                                            <input type="text" name="educational_qualification[]" id="educational_qualification_{{ $key }}" value="{{ old('educational_qualification.'.$key)? old('educational_qualification.'.$key) : $value['educational_qualification'] }}" class="form-control @error('educational_qualification.'.$key)is-invalid @enderror" autofocus data-parsley-maxlength="150" data-parsley-trigger="keyup" placeholder="শিক্ষাগত যোগ্যতা দিন" />
                                                        ...
                                                        <div class="col-sm-3 bt-flabels__wrapper">
                                                            <select name="religion[]" id="religion_{{ $key }}" selected="selected" class="form-control @error('religion.'.$key)is-invalid @enderror" data-parsley-required >
                                                                <option value='' {{ (old('religion.'.$key)? old('religion.'.$key) : $value['religion'] == '') ? 'selected="selected"' : '' }}>চিহ্নিত করুন</option>
                                                                <option value='1' {{ (old('religion.'.$key)? old('religion.'.$key) : $value['religion'] == 1) ? 'selected="selected"' : '' }}>ইসলাম</option>
                                                                <option value='2' {{ (old('religion.'.$key)? old('religion.'.$key) : $value['religion'] == 2) ? 'selected="selected"' : '' }}>হিন্দু</option>
                                                                <option value='3' {{ (old('religion.'.$key)? old('religion.'.$key) : $value['religion'] == 3) ? 'selected="selected"' : '' }}>বৌদ্ধ ধর্ম</option>
                                                                <option value='4' {{ (old('religion.'.$key)? old('religion.'.$key) : $value['religion'] == 4) ? 'selected="selected"' : '' }}>খ্রিস্ট ধর্ম</option>
                                                                <option value='5' {{ (old('religion.'.$key)? old('religion.'.$key) : $value['religion'] == 5) ? 'selected="selected"' : '' }}>অন্যান্য</option>
                                                            </select>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-sm-3 bt-flabels__wrapper">
                                                            <input type="text" name="occupation[]" id="occupation_{{ $key }}" value="{{ old('occupation.'.$key)? old('occupation.'.$key) : $value['occupation'] }}" class="form-control @error('occupation.'.$key) is-invalid @enderror" autofocus data-parsley-maxlength="120" data-parsley-trigger="keyup" placeholder="পেশা দিন"/>
                                                        ...
                                                        <div class="col-sm-3 bt-flabels__wrapper">
                                                            <select name="resident[]" id='resident_{{ $key }}' selected="selected" class="form-control @error('resident.'.$key)is-invalid @enderror" data-parsley-required >
                                                                <option value='' {{ (old('resident.'.$key)? old('resident.'.$key) : $value['resident'] == '') ? 'selected="selected"' : '' }}>চিহ্নিত করুন</option>
                                                                <option value='1' {{ (old('resident.'.$key)? old('resident.'.$key) : $value['resident'] == 1) ? 'selected="selected"' : '' }}>অস্থায়ী</option>
                                                                <option value='2' {{ (old('resident.'.$key)? old('resident.'.$key) : $value['resident'] == 2) ? 'selected="selected"' : '' }}>স্থায়ী</option>
                                                            </select>
                                                            <span class="bt-flabels__error-desc">অনুগ্রহ করে নির্বাচন করুন....</span>
                                                ...
                                                <div class="col-md-3">
                                                    <label for="cropzee-input_{{ $key }}" onclick="cropTest({{ $key }});">
                                                        <div class="image-overlay">
                                                            <img src="{{ asset('images/application/'.($value['photo']?? "default.jpg")) }}" class="image-previewer image" id="image-0" data-cropzee="cropzee-input_{{ $key }}" />
                                                    ...
                                                    <input id="cropzee-input_{{ $key }}" style="display: none;" name="photo{{ $key }}[]" type="file" accept="image/*">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12" id="genderError_{{ $key }}">
                                            <div class="row form-group">
                                                <label class="col-sm-3 control-label wrap">লিঙ্গ <span>*</span></label>
                                                <div class="col-sm-3 wrap">
                                                    <label class="radio-inline"><input type="radio" id="gender_1" class="@error('gender.'.$key)is-invalid @enderror" name="gender[{{ $key }}]" {{ (old('gender.'.$key)? old('gender.'.$key) : $value['gender'] == 1) ? 'checked' : '' }} onclick="genderStatus({{ $key }})" value="1" >পুরুষ </label>
                                                    <label class="radio-inline"><input type="radio" id="gender_2" class="@error('gender.'.$key)is-invalid @enderror" name="gender[{{ $key }}]" {{ (old('gender.'.$key)? old('gender.'.$key) : $value['gender'] == 2) ? 'checked' : '' }} onclick="genderStatus({{ $key }})" value="2" >মহিলা</label>
                                                ...
                                                <label for="marital_status_{{ $key }}" class="col-sm-3 control-label">বৈবাহিক সম্পর্ক <span>*</span></label>
                                                <div class="col-sm-3 bt-flabels__wrapper">
                                                    <select name="marital_status[]" id="marital_status_{{ $key }}" onchange="genderStatus({{ $key }})" selected="selected" class="form-control @error('marital_status.'.$key)is-invalid @enderror" data-parsley-required >
                                                        <option {{ (old('marital_status.'.$key)? old('marital_status.'.$key) : $value['marital_status'] == '') ? 'selected="selected"' : '' }} value="">চিহ্নিত করুন</option>
                                                        <option {{ (old('marital_status.'.$key)? old('marital_status.'.$key) : $value['marital_status'] == 1) ? 'selected="selected"' : '' }} value='1'>অবিবাহিত</option>
                                                        <option {{ (old('marital_status.'.$key)? old('marital_status.'.$key) : $value['marital_status'] == 2) ? 'selected="selected"' : '' }} value='2'>বিবাহিত</option>
                                                    </select>
                                                    <span class="bt-flabels__error-desc">অনুগ্রহ করে নির্বাচন করুন....</span>
                                        ...
                                        <div class="col-md-12" id="showhidden-husband-name-{{ $key }}" style="display:{{ ((old('gender.'.$key)? old('gender.'.$key) : $value['gender']) == 2 && (old('marital_status.'.$key)? old('marital_status.'.$key) : $value['marital_status']) == 2)? 'block;' : 'none' }}">
                                            <div class="row form-group bt-flabels__wrapper">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" name="husband_name_en[]" id="husband_name_en_{{ $key }}" value="{{ old('husband_name_en.'.$key)? old('husband_name_en.'.$key) : $value['husband_name_en'] }}" class="form-control @error('husband_name_en.'.$key)is-invalid @enderror" placeholder="" data-parsley-pattern='^[a-zA-Z. ]+$' data-parsley-trigger="keyup"/>
                                                ...
                                                <div class="col-sm-3 bt-flabels__wrapper">
                                                    <input type="text" name="husband_name_bn[]" id="husband_name_bn_{{ $key }}" value="{{ old('husband_name_bn.'.$key)? old('husband_name_bn.'.$key) : $value['husband_name_bn'] }}" class="form-control @error('husband_name_bn.'.$key)is-invalid @enderror" placeholder="" />
                                        ...
                                        <div class="col-md-12">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-3 bt-flabels__wrapper">
                                                    <input type="text" name="father_name_en[]" id="father_name_en_{{ $key }}" value="{{ old('father_name_en.'.$key)? old('father_name_en.'.$key) : $value['father_name_en'] }}" class="form-control @error('father_name_en.'.$key) is-invalid @enderror" autofocus data-parsley-pattern='^[a-zA-Z. ]+$' data-parsley-trigger="keyup" placeholder="Father's Name" />
                                                ...
                                                <label for="father_name_bn_{{ $key }}" class="col-sm-3 control-label">পিতার নাম (বাংলায়) <span>*</span></label>
                                                <div class="col-sm-3 bt-flabels__wrapper">
                                                    <input type="text" name="father_name_bn[]" id="father_name_bn_{{ $key }}" value="{{ old('father_name_bn.'.$key)? old('father_name_bn.'.$key) : $value['father_name_bn'] }}" class="form-control @error('father_name_bn.'.$key) is-invalid @enderror" autofocus placeholder="পিতার নাম" data-parsley-required />
                                        ...
                                        <div class="col-md-12">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-sm-3 bt-flabels__wrapper">
                                                    <input type="text" name="mother_name_en[]" id="mother_name_en_{{ $key }}" value="{{ old('mother_name_en.'.$key)? old('mother_name_en.'.$key) : $value['mother_name_en'] }}" data-parsley-pattern='^[a-zA-Z. ]+$' data-parsley-trigger="keyup" autofocus class="form-control @error('mother_name_en.'.$key)is-invalid @enderror" placeholder="Mother's Name" />
                                                ...
                                                <label for="mother_name_bn_{{ $key }}" class="col-sm-3 control-label">মাতার নাম (বাংলায়) <span>*</span></label>
                                                <div class="col-sm-3 bt-flabels__wrapper">
                                                    <input type="text" name="mother_name_bn[]" id="mother_name_bn_{{ $key }}" value="{{ old('mother_name_bn.'.$key)? old('mother_name_bn.'.$key) : $value['mother_name_bn'] }}" class="form-control @error('mother_name_bn.'.$key)is-invalid @enderror" autofocus placeholder="মাতার নাম" data-parsley-trigger="keyup" data-parsley-required />
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="present_village_en[]" id="present_village_en_{{ $key }}" value="{{ old('present_village_en.'.$key)? old('present_village_en.'.$key) : $value['present_village_en'] }}" class="form-control @error('present_village_en.'.$key)is-invalid @enderror" autofocus placeholder="" data-parsley-maxlength="100" data-parsley-trigger="keyup" />
                                                    ...
                                                    <label for="present_village_bn_{{ $key }}" class="col-sm-3 control-label">গ্রাম/মহল্লা (বাংলায়)</label>
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="present_village_bn[]" id="present_village_bn_{{ $key }}" value="{{ old('present_village_bn.'.$key)? old('present_village_bn.'.$key) : $value['present_village_bn'] }}" class="form-control @error('present_village_bn.'.$key)is-invalid @enderror" placeholder="" autofocus data-parsley-maxlength="100" data-parsley-trigger="keyup"  data-parsley-required />
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="present_rbs_en[]" id="present_rbs_en_{{ $key }}" value="{{ old('present_rbs_en.'.$key)? old('present_rbs_en.'.$key) : $value['present_rbs_en'] }}" class="form-control @error('present_rbs_en.'.$key)is-invalid @enderror" placeholder="" autofocus data-parsley-maxlength="100" data-parsley-trigger="keyup"/>
                                                    ...
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="present_rbs_bn[]" id="present_rbs_bn_{{ $key }}" value="{{ old('present_rbs_bn.'.$key)? old('present_rbs_bn.'.$key) : $value['present_rbs_bn'] }}" class="form-control @error('present_rbs_bn.'.$key)is-invalid @enderror" placeholder="" autofocus data-parsley-maxlength="100" data-parsley-trigger="keyup" />
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <label for="present_holding_no_{{ $key }}" class="col-sm-3 control-label">হোল্ডিং নং</label>
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="present_holding_no[]" id="present_holding_no_{{ $key }}" value="{{ old('present_holding_no.'.$key)? old('present_holding_no.'.$key) : $value['present_holding_no'] }}" class="form-control @error('present_holding_no.'.$key)is-invalid @enderror" autofocus data-parsley-type="number" data-parsley-trigger="keyup"  />
                                                    ...
                                                    <label for="present_ward_no_{{ $key }}" class="col-sm-3 control-label">ওয়ার্ড নং</label>
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="present_ward_no[]" id="present_ward_no_{{ $key }}" value="{{ old('present_ward_no.'.$key)? old('present_ward_no.'.$key) : $value['present_ward_no'] }}" class="form-control @error('present_ward_no.'.$key)is-invalid @enderror" autofocus  data-parsley-type="number" data-parsley-trigger="keyup" data-parsley-required/>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row form-group">
                                                    <label for="present_district_id_{{ $key }}" class="col-sm-3 control-label">জেলা</label>
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        ...
                                                        <option value="{{ $value['present_district_id'] }}" selected="selected">{{ $value['present_district_name_en'] }}</option>
                                                        </select>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row form-group">
                                                    <label for="present_upazila_id_{{ $key }}" class="col-sm-3 control-label">উপজেলা/থানা</label>
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <select onchange="getLocation($(this).val(), 'present_upazila_{{ $key }}', 'present_post_office_append_{{ $key }}', 'present_postoffice_id_{{ $key }}', 'present_postoffice_{{ $key }}', 6 )" name="present_upazila_id[]" id="present_upazila_id_{{ $key }}" class="custom-select2 form-control @error('present_upazila_id.'.$key)is-invalid @enderror" data-parsley-required >
                                                            ...
                                                            <option value="{{ $value['present_upazila_id'] }}" selected="selected">{{ $value['present_upazila_name_en'] }}</option>
                                                        </select>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row form-group">
                                                    <label for="present_postoffice_id_{{ $key }}" class="col-sm-3 control-label">পোষ্ট অফিস</label>
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <select onchange="getLocation($(this).val(), 'present_postoffice_{{ $key }}')" name="present_postoffice_id[]" id="present_postoffice_id_{{ $key }}" class="custom-select2 form-control @error('present_postoffice_id.'.$key)is-invalid @enderror" data-parsley-required >
                                                            ...
                                                            <option value="{{ $value['present_postoffice_id'] }}" selected="selected">{{ $value['present_postoffice_name_en'] }}</option>
                                                        </select>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" disabled id="present_postoffice_{{ $key }}" value="{{ $value['present_postoffice_name_bn'] }}" class="form-control" placeholder=""/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="permanent_village_en[]" id="permanent_village_en_{{ $key }}" value="{{ old('permanent_village_en.'.$key)? old('permanent_village_en.'.$key) : $value['permanent_village_en'] }}" class="form-control @error('permanent_village_en.'.$key)is-invalid @enderror" autofocus placeholder="" data-parsley-maxlength="100" data-parsley-trigger="keyup" />
                                                        <span class="bt-flabels__error-desc">গ্রাম/মহল্লা দিন ইংরেজিতে....</span>
                                                    ...
                                                    <label for="permanent_village_bn_{{ $key }}" class="col-sm-3 control-label">গ্রাম/মহল্লা (বাংলায়)</label>
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="permanent_village_bn[]" id="permanent_village_bn_{{ $key }}" value="{{ old('permanent_village_bn.'.$key)? old('permanent_village_bn.'.$key) : $value['permanent_village_bn'] }}" class="form-control @error('permanent_village_bn.'.$key)is-invalid @enderror" autofocus placeholder="" data-parsley-maxlength="100" data-parsley-trigger="keyup"  data-parsley-required />
                                                        <span class="bt-flabels__error-desc">গ্রাম/মহল্লা দিন বাংলায়....</span>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="permanent_rbs_en[]" id="permanent_rbs_en_{{ $key }}" value="{{ old('permanent_rbs_en.'.$key)? old('permanent_rbs_en.'.$key) : $value['permanent_rbs_en'] }}" class="form-control @error('permanent_rbs_en.'.$key)is-invalid @enderror" placeholder="" autofocus data-parsley-maxlength="100" data-parsley-trigger="keyup"/>
                                                        <span class="bt-flabels__error-desc">রোড/ব্লক/সেক্টর দিন ইংরেজিতে....</span>
                                                    ...
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="permanent_rbs_bn[]" id="permanent_rbs_bn_{{ $key }}" value="{{ old('permanent_rbs_bn.'.$key)? old('permanent_rbs_bn.'.$key) : $value['permanent_rbs_bn'] }}" class="form-control @error('permanent_rbs_bn.'.$key)is-invalid @enderror" placeholder="" autofocus data-parsley-maxlength="100" data-parsley-trigger="keyup"  />
                                                        <span class="bt-flabels__error-desc">রোড/ব্লক/সেক্টর দিন বাংলায়....</span>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="permanent_holding_no[]" id="permanent_holding_no_{{ $key }}" value="{{ old('permanent_holding_no.'.$key)? old('permanent_holding_no.'.$key) : $value['permanent_holding_no'] }}" class="form-control @error('permanent_holding_no.'.$key)is-invalid @enderror" autofocus data-parsley-type="number" data-parsley-trigger="keyup"  />
                                                        <span class="bt-flabels__error-desc">হোল্ডিং নং দিন ইংরেজিতে....</span>
                                                    ...
                                                    <label for="permanent_ward_no_{{ $key }}" class="col-sm-3 control-label">ওয়ার্ড নং</label>
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <input type="text" name="permanent_ward_no[]" id="permanent_ward_no_{{ $key }}" value="{{ old('permanent_ward_no.'.$key)? old('permanent_ward_no.'.$key) : $value['permanent_ward_no'] }}" class="form-control @error('permanent_ward_no.'.$key)is-invalid @enderror" autofocus  data-parsley-type="number" data-parsley-trigger="keyup" data-parsley-required/>
                                                        <span class="bt-flabels__error-desc">ওয়ার্ড নং দিন ইংরেজিতে....</span>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row form-group">
                                                    <label for="permanent_district_id_{{ $key }}" class="col-sm-3 control-label">জেলা</label>
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <select onchange="getLocation($(this).val(), 'permanent_district_{{ $key }}', 'permanent_upazila_append_{{ $key }}', 'permanent_upazila_id_{{ $key }}', 'permanent_upazila_{{ $key }}', 3 )" name="permanent_district_id[]" id="permanent_district_id_{{ $key }}" class="custom-select2 form-control @error('permanent_district_id.'.$key)is-invalid @enderror" style="width: 100%; height: 38px;" data-parsley-required >
                                                            <option value="" class="district_append">-আপনার জেলা নির্বাচন করুন-</option>
                                                            <option value="{{ $value['permanent_district_id'] }}" selected="selected">{{ $value['permanent_district_name_en'] }}</option>
                                                        </select>
                                                        <span class="bt-flabels__error-desc">জেলা নির্বাচন করুন....</span>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" disabled id="permanent_district_{{ $key }}" value="{{ $value['permanent_district_name_bn'] }}" class="form-control" placeholder=""/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row form-group">
                                                    <label for="permanent_upazila_id_{{ $key }}" class="col-sm-3 control-label">উপজেলা/থানা</label>
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <select onchange="getLocation($(this).val(), 'permanent_upazila_{{ $key }}', 'permanent_post_office_append_{{ $key }}', 'permanent_postoffice_id_{{ $key }}', 'permanent_postoffice_{{ $key }}', 6 )" name="permanent_upazila_id[]" id="permanent_upazila_id_{{ $key }}" class="custom-select2 form-control @error('permanent_upazila_id.'.$key)is-invalid @enderror" data-parsley-required >
                                                            ...
                                                            <option value="{{ $value['permanent_upazila_id'] }}" selected="selected">{{ $value['permanent_upazila_name_en'] }}</option>
                                                        </select>
                                                        <span class="bt-flabels__error-desc">উপজেলা/থানা নির্বাচন করুন....</span>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" disabled id="permanent_upazila_{{ $key }}" value="{{ $value['permanent_upazila_name_bn'] }}" class="form-control" placeholder=""/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row form-group">
                                                    <label for="permanent_postoffice_id_{{ $key }}" class="col-sm-3 control-label">পোষ্ট অফিস</label>
                                                    <div class="col-sm-3 bt-flabels__wrapper">
                                                        <select onchange="getLocation($(this).val(), 'permanent_postoffice_{{ $key }}')" name="permanent_postoffice_id[]" id="permanent_postoffice_id_{{ $key }}" class="custom-select2 form-control @error('permanent_postoffice_id.'.$key)is-invalid @enderror" data-parsley-required >
                                                            ...
                                                            <option value="{{ $value['permanent_postoffice_id'] }}" selected="selected">{{ $value['permanent_postoffice_name_en'] }}</option>
                                                        </select>
                                                        <span class="bt-flabels__error-desc">পোষ্ট অফিস নির্বাচন করুন....</span>
                                                    ...
                                                    <div class="col-sm-3">
                                                    <input type="hidden" name="citizen_id[]" value="{{ $value['citizen_id'] }}">
                                                    <input type="hidden" name="owner_id[]" value="{{ $value['owner_id'] }}">
                                                    <input type="hidden" name="pin[]" value="{{ $value['pin'] }}">
                                                    <input type="text" disabled id="permanent_postoffice_{{ $key }}" value="{{ $value['permanent_postoffice_name_bn'] }}" class="form-control" placeholder=""/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="row" style="margin-top: 50px;">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="vat_id" id="vat_id" value="{{ old('vat_id')? old('vat_id') : $organization->vat_id }}" class="form-control @error('vat_id')is-invalid @enderror" placeholder="ইংরেজিতে" autocomplete="vat_id" autofocus data-parsley-type="number" data-parsley-maxlength="17" data-parsley-trigger="keyup" />
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="tax_id" id="tax_id" value="{{ old('tax_id')? old('tax_id') : $organization->tax_id }}" class="form-control @error('tax_id')is-invalid @enderror" placeholder="ইংরেজিতে" autocomplete="tax_id" autofocus data-parsley-type="number" data-parsley-maxlength="17" data-parsley-trigger="keyup" />
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="normal_signboard" id="normal_signboard" value="{{ old
                                ('normal_signboard') ? old
                                ('normal_signboard') : $organization->normal_signboard  }}"
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="lighted_signboard" id="lighted_signboard" value="{{ old
                                ('lighted_signboard') ? old
                                ('lighted_signboard') :  $organization->lighted_signboard  }}"
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="agent_name_en" id="agent_name_en" value="{{ old
                                ('agent_name_en') ? old
                                ('agent_name_en') : $organization->agent_name_en  }}"
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="agent_name_bn" id="agent_name_bn" value="{{ old
                                ('agent_name_bn') ? old
                                ('agent_name_bn') : $organization->agent_name_bn }}"
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                ...
                                ('business_start_date') ? old
                                ('business_start_date') : $organization->business_start_date   }}"
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="previous_license_data" id="previous_license_data" value="{{
                                old('previous_license_data') ? old('previous_license_data') : $organization->previous_license_data }}"
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="capital" id="capital" value="{{ old('capital')? old('capital') : $organization->capital }}" class="form-control @error('capital')is-invalid @enderror" autocomplete="capital" autofocus data-parsley-type="number" data-parsley-trigger="keyup"/>
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper ">
                                ...
                                <input type="text"  class="form-control @error('building_size')is-invalid @enderror"
                                       name="building_size" id="building_size" value="{{ old('building_size') ? old
                                       ('building_size') :  $organization->building_size   }}"
                                />
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group" >
                            <label for="business_type" class="col-sm-3 control-label">ব্যবসার ধরন (বাংলায়) <span>*</span></label>
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text"  class="form-control @error('business_type')is-invalid @enderror"
                                       name="business_type" value="{{ old('business_type') ?  old('business_type') :
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            <label for="office_village_en" class="col-sm-3 control-label">গ্রাম/মহল্লা (ইংরেজিতে)</label>
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="office_village_en" id="office_village_en" value="{{ old('office_village_en')? old('office_village_en') : $organization->office_village_en }}" class="form-control @error('office_village_en')is-invalid @enderror" autocomplete="office_village_en" autofocus placeholder="" data-parsley-maxlength="100" data-parsley-trigger="keyup" />
                                <span class="bt-flabels__error-desc">গ্রাম/মহল্লা দিন ইংরেজিতে....</span>
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="office_village_bn" id="office_village_bn" value="{{ old('office_village_bn')? old('office_village_bn') : $organization->office_village_bn }}" class="form-control @error('office_village_bn')is-invalid @enderror" placeholder="" autocomplete="office_village_bn" autofocus data-parsley-maxlength="100" data-parsley-trigger="keyup"  data-parsley-required />
                                <span class="bt-flabels__error-desc">গ্রাম/মহল্লা দিন বাংলায়....</span>
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="office_rbs_en" id="office_rbs_en" value="{{ old('office_rbs_en')? old('office_rbs_en') : $organization->office_rbs_en }}" class="form-control @error('office_rbs_en')is-invalid @enderror" autocomplete="office_rbs_en" autofocus placeholder="" data-parsley-maxlength="100" data-parsley-trigger="keyup"/>
                                <span class="bt-flabels__error-desc">রোড/ব্লক/সেক্টর দিন ইংরেজিতে....</span>
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="office_rbs_bn" id="office_rbs_bn" value="{{ old('office_rbs_bn')? old('office_rbs_bn') : $organization->office_rbs_bn }}" class="form-control @error('office_rbs_bn')is-invalid @enderror" autocomplete="office_rbs_bn" autofocus placeholder="" data-parsley-maxlength="100" data-parsley-trigger="keyup"  />
                                <span class="bt-flabels__error-desc">রোড/ব্লক/সেক্টর দিন বাংলায়....</span>
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="office_holding_no" id="office_holding_no" value="{{ old('office_holding_no')? old('office_holding_no') : $organization->office_holding_no }}" class="form-control @error('office_holding_no')is-invalid @enderror" autocomplete="office_holding_no" autofocus data-parsley-type="number" data-parsley-trigger="keyup" />
                                <span class="bt-flabels__error-desc">হোল্ডিং নং দিন ইংরেজিতে....</span>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <select onchange="getLocation($(this).val(), 'trade_district', 'trade_upazila_append', 'trade_upazila_id', 'trade_upazila', 3 )" name="trade_district_id" id="trade_district_id" class="custom-select2 form-control @error('trade_district_id')is-invalid @enderror" style="width: 100%; height: 38px;" data-parsley-required >
                                    <option value="" class="district_append">-আপনার জেলা নির্বাচন করুন-</option>
                                <option value="{{ $organization->trade_district_id }}" selected="selected">{{ $organization->trade_district_name_en }}</option>
                                </select>
                                <span class="bt-flabels__error-desc">জেলা নির্বাচন করুন....</span>
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                ...
                                <option value="{{ $organization->trade_upazila_id }}" selected="selected">{{ $organization->trade_upazila_name_en }}</option>
                                </select>
                                <span class="bt-flabels__error-desc">উপজেলা/থানা নির্বাচন করুন....</span>
                            ...
                            <div class="col-sm-3">
                                <input type="text" disabled id="trade_upazila" value="{{ $organization->trade_upazila_name_bn }}" class="form-control" placeholder=""/>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <select onchange="getLocation($(this).val(), 'trade_postoffice')" name="trade_postoffice_id" id="trade_postoffice_id" class="custom-select2 form-control @error('trade_postoffice_id')is-invalid @enderror" data-parsley-required >
                                    ...
                                    <option value="{{ $organization->trade_postoffice_id }}" selected="selected">{{ $organization->trade_postoffice_name_en }}</option>
                                </select>
                                <span class="bt-flabels__error-desc">পোষ্ট অফিস নির্বাচন করুন....</span>
                            ...
                            <div class="col-sm-3">
                                <input type="text" disabled id="trade_postoffice" value="{{ $organization->trade_postoffice_name_bn }}" class="form-control" placeholder=""/>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="email" id="email" value="{{ old('email')? old('email') : $organization->email }}" class="form-control @error('email')is-invalid @enderror" placeholder="example@gmail.com" autocomplete="email" autofocus data-parsley-type="email" data-parsley-trigger="keyup" />
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="tel" id="tel" value="{{ old('tel')? old('tel') : $organization->phone }}" class="form-control @error('tel')is-invalid @enderror" placeholder="" autocomplete="tel" autofocus data-parsley-type="digits" data-parsley-trigger="keyup"/>
