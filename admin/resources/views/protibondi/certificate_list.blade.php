...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='protibondi_certificate_table'>
                <thead>
                    <tr>
...
@can('regenerate')
<div class="modal fade" id="protibondi_regenerate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title" id="myLargeModalLabel">প্রকৃত বাকঁ ও শ্রবন প্রতিবন্ধী সনদ রি-জেনারেট</h4>
...
<script>
    ...
    var protibondi_certificate_data_url = '@php echo  url("protibondi/certificate_list_data") @endphp';

    var protibondi_certificate_csrf = '@php echo  csrf_token() @endphp';

    // console.log(img_path);

    var protibondi_regenerate_url = '@php echo  url("protibondi/regenerate") @endphp';

    var protibondi_regenerate_csrf = '@php echo csrf_token() @endphp';
