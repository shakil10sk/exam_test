   ...
   @include('layouts.pdf_sub_layouts.certificate_header_en')
        ...
        <table style="width:95%; margin-left:48px;border-color:lightgray;border-collapse:collapse;margin-top:10px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td colspan="2" style="text-align:center;font-size:25px;font-weight:bold;padding-bottom: 5px">
                    <font style="">
                        <u>Actual speech and hearing impairment Certificate</u>
                    </font>
                </td>
            </tr>
    ...
    <table class="jolchap" align="center" border="0" height="415px" width='99%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed; line-height: 1.5;">
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ $protibondi->name_en }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px; ">: {{ $protibondi->husband_name_en }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px; ">: {{ $protibondi->father_name_en }} </font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">: {{ $protibondi->mother_name_en }} </font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                <p style="line-height:25px;font-size:16px; ">
                    ...
                    : Village : {{ $protibondi->present_village_en }}
                    <br> &nbsp; Post Office: {{ $protibondi->present_postoffice_name_en }}
                    <br> &nbsp; Upazila/Thana: {{ $protibondi->present_upazila_name_en }}
                    <br> &nbsp; District: {{ $protibondi->present_district_name_en}}</p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                ...
                <p style="line-height:25px;font-size:16px;  ">
                    : Village: {{ $protibondi->permanent_village_en }}
                    <br> &nbsp; Post Office: {{ $protibondi->permanent_postoffice_name_en }}
                    <br> &nbsp; Upazila/Thana: {{ $protibondi->permanent_upazila_name_en }}
                    <br> &nbsp; District: {{ $protibondi->permanent_district_name_en }}
                </p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">:  {{ $protibondi->permanent_ward_no }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: {{ $protibondi->nid }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ $protibondi->birth_id }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ $protibondi->passport_no }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                 <font style="font-size:16px;">:  <?php echo date('d-m-Y', strtotime($protibondi->generate_date)); ?></font>
            </td>
        </tr>
    ...
    <table border='0' width='98%' cellpadding='0' cellspacing='0' style="border-collapse:collapse;margin:0 auto;padding-top:10px;">
        ...
        <tr>
            <td style="font-size:17px;  padding-left:50px;" height="80">&nbsp; &nbsp; &nbsp; &nbsp; To my knowledge, there is a {{ ($protibondi->resident == 1) ? "temporary" : "permanent" }} resident of the union and a deaf and hearing impaired person.</td>

        </tr>

        <tr>
            <td style="padding-left:72px; font-size:17px; height: 20px">I wish {{ ($protibondi->gender == 1) ? 'him' : 'her' }} all the best and prosperity.</td>
        </tr>
    ...
    <table border="0" width='99%' style="border-collapse:collapse; margin:5px auto; height: 100px" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td  style="font-size:16px;">&nbsp;{{ $protibondi->comment_en }}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td rowspan="1" style="border-left:1px solid black; border-top:1px solid black;">
               ...
               <?php
                ...
                $url = $url.'/verify/protibondi_en/'.$protibondi->sonod_no.'/'.$protibondi->union_id.'/'.$protibondi->type;
