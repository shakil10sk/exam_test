...
<head>
    <base href='' />
    <meta charset="utf-8">
    <title>বাংলা প্রতিবন্ধী সনদপত্র</title>
...
<body>
        ...
        <table style="width:95%; margin-left:48px;border-color:lightgray;border-collapse:collapse;margin-top:10px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td colspan="2" style="text-align:center;font-size:25px;font-weight:bold;padding-bottom: 5px">
                    <font style="">
                        <u>প্রকৃত বাক ও শ্রবণ প্রতিবন্ধি সনদ</u>
                    </font>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <table border="1" style="width: 600px;border-color:lightgray;border-collapse:collapse;" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            $sonod = str_split($protibondi->sonod_no);

                            for($i=0; $i<strlen($protibondi->sonod_no); $i++):
                ...
                <td rowspan="3" valign="top" style="text-align: left;" >
                    @if($protibondi->photo != '' )
                        <img src="{{ asset('images/application/'.$protibondi->photo) }}" height="100px" width="100px" style="" alt="profile" />
                    @endif
                </td>
    ...
    <table class="jolchap" align="center" border="0" height="415px" width='99%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed; line-height: 1.5;">
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ $protibondi->name_bn }}</font>
            </td>
        </tr>

        @if ($protibondi->marital_status == 2 && $protibondi->gender == 2 )

        <tr>
            <td align="left" style="font-size:16px;text-indent:55px; font-color:black; width: 150px; padding-left: 50px">স্বামীর নাম</td>
            <td>
                <font style="font-size:16px; ">: {{ $protibondi->husband_name_bn }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px; ">: {{ $protibondi->father_name_bn }} </font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">: {{ $protibondi->mother_name_bn }} </font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                <p style="line-height:25px;font-size:16px; ">
                    ...
                    : গ্রামঃ {{ $protibondi->present_village_bn }}
                    <br> &nbsp; ডাকঘরঃ {{ $protibondi->present_postoffice_name_bn }}
                    <br> &nbsp; উপজেলাঃ {{ $protibondi->present_upazila_name_bn }}
                    <br> &nbsp; জেলাঃ {{ $protibondi->present_district_name_bn}}</p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                ...
                <p style="line-height:25px;font-size:16px;  ">
                    : গ্রামঃ {{ $protibondi->permanent_village_bn }}
                    <br> &nbsp; ডাকঘরঃ {{ $protibondi->permanent_postoffice_name_bn }}
                    <br> &nbsp; উপজেলাঃ {{ $protibondi->permanent_upazila_name_bn }}
                    <br> &nbsp; জেলাঃ {{ $protibondi->permanent_district_name_bn }}
                </p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">:  {{ BanglaConverter::bn_number($protibondi->permanent_ward_no) }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: {{ BanglaConverter::bn_number($protibondi->nid) }}</font>
            </td>
        </tr>
        @endif

        @if($protibondi->birth_id > 0)
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ BanglaConverter::bn_number($protibondi->birth_id) }}</font>
            </td>
        </tr>
        @endif

        @if($protibondi->passport_no > 0)
        <tr>
            <td align="left" nowrap style="font-size:16px;text-indent:55px; font-color:black; width: 150px; padding-left: 50px">পাসপোর্ট নং </td>
            <td>
                <font style="font-size:16px;">:  {{ BanglaConverter::bn_number($protibondi->passport_no) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: <?php echo BanglaConverter::bn_number(date('d-m-Y', strtotime($protibondi->generate_date))); ?></font>
            </td>
        </tr>
    ...
    <table border='0' width='98%' cellpadding='0' cellspacing='0' style="border-collapse:collapse;margin:0 auto;padding-top:10px;">
        ...
        <tr>
            <td style="font-size:17px;  padding-left:50px;" height="80">&nbsp; &nbsp; &nbsp; &nbsp; আমার জানামতে অত্র পৌরসভার একজন <font style="font-size:17px;">{{ ($protibondi->resident == 1) ? "অস্থায়ী" : "স্থায়ী" }}
                </font> বাসিন্দা ও প্রকৃত বাকঁ ও শ্রবন প্রতিবন্ধী ।
            </td>
    ...
    <table border="0" width='99%' style="border-collapse:collapse; margin:5px auto; height: 100px" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td  style="font-size:16px;">&nbsp;{{ $protibondi->comment_bn }}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td rowspan="1" style="border-left:1px solid black; border-top:1px solid black;">
                ...
                <?php
                    ...
                    $url = $url.'/verify/protibondi_bn/'.$protibondi->sonod_no.'/'.$protibondi->union_id.'/'.$protibondi->type;
