...
@section('content')
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="title text-center">
                    <h4 class="text-center application_head">নতুন হোল্ডিং আবেদন</h4>
                </div>
    ...
    <section>
        <div class="container">
            <form id="form-data" action="{{ route('newholding_store') }}" method="post" enctype="multipart/form-data"
                ...
                <div class="row" style="margin-top: 50px;">
                    ...
                    <div class="col-md-12">
                        <div class="row form-group">
                            <label for="Name-english" class="col-sm-3 control-label">হোল্ডিং গ্রহীতার নাম ( ইংরেজিতে
                                )</label>
                            ...
                            <label for="Name-bangla" class="col-sm-3 control-label">হোল্ডিং গ্রহীতার নাম ( বাংলায় )
                                <span>*</span></label>
                            <div class="col-sm-3 bt-flabels__wrapper">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <select name="religion" id="religion" selected="selected"
                                        ...
                                        data-parsley-required>
                                    <option value='' {{ (old('religion') == '') ? 'selected="selected"' : '' }}>চিহ্নিত
                                        করুন
                                    </option>
                                    <option value='1' {{ (old('religion') == 1) ? 'selected="selected"' : '' }}>ইসলাম
                                    </option>
                                    <option value='2' {{ (old('religion') == 2) ? 'selected="selected"' : '' }}>হিন্দু
                                    </option>
                                    <option value='3' {{ (old('religion') == 3) ? 'selected="selected"' : '' }}>বৌদ্ধ
                                        ধর্ম
                                    </option>
                                    <option value='4' {{ (old('religion') == 4) ? 'selected="selected"' : '' }}>খ্রিস্ট
                                        ধর্ম
                                    </option>
                                    <option value='5' {{ (old('religion') == 5) ? 'selected="selected"' : '' }}>
                                        অন্যান্য
                                    </option>
                                </select>
                                <span class="bt-flabels__error-desc">অনুগ্রহ করে নির্বাচন করুন....</span>
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                ...
                                ('nearby_holding_no') }}" class="form-control @error('nearby_holding_no')is-invalid
@enderror" placeholder="প্রস্তাবিত হোল্ডিং এর পার্শ্ববর্তী হোল্ডিং দিন" data-parsley-maxlength="100"
                                       data-parsley-trigger="keyup" data-parsley-required/>
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="holding_construction_date" id="holding_construction_date"
                                       value="{{ old('holding_construction_date') }}" class="form-control
@error('holding_construction_date')is-invalid @enderror" placeholder="yyyy-mm-dd" data-parsley-type="date" data-parsley-maxlength="100"
                    ...
                    <div class="col-sm-12">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="holding" id="holding" value="{{ old('holding') }}" class="form-control @error('holding')is-invalid @enderror" placeholder="প্রস্তাবিত হোল্ডিং দিন" data-parsley-required data-parsley-maxlength="100" data-parsley-trigger="keyup"/>
                            ...
                            <div class="col-sm-3 bt-flabels__wrapper">
                                <input type="text" name="description_of_house" id="description_of_house"
                                       value="{{old('description_of_house') }}" class="form-control @error('description_of_house') is-invalid @enderror" placeholder="ঘরের পূর্ণ বিবরণ দিন" data-parsley-maxlength="100" data-parsley-required/>
                ...
                <div class="row" style="margin-bottom: 100px;">
                    <div class="offset-6 col-sm-6 button-style">
                        ...
                        <input type="hidden" value="92" id="app-type">
