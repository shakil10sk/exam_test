        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">নতুন হোল্ডিং সনদ</li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    ...
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='newholding_applicant_table'>
                <thead>
                    <tr>
...
<script>
    ...
    var newholding_applicant_data_url = '@php echo  url("newholding/applicant_data") @endphp';

    var death_generate_url = '@php echo  url("death/generate") @endphp';

    var newholding_delete_url = '@php echo  url("newholding/delete") @endphp';

    //for applicant csrf
    var newholding_applicant_csrf = '@php echo csrf_token() @endphp';

    var death_generate_csrf = '@php echo csrf_token() @endphp';

    var newholding_delete_csrf = '@php echo csrf_token() @endphp';
    ...
    $('document').ready(function() {
        ...
        newholding_applicant_list();

    });
</script>

<script src="{{ asset('js/newholding.js') }}"></script>
