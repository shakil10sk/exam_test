...
<body>
    ...
    <table class="jolchap" align="center" border="0" height="415px" width='99%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed;">
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: {{ BanglaConverter::bn_number($death->nid) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ BanglaConverter::bn_number($death->birth_id) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ BanglaConverter::bn_number($death->passport_no) }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">: <?php echo BanglaConverter::bn_number(date('d-m-Y', strtotime($death->generate_date))); ?></font>
            </td>
        </tr>
    ...
    <table border='0' width='98%' cellpadding='0' cellspacing='0' style="border-collapse:collapse;margin:0 auto;padding-top:10px;">
        ...
        <tr>
            <td style="font-size:17px;  padding-left:50px;" height="80">&nbsp; &nbsp; &nbsp; &nbsp; তিনি গত- <?php echo BanglaConverter::bn_number(date('d-m-Y', strtotime($death->birth_date))); ?> ইং তারিখে মৃত্যু বরণ করিয়াছেন। তিনি অত্র পৌরসভার {{ BanglaConverter::bn_number($death->permanent_ward_no) }} নং ওর্য়াডের স্থায়ী বাসিন্দা ছিলেন ।</td>
    ...
    <table border='0' width="99%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;table-layout:fixed;margin:0px auto;">
        <tr>
            ...
            <td style="padding-left:100px;font-size:15px; vertical-align: bottom;">
                <font style='border-top: 1px solid black;'>সচিবের স্বাক্ষর</font>
            </td>
            @endif
            ...
            <td style="padding-left:{{$colspan>2? 100 : 250}}px; font-size:15px; height: 100px; vertical-align: bottom;">
                <font style='border-top: 1px solid black;'>মেয়র স্বাক্ষর</font>
            </td>
            @endif
        </tr>
