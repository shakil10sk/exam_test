...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='nodibanga_certificate_table'>
                <thead>
                    <tr>
...
@can('regenerate')
<div class="modal fade" id="nodibanga_regenerate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title" id="myLargeModalLabel">নদীভাঙ্গনের সনদ রি-জেনারেট</h4>
...
<script>
    ...
    var nodibanga_certificate_data_url = '@php echo  url("nodibanga/certificate_list_data") @endphp';

    var nodibanga_certificate_csrf = '@php echo  csrf_token() @endphp';

    // console.log(img_path);

    var nodibanga_regenerate_url = '@php echo  url("nodibanga/regenerate") @endphp';

    var nodibanga_regenerate_csrf = '@php echo csrf_token() @endphp';
