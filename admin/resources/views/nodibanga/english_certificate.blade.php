...
<body>
        ...
        <table style="width:95%; margin-left:48px;border-color:lightgray;border-collapse:collapse;margin-top:10px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td rowspan="3" valign="top" style="text-align: left;" >
                    @if($nodibanga->photo != '' )
                        <img src="{{ asset('images/application/'.$nodibanga->photo) }}" height="100px" width="100px" style="" alt="profile" />
                    @endif
                </td>
    ...
    <table class="jolchap" align="center" border="0" height="415px" width='99%' cellspacing="0" cellspacing='0' style="border-collapse:collapse;margin:0 auto;table-layout:fixed; line-height: 1.5;">
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ $nodibanga->name_en }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px; ">: {{ $nodibanga->husband_name_en }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px; ">: {{ $nodibanga->father_name_en }} </font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">: {{ $nodibanga->mother_name_en }} </font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                <p style="line-height:25px;font-size:16px; ">
                    ...
                    : Village : {{ $nodibanga->present_village_en }}
                    <br> &nbsp; Post Office: {{ $nodibanga->present_postoffice_name_en }}
                    <br> &nbsp; Upazila/Thana: {{ $nodibanga->present_upazila_name_en }}
                    <br> &nbsp; District: {{ $nodibanga->present_district_name_en}}</p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style=" vertical-align:top;">
                ...
                <p style="line-height:25px;font-size:16px;  ">
                    : Village: {{ $nodibanga->permanent_village_en }}
                    <br> &nbsp; Post Office: {{ $nodibanga->permanent_postoffice_name_en }}
                    <br> &nbsp; Upazila/Thana: {{ $nodibanga->permanent_upazila_name_en }}
                    <br> &nbsp; District: {{ $nodibanga->permanent_district_name_en }}
                </p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;  ">:  {{ $nodibanga->permanent_ward_no }}</font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ $nodibanga->birth_id }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                <font style="font-size:16px;">:  {{ $nodibanga->passport_no }}</font>
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td>
                 <font style="font-size:16px;">:  <?php echo date('d-m-Y', strtotime($nodibanga->generate_date)); ?></font>
            </td>
        </tr>
    ...
    <table border='0' width='98%' cellpadding='0' cellspacing='0' style="border-collapse:collapse;margin:0 auto;padding-top:10px;">
        ...
        <tr>
            <td style="font-size:17px;  padding-left:50px;" height="80">&nbsp; &nbsp; &nbsp; &nbsp; {{ ($nodibanga->gender == 1) ? 'He' : 'She' }} is a  resident of this union. To my knowledge, on {{ $nodibanga->birth_date }} {{ ($nodibanga->gender == 1) ? 'his' : 'her' }} house had disappeared in the riverbed.</td>

        </tr>

        <tr>
            <td style="padding-left:72px; font-size:17px; height: 20px">I wish {{ ($nodibanga->gender == 1) ? 'him' : 'her' }} all the best and prosperity.</td>
        </tr>
    ...
    <table border="0" width='99%' style="border-collapse:collapse; margin:5px auto; height: 100px" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td  style="font-size:16px;">&nbsp;{{ $nodibanga->comment_en }}
            </td>
        </tr>
    ...
    <table border='0' width="99%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;table-layout:fixed;margin:0px auto;">
        ...
        <tr>
            ...
            <td rowspan="1" style="border-left:1px solid black; border-top:1px solid black;">
                ...
                $url = $url.'/verify/nodibanga_en/'.$nodibanga->sonod_no.'/'.$nodibanga->union_id.'/'.$nodibanga->type;
