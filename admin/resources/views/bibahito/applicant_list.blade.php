        ...
        <div class="col-md-12 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">বিবাহিত সনদ</li>
...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    ...
    <div class="clearfix mb-20">
        ...
        <div class="row">
            <table class="stripe hover multiple-select-row data-table-export nowrap" id='bibahito_applicant_table'>
                <thead>
                    <tr>
...
@can('generate')
<div class="modal fade" id="bibahito_generate_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title" id="myLargeModalLabel">বিবাহিত সনদ জেনারেট</h4>
            ...
            <div class="modal-body">
                ...
                <form action="javascript:void(0)" method="post">
                    ...
                    <div class="row">
                        ...
                        <input class="form-control col-md-6" type="text" name="bibahito_generate_date" id="bibahito_generate_date" value="{{ date('Y-m-d') }}" />
                    </div>
                    <br>
...
<script>
    ...
    //url for print bibahito sonod
    var bibahito_bangla_sonod_url = '@php echo  url("bibahito/print_bn") @endphp';

    var bibahito_applicant_data_url = '@php echo  url("bibahito/applicant_data") @endphp';

    var bibahito_generate_url = '@php echo  url("bibahito/generate") @endphp';

    var bibahito_delete_url = '@php echo  url("bibahito/delete") @endphp';

    //for applicant csrf
    var bibahito_applicant_csrf = '@php echo csrf_token() @endphp';

    var bibahito_generate_csrf = '@php echo csrf_token() @endphp';

    var bibahito_delete_csrf = '@php echo csrf_token() @endphp';
    ...
    $('document').ready(function() {
        ...
        if(today.getTime() >= from_date.getTime() && today.getTime() <= to_date.getTime()){
            var display_date = today.getFullYear() + '-' + ((today.getMonth() + 1) < 10 ? '0'+(today.getMonth() + 1) : (today.getMonth() + 1)) + '-' + (today.getDate() < 10 ? ('0' + today.getDate()) : today.getDate());
        ...
        bibahito_applicant_list();

    });
</script>

<script src="{{ asset('js/bibahito.js') }}"></script>
