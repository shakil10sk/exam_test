...
@foreach($data as $value)
    <table style="margin: 50px auto; overflow: hidden; width: 550px; height: 350px; background:#f3f8ff; border: 2px solid; padding: 2px;">
        <tr>
            <td>
                <table style="margin:0 auto;">
                    ...
                    <tr>
                        <td>
                        <img style="padding: 10px; text-align: left; width: 90px;" src="{{ asset('images/union_profile/'.$value->union_logo) }}">
                        </td>
                        <td style="text-align:center;">
                            <p style="font-weight: bold;line-height: 3px;">গণপ্রজাতন্ত্রী বাংলাদেশ সরকার</p>
                            <p style="text-align: center;line-height: 3px;padding-top: 2px;">{{ $value->union_name_bn }}</p>
                            <p style="text-align: center;line-height: 3px;">{{ $value->union_upazila }} , {{ $value->union_district }}</p>
                        </td>
                        <td>
                            <img style="padding: 10px; text-align: left; width: 90px;" src="{{ asset('images/allowance/'.$value->photo) }}" >
                        </td>
                    </tr>
            ...
            <td>
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td style="border-right: 1px dotted;">{{ $value->name }}</td>
                        <td class="pl-2">ওয়ার্ড নং</td>
                        <td>:</td>
                        <td>{{ BanglaConverter::bn_number($value->ward_no) }}</td>
                    </tr>

                    <tr>
                        <td class="pl-2">আইডি নং</td>
                        <td>:</td>
                        <td style="border-right: 1px dotted;">{{ BanglaConverter::bn_number($value->allowance_id) }}</td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td style="border-right: 1px dotted;">{{ BanglaConverter::bn_number($value->nid) }}</td>
                        <td class="pl-2">মোবাইল</td>
                        <td>:</td>
                        <td>{{ BanglaConverter::bn_number($value->mobile) }}</td>
                    </tr>
                ...
                <table style="width: 100%;border-top: 1px dotted;">
                    <tr>
                        ...
                        <td style="padding-left:10px;">
                            @php $url = route('vata_card', ['type' => $type, 'id' => $value->id]); @endphp
